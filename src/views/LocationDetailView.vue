<template>
  <div class="min-h-screen bg-gray-50 px-4 py-8">
    <div class="max-w-4xl mx-auto">
      <!-- Loading state -->
      <div v-if="isLoading" class="flex items-center justify-import { ref, onMounted, computed } from 'vue'
import { useRoute, useRouter } from 'vue-router'
import { locationService } from '../services/locationService.js'
import { loadImageAsDataUrl } from '../utils/imageUtils.js'ter py-12">
      ...
      <div v-else-if="location" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div v-else class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <!-- This would show uploaded images - placeholder for now -->
            <div
    ...
    >
      <div class="bg-white rounded-lg p-6 max-w-md w-full">
        ...
        <p class="text-gray-600 mb-4">Image upload functionality will be implemented here.</p>
        <button
...
import { useRoute, useRouter } from "vue-router";
import { locationService } from "../services/locationService.js";
import { loadImageAsDataUrl } from "../utils/imageUtils.js";
...
const heroImageDataUrl = ref(null);
...
const loadLocation = async () => {
  try {
    ...
    // Load hero image as data URL to avoid CORS issues
    if (location.value.heroImageUrl) {
      heroImageDataUrl.value = await loadImageAsDataUrl(location.value.heroImageUrl);
    }

    // Load images for this location (placeholder for now)
    images.value = [];
  } catch (err) {
