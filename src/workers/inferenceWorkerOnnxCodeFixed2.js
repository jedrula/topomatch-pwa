...
Object.keys(onnxDefines).forEach((key) => {
  const segments = key.split(".");
  let target = onnxContext;
  for (let i = 0; i < segments.length; i++) {
    const segment = segments[i];
    if (i === segments.length - 1) {
      target[segment] = onnxDefines[key];
    } else {
...
var ort = (() => {
        ...
        async run(t, n, r) {
          ...
          for (let d in a)
            if (Object.hasOwnProperty.call(a, d)) {
              let l = a[d];
              l instanceof $e ? (u[d] = l) : (u[d] = new $e(l.type, l.data, l.dims));
            }
          return me(), u;
        }
        async release() {
    ...
    Le = E(() => {
      ...
      (kn = !1),
        ...
        (It = async (e) => {
          ...
          if (Bt) throw new Error("multiple calls to 'initializeWebAssembly()' detected.");
          if (eo) throw new Error("previous call to 'initializeWebAssembly()' failed.");
          Bt = !0;
          let t = e.initTimeout,
            n = e.numThreads;
          if (e.simd !== !1) {
          ...
          if (
            ...
            m.push(
              new Promise((h, b) => {
                ...
                p(y).then(
                  (g) => {
                    (Bt = !1), (kn = !0), (An = g), h(), c && URL.revokeObjectURL(c);
                  },
                  (g) => {
                    (Bt = !1), (eo = !0), b(g);
                  }
      ...
      (zn = class {
        ...
        (Pe = class {
          static calcShape(t, n, r = !1) {
            ...
            if (r) {
              if (o < 2 || i < 2) return;
              let u = zn.calcMatMulShape([t[o - 2], t[o - 1]], [n[i - 2], n[i - 1]]);
              if (u === void 0) return;
              [a[s - 2], a[s - 1]] = u;
            }
          ...
          static computeShapeHelper(t, n, r, o, i, s, a, u) {
            if (t) for (let d = 0; d < n.length - 2; d++) r.push(1);
              ...
              for (let d = 0; d < n.length - 2; d++)
                r.push(
                  e.adjustPadAndReturnShape(n[d + 2], o[d], i[d], s[d], a, d, d + n.length - 2, u)
                );
          }
        ...
        (Dn = class {
          ...
          registerTensor(t, n, r, o) {
            let i = this.getMLContext(t),
              s = lo(),
              a = new Wt({ sessionId: t, context: i, tensor: n, dataType: r, shape: o });
            return this.tensorTrackersById.set(s, new Ht(this, a)), this.externalTensors.add(a), s;
          }
      ...
      (yo = new Map([
        ...
        (Un = class {
          constructor(t) {
            ...
            for (let [n] of yo)
              Mn.push(n), this.freeBuffers.set(n, []), this.freeUniformBuffers.set(n, []);
            this.sessionCount = 0;
          }
          upload(t, n) {
            let r = n.buffer,
  ...
  Please use the previous external buffer!`);
          ...
          create(
            t,
            n = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST
          ) {
            let r = dd(t),
              o,
      ...
      (Qe = 64),
        ...
        (P = (...e) => {
          ...
          return (
            e.forEach((n) => {
              n.length !== 0 &&
                t.push({ type: 12, data: n }, { type: 12, data: x.computeStrides(n) });
            }),
            t
          );
        }),
  ...
  var cd,
    ...
    Re = E(() => {
      ...
      (cd = (e, t) => {
        ...
        (So = (e, t) => (t.length !== 0 ? t : [...new Array(e).keys()].reverse())),
...
${g.setByIndices(`${g.type.indices}(output_row, output_col)`, "tile[local_id.x][local_id.y]")}
              ...
              }),
              {
                ...
                getRunData: () => {
                  ...
                  return {
                    outputs: [{ dims: i, dataType: e.dataType }],
                    dispatchGroup: { x: Math.ceil(a[1] / h), y: Math.ceil(a[0] / h) },
    ...
    r === "mean"
      ...
      : `${c.type.storage}(${_d[r]})`
        ...
        (ze = (e, t, n, r) => {
          ...
          d.length > 0 &&
            ((u = e.compute(ce(e.inputs[0], d), { inputs: [0], outputs: [-1] })[0]),
...
`)
        ...
        (Hn = (e, t) => {
          let n = [];
          return (
            e[1].dims[0] > 0 && e[1].getBigInt64Array().forEach((r) => n.push(Number(r))),
            N({ axes: n, keepDims: t.keepDims, noopWithEmptyAxes: t.noopWithEmptyAxes })
          );
        }),
        (De = (e, t, n, r) => {
          let o = e.inputs,
...
`)}`,
        ...
        (Uo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? zd(e, t) : Co(e, t);
        }),
        (Vo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ad(e, t) : Ao(e, t);
        }),
        (No = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? kd(e, t) : ko(e, t);
        }),
        (Lo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ed(e, t) : Eo(e, t);
        }),
        (Go = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Pd(e, t) : Po(e, t);
        }),
        (Wo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Od(e, t) : zo(e, t);
        }),
        (Ho = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Dd(e, t) : Oo(e, t);
        }),
        (qo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Bd(e, t) : Do(e, t);
        }),
        (Fo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Md(e, t) : Bo(e, t);
        }),
        (Ko = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Cd(e, t) : Mo(e, t);
        });
    });
  var jo,
    Zo,
...
output[outputIdx] = ${ee.type.value} (sum * uniforms.alpha) + ${
          ...
          return {
            ...
            getRunData: () => ({ outputs: T, dispatchGroup: _, programUniforms: w }),
            getShaderSource: I,
          };
        }),
...
output[outputIdx] = value;
        ...
        (nt = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
          ...
          e.compute(Ud(y, d.batchSize, d.numHeads, f, d.sequenceLength, m, l, c), {
            inputs: l && c ? [y, l, c] : [y],
            outputs: [],
          });
          let g = [y, r];
          p > 1 && a && x.size(a.dims) > 0 && g.push(a),
            l && g.push(l),
            c && g.push(c),
            e.compute(Nd(p, y, r, a, d, f, l, c), { inputs: g, outputs: p > 1 ? [0, 2] : [0] });
        }),
        (Ld = (e, t) => {
...
output_v[outputIdx] = valueV;
        ...
        (Yo = (e, t) => {
          let n = Rd(e.inputs, t),
            [r, o, i] = Ld(e, n);
          return nt(e, r, o, i, e.inputs[4], void 0, void 0, void 0, e.inputs[5], n);
        });
    });
  var Gd,
    Wd,
...
${b.setByOffset("global_idx", "value")}
          ...
          return {
            ...
            getRunData: () => ({
              ...
              programUniforms: d ? [{ type: 12, data: u }, ...P(i)] : [{ type: 12, data: u }],
            }),
          };
        }),
        (Hd = (e) => N(e)),
          ...
          return (
            m.push(p),
            {
              ...
              getRunData: () => ({
                ...
                programUniforms: [{ type: 12, data: Math.ceil(x.size(l) / 4) }, ...P(a, u, l)],
              }),
            }
          );
        }),
          ...
          if (n.group !== 1) {
            ...
            if (o) {
              let I =
                ...
                e.compute(ce(t[1], Xn), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
          ...
          if (
            ...
            if (o) {
              ...
              if ((n.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = W), h)) {
                let O = a * u * d;
                (T = t[0].reshape([1, $, O])), (I = W.reshape([1, O, m])), (A = [1, $, m]);
              } else
                (T = t[0].reshape([$, a * u, d])), (I = W.reshape([1, d, m])), (A = [$, p * f, m]);
              z.push(T), z.push(I);
            } else
              (T = t[0].reshape([$, d, a * u])),
                (I = t[1].reshape([1, m, d])),
        ...
        (gl = (e, t) => {
          let n = t.format === "NHWC",
            r = [
              e.inputs[0].reshape(
                n
                  ? [e.inputs[0].dims[0], 1, e.inputs[0].dims[1], e.inputs[0].dims[2]]
                  : [e.inputs[0].dims[0], e.inputs[0].dims[1], 1, e.inputs[0].dims[2]]
              ),
              e.inputs[1].reshape([
                e.inputs[1].dims[0],
                e.inputs[1].dims[1],
          ...
          let o = [0, t.pads[0], 0, t.pads[1]],
            ...
            u = Yn({ ...t, pads: o, strides: i, dilations: s, kernelShape: a }, r);
...
`),
                ...
                H += `
let w_offset = ${G.indicesToOffset(
                  `${G.type.indices}(u32(wRPerm), u32(wCPerm), inputChannel, wOutChannel)`
                )};
...
dotProd = dotProd + xValue * wValue;`;
                ...
                for (let k = 0; k < l; k++)
                  H += `
 let wValue${k} = ${G.getByOffset(
                    `${G.indicesToOffset(
                      `${G.type.indices}(u32(wRPerm), u32(wCPerm), inputChannel + ${k}, wOutChannel)`
                    )} / ${h}`
                  )};
...
dotProd = dotProd + dot(xValue, wValue);`;
 ...
 for (; wR < uniforms.effective_filter_dims.x; wR = wR + 1) {
   ...
   for (; wC < uniforms.effective_filter_dims.y; wC = wC + 1) {
     ...
     var w_offset = ${G.indicesToOffset(
      ...
      (bl = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i),
        ...
        (wl = (e, t, n, r, o, i, s, a, u, d) => {
          ...
          for (let m = 0, h = e.length - l - (a ? 1 : 0); m < l; ++m, ++h) {
            ...
            _l(g, r, i, m, m + l),
              c && d.push(s[m] * (b - 1) + u[m] + (t[h] - 1) * n[m] + 1 - i[m] - i[m + l]);
          }
        ...
        (vs = (e, t, n, r) => {
          let o =
            e.kernelCustomData.wT ??
            e.compute(ce(t[1], [2, 3, 0, 1]), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
        ...
        (vl = (e, t) => {
          ...
          u = [0].concat(u);
          let d = ws(
            { ...t, pads: a, strides: s, dilations: i, kernelShape: o, outputPadding: u },
            r
          );
       ...
       ${a.setByOffset("global_idx", "sum")};
        ...
        return {
          ...
          getRunData: () => ({
            ...
            dispatchGroup: { x: Math.ceil(o / 64) },
            programUniforms: [{ type: 12, data: o }, { type: 12, data: d }, ...P(t, t)],
          }),
          getShaderSource: l,
        };
      }),
...
${h.setByOffset("global_idx", m.getByIndices("aIndices"))}
        ...
        (ks = (e) => N({ blocksize: e.blocksize, mode: e.mode, format: e.format }));
    });
  var tr,
    un,
    Ps,
            ...
            return (
              d?.forEach((c, p) => {
                if (c === "...") {
                  ...
                  l.addSymbol(c, p + (this.hasEllipsis ? this.ellipsisDims.length - 1 : 0)),
          ...
          return {
            ...
            getRunData: () => {
              let l = u
                ...
                .map((p) => ({ type: 12, data: n.symbolToInfo.get(p)?.dimValue || 0 }));
...
${d.setByOffset("global_idx", jn("x_in"))}
        ...
        (Vs = (e) => {
          e.inputs.length < 2 || x.size(e.inputs[1].dims) === 0 ? Bi(e) : e.compute(Ol(e.inputs));
        });
    });
  var Dl,
    Bl,
            ...
            c = (p) => {
              let f = S("data", e[0].dataType, e[0].dims.length, u),
                ...
                b = (g) => {
                  ...
                  for (let v = 0; v < _; v++)
                    w += `${_ > 1 ? `indicesIndices${g}[${v}]` : `indicesIndices${g}`} = ${
                      s.length > 1 ? `outputIndices${g}[uniforms.axis + ${v}]` : `outputIndices${g}`
                    };`;
                  w += `
                  ...
                  for (let v = 0, $ = 0; v < o; v++)
                    v === i
                      ? ((w += `${
                        ...
                        ($ += _))
                      : ((w += `${o > 1 ? `dataIndices${g}[${v}]` : `dataIndices${g}`} = ${
                          s.length > 1 ? `outputIndices${g}[${$}]` : `outputIndices${g}`
                        };`),
                        $++);
                  return w;
                },
    ...
    Zs = E(() => {
      ...
      (Rl = (e, t) => {
        ...
        if (
          ...
          !o.dims
            .map((a, u) => (u === n ? Math.ceil(a / r) === i.dims[u] : a === i.dims[u]))
            .reduce((a, u) => a && u, !0)
        )
          throw new Error(
...
${_.setByOffset("global_idx", "dequantized_data")};
        ...
        (js = (e) =>
          N({ blockSize: e.blockSize, gatherAxis: e.gatherAxis, quantizeAxis: e.quantizeAxis }));
    });
  var Vl,
    Nl,
    Qs,
        ...
        (yt = (e, t, n, r, o, i, s, a) => {
          ...
          if (s && x.size(s.dims) > 0) {
            ...
            return (
              ...
              (u = u.reshape([t, r, n, o])),
              n === 1 || r === 1 ? u : e.compute(ce(u, ia.perm), { inputs: [u], outputs: [-1] })[0]
            );
          } else
            return (
    ...
    sr = E(() => {
      ...
      (tc = (e) => {
        ...
        (nc = (e, t) => {
          ...
          return (
            e[1].dims[0] > 0 &&
              (e[1].getBigInt64Array().forEach((o) => n.push(Number(o))), (r = n.length)),
  ...
  var ic,
    ...
    ar = E(() => {
      ...
      (ic = (e, t) => {
        ...
        (dn = (e, t) => {
          let { interleaved: n, numHeads: r, rotaryEmbeddingDim: o, scale: i } = t,
            s = e[0].dims[0],
            ...
            m = [
              ...
              { type: 12, data: p },
              { type: 12, data: f },
              ...(e[0].dims.length === 3 ? new Array({ type: 12, data: [a, d, c, 1] }) : []),
              ...(e[0].dims.length === 4 ? new Array({ type: 12, data: [a, c, u * c, 1] }) : []),
    ...
    ma = E(() => {
      ...
      (sc = (e, t) => {
        ...
        let a = !1,
          u = n.dims[0],
          d = n.dims[1],
          l = n.dims.length === 3 ? (a ? n.dims[2] / 3 : n.dims[2]) : t.numHeads * n.dims[4],
          c = d,
          p = 0,
          f = !r || r.dims.length === 0,
          m = Math.floor(f ? l / (t.numHeads + 2 * t.kvNumHeads) : l / t.numHeads);
        f && (l = m * t.numHeads);
        ...
        (ca = (e, t, n) => {
          ...
          return (
            t.dims.length === 3 &&
              ...
              (r = e.compute(ce(r, ac.perm), { inputs: [r], outputs: [-1] })[0])),
            r
          );
        }),
        (uc = (e, t, n, r) => {
...
`;
        ...
        (pa = (e, t) => {
          ...
          let r = e.inputs[0],
            ...
            s = e.inputs[3] && e.inputs[3].dims.length !== 0 ? e.inputs[3] : void 0,
            a = e.inputs[4] && e.inputs[4].dims.length !== 0 ? e.inputs[4] : void 0,
            ...
            c = N({
              axis: 2,
              numOutputs: 3,
              splitSizes: [n.numHeads * n.headSize, l * n.headSize, l * n.headSize],
            }),
            [p, f, m] =
              !o && !i ? e.compute(ir([r], c), { inputs: [r], outputs: [-1, -1, -1] }) : [r, o, i],
            h,
            b;
          if (t.doRotary) {
            let w = e.compute(uc(n.batchSize, n.sequenceLength, u, d), {
              ...
              I = [p, w, v, $],
              A = [-1];
            (h = e.compute(dn(I, T), { inputs: I, outputs: A })[0]), I.splice(0, 1, f);
            let z = N({
              interleaved: t.rotaryInterleaved !== 0,
...
${_.setByOffset("global_idx", "value")};
        ...
        (lc = (e, t, n) => {
          ...
          p = p && r[r.length - 1] !== 1;
          let m = p
              ? e.compute(ce(e.inputs[0], f), { inputs: [e.inputs[0]], outputs: [-1] })[0]
              : e.inputs[0].reshape(Array.from({ length: r.length }, (y, g) => r[f[g]])),
...
`;
      ...
      (ln = (e) => {
        ...
        (Ia = (e, t, n) => {
          ...
          i
            ...
            : Object.assign(c, { kernelShape: s, strides: a, pads: d, cacheKey: t.cacheKey });
          let p = l.slice();
 ...
 ${e.mainStart()}
   ...
   output[global_idx] = value;
        ...
        (ka = (e) => `${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`),
        ...
        (Pa = (e, t, n, r) => {
          ...
          return {
            ...
            getShaderSource: (b) => Aa(b, s, t.dims.length, i.length, o, u, d, 0, c, p, f, m),
          };
        }),
        (za = (e) => {
...
`,
          ...
          return (
            ...
            {
              name: e,
              shaderCache: { hint: `${r.cacheKey};${p};${f};${m}`, inputDependencies: d },
              getRunData: () => ({
                outputs: [{ dims: i, dataType: t.dataType }],
                dispatchGroup: { x: Math.ceil(x.size(i) / 64) },
                programUniforms: l,
        ...
        (Lc = (e, t, n) => {
          ...
          return (
            n.axes.length > 0
              ...
              : (t.fill(r, 0, t.length), o.forEach((i, s) => (o[s] = Math.round(i * t[s])))),
            o
          );
        }),
        (Gc = (e, t, n, r, o) => `
fn calculateOriginalIndicesFromOutputIndices(output_indices: ${e.type.indices}) -> array<${
          e.type.value
        }, ${n.length}> {
...
`;
        ...
        (Kc = (e, t, n, r, o) => {
          let [s, a, u, d, l] = n.length === 3 ? [-1, 0, 1, 2, -1] : [0, 2, 3, 4, 1],
            c = e.type.value;
          return `
    ...
    du = E(() => {
      ...
      (Yc = (e, t) => {
        ...
        (cn = (e, t) => {
          let n = [];
          if (e.length > t)
            if (e[t].dataType === 7) e[t].getBigInt64Array().forEach((r) => n.push(Number(r)));
        ...
        (su = (e, t, n, r, o) => {
          ...
          return (
            e < 0 && (i += n[r[t]]),
            o[t] < 0 ? Math.max(0, Math.min(i, n[r[t]] - 1)) : Math.max(0, Math.min(i, n[r[t]]))
          );
        }),
        (ep = (e, t, n) => `fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${
          e.type.indices
        } {
var input_indices: ${e.type.indices};
var carry = 0u;
...
return input_indices;
        ...
        (tp = (e, t) => {
          let n = e[0].dims,
            r = x.size(n),
            o = t.axes.length > 0 ? x.normalizeAxes(t.axes, n.length) : [...Array(n.length).keys()],
            i = cn(e, 4);
          i.forEach(
            (y) =>
              y !== 0 ||
...
${a}`,
          ...
          return (
            me(t.name),
            { programInfo: t, computePipeline: l, uniformVariablesInfo: s.variablesInfo }
          );
        }
      ...
      (dp = (e, t) => {
        ...
        (dr = class {
                  ...
                  for (let o = 0; o < n.length / 2; o++) {
                    ...
                    if (this.env.webgpu.profiling?.ondata)
                      this.env.webgpu.profiling.ondata({
                        version: 1,
                        inputsMetadata: c.map((y) => ({ dims: y.dims, dataType: ke(y.dataType) })),
                        outputsMetadata: p.map((y) => ({ dims: y.dims, dataType: ke(y.dataType) })),
                        kernelId: s,
                        kernelType: u,
                        kernelName: d,
                        programName: l,
                      ...
                      p.forEach((_, w) => {
                        ...
                        console.log(
                          `[profiling] kernel "${s}|${u}|${d}|${l}" ${y}${g}execution time: ${
                            b - h
                          } ns`
                        );
                    }
          ...
          run(t, n, r, o, i, s) {
            ...
            let { outputs: u, dispatchGroup: d, programUniforms: l } = t.getRunData(n),
            ...
            for (let _ = 0; _ < u.length; ++_) {
              ...
              let w = c[_] === -1,
                v = c[_] === -2,
                $ = w || v ? i(u[_].dataType, u[_].dims) : o(c[_], u[_].dataType, u[_].dims);
              ...
              d &&
                r.push(
                  this.device
                    .popErrorScope()
                    .then((l) =>
                      l ? `GPU validation error for kernel "[${i}] ${s}": ${l.message}` : null
                    )
                );
          ...
          unregisterBuffers(t) {
            ...
            n &&
              (n.forEach((r) => this.gpuDataManager.unregisterExternalBuffer(r[0])),
          ...
          onReleaseSession(t) {
            this.unregisterBuffers(t),
              this.capturedCommandList.has(t) && this.capturedCommandList.delete(t),
              this.capturedPendingKernels.has(t) && this.capturedPendingKernels.delete(t),
          ...
          if (e === "webgpu") {
            ...
            await s.initialize(n, r),
              o("webgpu", [
                ...
                (a, u, d) =>
                  s.createKernel(a, Number(u), d, t.UTF8ToString(t._JsepGetNodeName(Number(u)))),
                (a) => s.releaseKernel(a),
                (a, u, d, l) => {
                  j(
                    "verbose",
    ...
    In = E(() => {
      ...
      (pp = (e, t) => {
        ...
        (kt = async (e, t) => {
          ...
          try {
            ...
            throw (
              ...
              a !== 0 && o._OrtReleaseBinding(a) !== 0 && Y("Can't release IO binding."),
              i !== 0 && o._OrtReleaseSession(i) !== 0 && Y("Can't release session."),
              c)
            );
          } finally {
            o._free(n),
        ...
        (Et = (e) => {
          ...
          let [r, o, i, s, a] = n;
          s &&
            (a && t._OrtClearBoundOutputs(s.handle) !== 0 && Y("Can't clear bound outputs."),
            t._OrtReleaseBinding(s.handle) !== 0 && Y("Can't release IO binding.")),
        ...
        (Pt = async (e, t, n, r, o, i) => {
          ...
          try {
            ...
            for (let O = 0; O < b; O++) {
              ...
              try {
                ...
                if (U === "string") {
                  ...
                  let ae = ue(Q),
                    Ve = We(H, we);
                  if (Ve === void 0 || !Ut(U)) throw new Error(`Unsupported data type: ${U}`);
                  (Z = !0),
                    R.push([
                      U,
                      oe,
            ...
            p &&
              !f &&
              (s._OrtClearBoundOutputs(p.handle) !== 0 && Y("Can't clear bound outputs."),
      ...
      (Du = (e, t) => {
        ...
        (gp = (e) => {
          switch (e[3]) {
            ...
            case "ml-tensor": {
              ...
              return $e.fromMLTensor(n, { dataType: t, dims: e[1], download: r, dispose: o });
            }
            default:
        ...
        (gn = class {
          ...
          async run(t, n, r) {
            ...
            let u = o.map((p, f) => Du(p, () => `input "${this.inputNames[i[f]]}"`)),
              d = s.map((p, f) => (p ? Du(p, () => `output "${this.outputNames[a[f]]}"`) : null)),
              l = await zu(this.sessionId, i, u, a, d, r),
              c = {};
            for (let p = 0; p < l.length; p++) c[this.outputNames[a[p]]] = s[p] ?? gp(l[p]);
            return me(), c;
          }
          startProfiling() {}
          endProfiling() {
