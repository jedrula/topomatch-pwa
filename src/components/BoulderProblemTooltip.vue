<template>
  <div v-if="visible && problem" class="fixed z-50 pointer-events-none" :style="tooltipStyle">
    ...
    <div class="bg-white rounded-lg shadow-lg border border-gray-200 p-3 max-w-xs">
      ...
      <div v-if="hasUnsavedChanges" class="flex items-center mt-2 pt-2 border-t border-gray-100">
