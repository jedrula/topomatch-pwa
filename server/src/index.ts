...
export const createLocation = onRequest(
  {cors: true},
  async (request, response) => {
    try {
      ...
      const {name, description} = request.body as Location;
...
export const getLocation = onRequest(
  {cors: true},
  async (request, response) => {
    try {
      if (request.method !== "GET") {
...
// Update a location
export const updateLocation = onRequest(
  {cors: true},
  async (request, response) => {
    try {
...
// Delete a location
export const deleteLocation = onRequest(
  {cors: true},
  async (request, response) => {
    try {
