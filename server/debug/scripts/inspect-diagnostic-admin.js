/**
 * Inspect Diagnostic Report Document (Admin SDK - Production)
 * 
 * This script uses Firebase Admin SDK to access production Firestore.
 * 
 * Usage:
 *   GOOGLE_APPLICATION_CREDENTIALS=./topomatch-pwa-firebase-adminsdk.json node debug/scripts/inspect-diagnostic-admin.js <ascentId>
 * 
 * Example:
 *   GOOGLE_APPLICATION_CREDENTIALS=./topomatch-pwa-firebase-adminsdk.json node debug/scripts/inspect-diagnostic-admin.js 7eee15ba-ad03-466a-9880-f7fa8c561237
 */
...
async function inspectDiagnostic(ascentId) {
  ...
  try {
    const docRef = db.collection(COLLECTION).doc(ascentId);
...
if (!ascentId) {
  ...
  console.log('\nUsage:');
  console.log('  GOOGLE_APPLICATION_CREDENTIALS=./topomatch-pwa-firebase-adminsdk.json node debug/scripts/inspect-diagnostic-admin.js <ascentId>');
  console.log('\nExample:');
  console.log('  GOOGLE_APPLICATION_CREDENTIALS=./topomatch-pwa-firebase-adminsdk.json node debug/scripts/inspect-diagnostic-admin.js 7eee15ba-ad03-466a-9880-f7fa8c561237');
  process.exit(1);
}
