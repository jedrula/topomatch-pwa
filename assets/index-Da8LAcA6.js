...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Qm=(e,t)=>new Dd(e,t)}),Ud,aa,Wd,qd,Ld,Vd,xt,Xm,Ym,Er=j(()=>{we(),xe(),Ke(),ke(),Ud=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},aa=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Wd=(e,t)=>B.sortBasedOnPerm(e,aa(e.length,t)),qd=(e,t,r,n)=>{let s=`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`;for(let i=0;i<t;++i)s+=`a[${e[i]}]=i[${i}];`;return s+="return a;}"},Ld=(e,t)=>{let r=[],n=[];for(let s=0;s<e.length;++s)e[s]!==1&&r.push(e[s]),e[t[s]]!==1&&n.push(t[s]);return{newShape:r,newPerm:n}},Vd=(e,t)=>{let r=0;for(let n=0;n<e.length;++n)if(t[e[n]]!==1){if(e[n]<r)return!1;r=e[n]}return!0},xt=(e,t)=>{let r=e.dataType,n=e.dims.length,s=aa(n,t),i=Wd(e.dims,s),a=e.dims,o=i,u=n<2||Vd(s,e.dims),l;if(u)return l=g=>{let y=U("input",r,a,4),x=ce("output",r,o,4);return`
...
`}return _e};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${p};${h};${m};${s}`,inputDependencies:y?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:b}),getShaderSource:k}}}),Rc,Bc,co,la,Mc,po,Nc,Zi,au=j(()=>{we(),xe(),ke(),Gr(),su(),nu(),Rc=(e,t)=>e?`
...
`},Nc=(e,t,r,n,s=!1)=>{let[i,a,o,u]=n,l=Je(n[0].type.tensor);return`
    ...
    `},Zi=(e,t,r,n,s=!1,i)=>{let a=e[0].dims,o=e[1].dims,u=a.slice(0,-2),l=o.slice(0,-2),c=n?n.slice(0,-2):r.slice(0,-2),p=B.size(c),h=a[a.length-2],m=a[a.length-1],g=o[o.length-1],y=m%4===0&&g%4===0,x=h<=8?[4,1,1]:[4,4,1],w=[8,8,1],b=[Math.ceil(g/w[0]/x[0]),Math.ceil(h/w[1]/x[1]),Math.ceil(p/w[2]/x[2])],k=y?4:1,S=[...u,h,m/k],I=S.length,z=[...l,m,g/k],O=z.length,R=[p,h,g/k],N=[{type:6,data:h},{type:6,data:g},{type:6,data:m}];Lr(t,N),N.push(...he(c,S,z));let G=["rank","rank"],ue=e.length>2;ue&&(N.push(...he(e[2].dims)),G.push("rank")),N.push(...he(R));let ne=se=>{let Se=c.length,_e=Yo("batchDims",e[0].dataType,Se,1),Q=Je(e[0].dataType),ie=U("a",e[0].dataType,I,k),K=U("b",e[1].dataType,O,k),de=ce("result",e[0].dataType,R.length,k),Re=[ie,K];if(ue){let Ze=s?k:1;Re.push(U("bias",e[2].dataType,e[2].dims.length,Ze))}let P=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];Vr(t,P);let H=Je(de.type.tensor),Y=qr(t,de.type.value,H),ge=Nc(k,ue,Y,[_e,ie,K,de],s);return`
  ...
  ${y?co(x,w,Q,_e):po(x,w,Q,_e)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${I}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${y?`vec4<${de}>`:de}) {
        ...
        ${y?co(k,b,de,void 0,!l,R):po(k,b,de,void 0,!l,R,!1,void 0,o)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${I};${y};${N};${G};${ue};${z};${O};${R}`,inputDependencies:Se},getRunData:()=>({outputs:[{dims:u?u(r):r,dataType:e[0].dataType}],dispatchGroup:{x:S[0],y:S[1],z:S[2]},programUniforms:se}),getShaderSource:_e}}}),Dc,da,Sn,Uc,ca,Wc,$_,v_,w1=j(()=>{we(),lr(),xe(),ke(),Gr(),nu(),Dc=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},da=e=>typeof e=="number"?[e,e,e]:e,Sn=(e,t)=>t<=1?e:e+(e-1)*(t-1),Uc=(e,t,r,n=1)=>{let s=Sn(t,n);return Math.floor((e[0]*(r-1)-r+s)/2)},ca=(e,t,r,n,s)=>{s==null&&(s=Uc(e,t[0],n[0]));let i=[0,0,0,r];for(let a=0;a<3;a++)e[a]+2*s>=t[a]&&(i[a]=Math.trunc((e[a]-t[a]+2*s)/n[a]+1));return i},Wc=(e,t,r,n,s,i,a,o,u,l)=>{let c,p,h,m;if(e==="VALID"&&(e=0),typeof e=="number"){c={top:e,bottom:e,left:e,right:e,front:e,back:e};let g=ca([t,r,n,1],[o,u,l],1,[s,i,a],e);p=g[0],h=g[1],m=g[2]}else if(Array.isArray(e)){if(!e.every((y,x,w)=>y===w[0]))throw Error(`Unsupported padding parameter: ${e}`);c={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let g=ca([t,r,n,1],[o,u,l],1,[s,i,a],e[0]);p=g[0],h=g[1],m=g[2]}else if(e==="SAME_UPPER"){p=Math.ceil(t/s),h=Math.ceil(r/i),m=Math.ceil(n/a);let g=(p-1)*s+o-t,y=(h-1)*i+u-r,x=(m-1)*a+l-n,w=Math.floor(g/2),b=g-w,k=Math.floor(y/2),S=y-k,I=Math.floor(x/2),z=x-I;c={top:k,bottom:S,left:I,right:z,front:w,back:b}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:c,outDepth:p,outHeight:h,outWidth:m}},$_=(e,t,r,n,s,i=!1,a="channelsLast")=>{let o,u,l,c,p;if(a==="channelsLast")[o,u,l,c,p]=e;else if(a==="channelsFirst")[o,p,u,l,c]=e;else throw new Error(`Unknown dataFormat ${a}`);let[h,,m,g,y]=t,[x,w,b]=da(r),[k,S,I]=da(n),z=Sn(m,k),O=Sn(g,S),R=Sn(y,I),{padInfo:N,outDepth:G,outHeight:ue,outWidth:ne}=Wc(s,u,l,c,x,w,b,z,O,R),se=i?h*p:h,Se=[0,0,0,0,0];return a==="channelsFirst"?Se=[o,se,G,ue,ne]:a==="channelsLast"&&(Se=[o,G,ue,ne,se]),{batchSize:o,dataFormat:a,inDepth:u,inHeight:l,inWidth:c,inChannels:p,outDepth:G,outHeight:ue,outWidth:ne,outChannels:se,padInfo:N,strideDepth:x,strideHeight:w,strideWidth:b,filterDepth:m,filterHeight:g,filterWidth:y,effectiveFilterDepth:z,effectiveFilterHeight:O,effectiveFilterWidth:R,dilationDepth:k,dilationHeight:S,dilationWidth:I,inShape:e,outShape:Se,filterShape:t}},v_=(e,t,r,n,s,i)=>{let a=i==="channelsLast";a?e[0].dims[3]:e[0].dims[1];let o=[64,1,1],u={x:r.map((x,w)=>w)},l=[Math.ceil(Dc(u.x.map(x=>r[x]))/o[0]),1,1];Oe("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${l}`);let c=1,p=B.size(r),h=[{type:12,data:p},{type:12,data:n},{type:12,data:s},{type:12,data:t.strides},{type:12,data:t.dilations}];Lr(t,h),h.push(...he(e[0].dims,e[1].dims));let m=["rank","rank"],g=e.length===3;g&&(h.push(...he(e[2].dims)),m.push("rank")),h.push(...he(r));let y=x=>{let w=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:n.length},{name:"pads",type:"u32",length:s.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];Vr(t,w);let b=1,k=Je(e[0].dataType),S=U("x",e[0].dataType,e[0].dims.length,c),I=U("W",e[1].dataType,e[1].dims.length,b),z=[S,I],O=ce("result",e[0].dataType,r.length,b),R="";if(g){let ue=U("bias",e[2].dataType,e[2].dims.length,b);z.push(ue),R+=`
...
`)},Jc=(e,t)=>{let r,n,s,i,a,o,u=t.format==="NHWC",l=t.blocksize,c=t.mode==="DCR";u?([r,n,s,i]=e.dims,a=c?[r,n,s,l,l,i/l**2]:[r,n,s,i/l**2,l,l],o=c?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([r,n,s,i]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],a=c?[r,l,l,i/l**2,n,s]:[r,i/l**2,l,l,n,s],o=c?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let p=e.reshape(a),h=p.dims.length,m=e.dataType,g=U("a",m,h),y=ce("output",m,h),x=w=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:w=>{let b=u?[r,n*l,s*l,i/l**2]:[r,i/l**2,n*l,s*l],k=B.size(b),S=p.dims,I=B.sortBasedOnPerm(S,o);return{outputs:[{dims:b,dataType:w[0].dataType}],dispatchGroup:{x:Math.ceil(k/64)},programUniforms:[{type:12,data:k},...he(S,I)]}},getShaderSource:x}},z_=(e,t)=>{Xc(e.inputs),e.compute(Jc(e.inputs[0],t))},O_=e=>Ne({blocksize:e.blocksize,mode:e.mode,format:e.format})}),Ti,kn,ma,ep,tp,rp,np,ga,ip,A_,R_,E1=j(()=>{we(),xe(),Ke(),ke(),Ti="[a-zA-Z]|\\.\\.\\.",kn="("+Ti+")+",ma="^"+kn+"$",ep="("+kn+",)*"+kn,tp="^"+ep+"$",rp=class{constructor(e=-1){this.symbolToIndices=new Map,this.inputIndex=e}addSymbol(e,t){let r=this.symbolToIndices.get(e);r===void 0?r=[t]:r.push(t),this.symbolToIndices.set(e,r)}},np=class{constructor(e,t){var s;this.equation=t,this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[r,n]=t.includes("->")?t.split("->",2):[t,""];if(!r.match(RegExp(tp)))throw new Error("Invalid LHS term");if(r.split(",").forEach((i,a)=>{let o=e[a].dims.slice();if(!i.match(RegExp(ma)))throw new Error("Invalid LHS term");let u=this.processTerm(i,!0,o,a);this.lhs.push(u)}),n==="")n+=[...this.symbolToInfo.entries()].filter(([i,a])=>a.count===1||i==="...").map(([i])=>i).join("");else if(!n.match(RegExp(kn)))throw new Error("Invalid RHS");(s=n.match(RegExp(Ti,"g")))==null||s.forEach(i=>{if(i==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let a=this.symbolToInfo.get(i);if(a===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(a.dimValue)}}),this.rhs=this.processTerm(n,!1,this.outputDims)}addSymbol(e,t,r){let n=this.symbolToInfo.get(e);if(n!==void 0){if(n.dimValue!==t&&n.count!==1)throw new Error("Dimension mismatch");n.count++,n.inputIndices.push(r)}else n={count:1,dimValue:t,inputIndices:[r]};this.symbolToInfo.set(e,n)}processTerm(e,t,r,n=-1){let s=r.length,i=!1,a=[],o=0;if(!e.match(RegExp(ma))&&!t&&e!=="")throw new Error("Invalid LHS term");let u=e.match(RegExp(Ti,"g")),l=new rp(n);return u==null||u.forEach((c,p)=>{if(c==="..."){if(i)throw new Error("Only one ellipsis is allowed per input term");i=!0;let h=s-u.length+1;if(h<0)throw new Error("Ellipsis out of bounds");if(a=r.slice(o,o+h),this.hasEllipsis){if(this.ellipsisDims.length!==a.length||this.ellipsisDims.toString()!==a.toString())throw new Error("Ellipsis dimensions mismatch")}else if(t)this.hasEllipsis=!0,this.ellipsisDims=a;else throw new Error("Ellipsis must be specified in the LHS");for(let m=0;m<a.length;m++){let g=String.fromCharCode(48+m);l.addSymbol(g,p+m),this.addSymbol(g,r[o++],n)}}else l.addSymbol(c,p+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(c,r[o++],n)}),l}},ga=e=>e+"_max",ip=(e,t,r,n)=>{let s=e.map(l=>l.length).map((l,c)=>U(`input${c}`,t,l)),i=B.size(n),a=ce("output",t,n.length),o=[...r.symbolToInfo.keys()].filter(l=>!r.rhs.symbolToIndices.has(l)),u=l=>{let c=[],p="var prod = 1.0;",h="var sum = 0.0;",m="sum += prod;",g=[],y=[],x=[],w=[],b=r.symbolToInfo.size===r.rhs.symbolToIndices.size;r.symbolToInfo.forEach((S,I)=>{var z;if(r.rhs.symbolToIndices.has(I)){let O=(z=r.rhs.symbolToIndices.get(I))==null?void 0:z[0];O!==void 0&&r.lhs.forEach((R,N)=>{if(S.inputIndices.includes(N)){let G=R.symbolToIndices.get(I);if(G===void 0)throw new Error("Invalid symbol error");G.forEach(ue=>{c.push(`${s[N].indicesSet(`input${N}Indices`,ue,a.indicesGet("outputIndices",O))}`)})}})}else r.lhs.forEach((O,R)=>{if(S.inputIndices.includes(R)){let N=O.symbolToIndices.get(I);if(N===void 0)throw new Error("Invalid symbol error");N.forEach(G=>{g.push(`${s[R].indicesSet(`input${R}Indices`,G,`${I}`)}`)}),w.push(`prod *= ${s[R].getByIndices(`input${R}Indices`)};`)}}),y.push(`for(var ${I}: u32 = 0; ${I} < uniforms.${ga(I)}; ${I}++) {`),x.push("}")});let k=b?[...c,`let sum = ${s.map((S,I)=>S.getByIndices(`input${I}Indices`)).join(" * ")};`]:[...c,h,...y,...g,p,...w,m,...x];return`
            ${l.registerUniforms(o.map(S=>({name:`${ga(S)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...s,a)}
...
`)}
  ...
  ${I.mainStart()}
      ...
      `},Gp=(e,t,r)=>{let n="";for(let s=t-1;s>=0;--s)n+=`
          ...
          `},Zp=(e,t,r)=>{switch(r.mode){case 0:return Fp(e,t,r.pads.length);case 1:return Gp(e,t,r.pads.length);case 2:return jp(e,t,r.pads.length);case 3:return Kp(e,t,r.pads.length);default:throw new Error("Invalid mode")}},Qp=(e,t)=>{let r=B.padShape(e[0].dims.slice(),t.pads),n=e[0].dims,s=B.size(r),i=[{type:12,data:s},{type:6,data:t.pads}],a=e.length>=3&&e[2].data;t.mode===0&&i.push({type:a?e[2].dataType:1,data:t.value}),i.push(...he(e[0].dims,r));let o=["rank"],u=l=>{let c=ce("output",e[0].dataType,r.length),p=U("x",e[0].dataType,n.length),h=p.type.value,m=Zp(c,n.length,t),g=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&g.push({name:"constant_value",type:a?h:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},Sa=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,Yp=e=>`${Sa(e)};${e.countIncludePad}`,Jp=e=>`${Sa(e)};${e.storageOrder};${e.dilations}`,ka=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),Ta=(e,t,r,n)=>{let[s,i]=$a(t,n,r),a=U("x",t.dataType,t.dims.length),o=a.type.value,u="value += x_val;",l="";s.countIncludePad?l+=`value /= ${o}(uniforms.kernelSize);`:l+=`value /= ${o}(i32(uniforms.kernelSize) - pad);`;let[c,p,h,m,g]=va(i,s);c.push(...he(t.dims,i));let y=["rank"];return{name:e,shaderCache:{hint:`${n.cacheKey};${h};${m};${g}`,inputDependencies:y},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(B.size(i)/64)},programUniforms:c}),getShaderSource:x=>xa(x,a,t.dims.length,i.length,s,u,l,0,p,h,m,g)}},ly=e=>{let t=e.count_include_pad!==0,r=ka(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let n={countIncludePad:t,...r,cacheKey:""};return{...n,cacheKey:Yp(n)}},dy=(e,t)=>{Tn(e.inputs),e.compute(Ta("AveragePool",e.inputs[0],!1,t))},Ea={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},cy=e=>{let t=e.format;return{format:t,...Ea,cacheKey:t}},py=(e,t)=>{Tn(e.inputs),e.compute(Ta("GlobalAveragePool",e.inputs[0],!0,t))},Ia=(e,t,r,n)=>{let[s,i]=$a(t,n,r),a=`
      value = max(x_val, value);
    `,o="",u=U("x",t.dataType,t.dims.length),l=["rank"],[c,p,h,m,g]=va(i,s);return c.push(...he(t.dims,i)),{name:e,shaderCache:{hint:`${n.cacheKey};${h};${m};${g}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(B.size(i)/64)},programUniforms:c}),getShaderSource:y=>xa(y,u,t.dims.length,i.length,s,a,o,t.dataType===10?-65504:-1e5,p,h,m,g)}},fy=(e,t)=>{Tn(e.inputs),e.compute(Ia("MaxPool",e.inputs[0],!1,t))},hy=e=>{let t=e.storage_order,r=e.dilations,n=ka(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let s={storageOrder:t,dilations:r,...n,cacheKey:""};return{...s,cacheKey:Jp(s)}},my=e=>{let t=e.format;return{format:t,...Ea,cacheKey:t}},gy=(e,t)=>{Tn(e.inputs),e.compute(Ia("GlobalMaxPool",e.inputs[0],!0,t))}}),ef,tf,_y,yy,V1=j(()=>{we(),xe(),Ke(),ke(),ef=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,n)=>r===e[2].dims[n]).reduce((r,n)=>r&&n,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((s,i)=>i===t.axis||s===e[0].dims[i]).reduce((s,i)=>s&&i,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],n=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/n)||t.blockSize>Math.ceil(r/(n-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},tf=(e,t)=>{let r=B.normalizeAxis(t.axis,e[0].dims.length),n=e[0].dataType,s=n===3,i=e[0].dims,a=e[1].dataType,o=B.size(i),u=n===3||n===2,l=u?[Math.ceil(B.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,p=e.length>2?e[2]:void 0,h=p?u?[Math.ceil(B.size(p.dims)/4)]:p.dims:void 0,m=c.length===0||c.length===1&&c[0]===1,g=m===!1&&c.length===1,y=Ge(o),x=m&&(!u||y===4),w=x?y:1,b=x&&!u?y:1,k=U("input",u?12:n,l.length,b),S=U("scale",a,c.length),I=p?U("zero_point",u?12:n,h.length):void 0,z=ce("output",a,i.length,w),O=[k,S];I&&O.push(I);let R=[l,c];p&&R.push(h);let N=[{type:12,data:o/w},{type:12,data:r},{type:12,data:t.blockSize},...he(...R,i)],G=ue=>{let ne=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      ${z.setByOffset("global_idx",`${z.type.value}(x_value - zero_point_value) * scale_value`)};
        ...
        output[global_idx] = uniforms.start + ${p}(global_idx) * uniforms.delta;
              ...
              ${s}bitcast<${n}>(oldValue) + (${r})${i}`;case"max":return n==="i32"||n==="u32"?`atomicMax(&${t}, bitcast<${n}>(${r}));`:`
                ${s}max(bitcast<f32>(oldValue), (${r}))${i}`;case"min":return n==="i32"||n==="u32"?`atomicMin(&${t}, bitcast<${n}>(${r}));`:`${s}min(bitcast<${n}>(oldValue), (${r}))${i}`;case"mul":return`${s}(bitcast<${n}>(oldValue) * (${r}))${i}`;default:throw new Error(`Reduction ${e} is not supported.`)}},Ca=(e,t)=>`${e===1?`
    ...
    data_offset += u32((u32(index) * element_count_dim));`,za=(e,t,r)=>`for (var i = 0u; i < uniforms.num_updates_elements; i++) {
...
`}
      ...
      }`},S=[{dims:o,dataType:e[0].dataType}];return r>1&&S.push({dims:c,dataType:1}),r>2&&S.push({dims:c,dataType:1}),r>3&&S.push({dims:i,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${w};${m};${g};${y}`,inputDependencies:e.map((I,z)=>"type")},getShaderSource:k,getRunData:()=>({outputs:S,dispatchGroup:{x:Math.ceil(u/l)},programUniforms:b})}},Sy=(e,t)=>{xf(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(Sf(e.inputs,t,e.outputCount,!1),{outputs:r})}}),kf,En,Tf,Ra,Ef,If,ky,Ty,K1=j(()=>{we(),xe(),Ke(),ke(),kf=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,n)=>{if(e[n+1].dataType!==6&&e[n+1].dataType!==7)throw new Error(`Input ${n} must be an array of int32 or int64`)})},En=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(n=>r.push(Number(n)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(n=>r.push(Number(n)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Tf=(e,t)=>{if(e.length>1){let r=En(e,1),n=En(e,2),s=En(e,3);return s.length===0&&(s=[...Array(e[0].dims.length).keys()]),Ne({starts:r,ends:n,axes:s})}else return t},Ra=(e,t,r,n,s)=>{let i=e;return e<0&&(i+=r[n[t]]),s[t]<0?Math.max(0,Math.min(i,r[n[t]]-1)):Math.max(0,Math.min(i,r[n[t]]))},Ef=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
 ...
 * limitations under the License.
 * =============================================================================
 */const s2={__name:"HomeView",setup(e){Le.wasm.numThreads=4,Le.wasm.wasmPaths={wasm:"./ort-wasm-simd-threaded.jsep.wasm"};async function t(o){return new Promise((u,l)=>{const c=new Image;c.crossOrigin="anonymous",c.onload=()=>u(c),c.onerror=l,c.src=o})}function r(o,u,l,c){console.time(`Preprocess Image Time ${c}`);const p=document.createElement("canvas");p.width=u,p.height=l;const h=p.getContext("2d");h.drawImage(o,0,0,u,l);const m=h.getImageData(0,0,u,l).data,g=new Float32Array(u*l);for(let y=0;y<u*l;y++){const x=m[y*4]/255,w=m[y*4+1]/255,b=m[y*4+2]/255;g[y]=.299*x+.587*w+.114*b}return console.timeEnd(`Preprocess Image Time ${c}`),g}async function n(){return await qo.create("./superpoint_lightglue_pipeline.ort.onnx")}const s=Fa(null),i=Fa(null);async function a(){try{const o=["./otwarcie_fabryczna_testowy.jpg","./fabryczna_otwarcie_topo.jpg"],u=await Promise.all(o.map(I=>t(I))),l=256,c=256,p=u.map((I,z)=>r(I,l,c,z));await new Promise(I=>setTimeout(I,100));const h=new Float32Array([...p[0],...p[1]]),g={images:new Mt("float32",h,[2,1,c,l])},y=performance.now(),x=await n();i=`${(performance.now()-y).toFixed(2)} ms`;const b=performance.now(),k=await x.run(g),S=performance.now();s.value=`${(S-b).toFixed(2)} ms`,console.log("Inference results:",k)}catch(o){console.error(`Failed to inference ONNX model: ${o}`)}}return a(),(o,u)=>(Gh(),Xw("main",null,[u[0]||(u[0]=Zh(" Hello World ")),Li("p",null,"Inference Time: "+Ua(s.value),1),Li("p",null,"Session Time: "+Ua(i.value),1)]))}},a2=Nv({history:pv("/"),routes:[{path:"/",name:"home",component:s2}]}),Qy=R$(Dv);console.log("a change4");Qy.use(a2);Qy.mount("#app");
