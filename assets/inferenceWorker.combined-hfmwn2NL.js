...
}`}},rs=e=>{ts(e.inputs),e.compute(is(e.inputs))}}),as,j,ns,ss,os,us,ls,ds,ps,cs,hs,fs,ms,gs,_s,ys,$t,$s,Ft,ws,bs,vs,xs,ks,Ss,Is,Ts,zs,Es,Cs,Os,As,Bs,Rs,Ds,Hi,Ms,Fi,Ki,Us,Ps,qs,Ns,Vs,Ls,ji=T(()=>{N(),W(),re(),G(),as=(e,t,i,r,a,n,s)=>{let o=Math.ceil(t/4),u="";typeof a=="string"?u=`${a}(a)`:u=a("a");let l=S("inputData",i,[o],4),d=B("outputData",r,[o],4),p=[{name:"vec_size",type:"u32"}];return s&&p.push(...s),`
...
`};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${p};${c};${h};${a}`,inputDependencies:g?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:m}),getShaderSource:w}}}),ho,fo,Ji,er,mo,tr,go,Kt,ir=T(()=>{N(),W(),G(),Je(),Yi(),Qi(),ho=(e,t)=>e?`
...
}`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${s};${d};${f}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:l[0],y:l[1],z:l[2]},programUniforms:c}),getShaderSource:g}}}),ko,So,Ep=T(()=>{N(),W(),G(),Je(),ko=(e,t,i,r)=>{let a=e.length>2,n=a?"value += b[output_channel];":"",s=e[0].dims,o=e[1].dims,u=t.format==="NHWC",l=u?i[3]:i[1],d=l/t.group,p=u&&d>=4?ie(l):1,c=k.size(i)/p,h=[{type:12,data:c},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:d}];Xe(t,h),h.push(...M(s,[o[0],o[1],o[2],o[3]/p]));let f=a?["rank","rank","rank"]:["rank","rank"];h.push(...M([i[0],i[1],i[2],i[3]/p]));let g=y=>{let _=B("output",e[0].dataType,i.length,p),m=ne(_.type.tensor),w=Qe(t,_.type.value,m),$=S("x",e[0].dataType,s.length),b=S("w",e[1].dataType,o.length,p),x=[$,b];a&&x.push(S("b",e[2].dataType,e[2].dims,p));let v=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];Ye(t,v);let I=u?`
...
}`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${p}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:h}),getShaderSource:g}},So=(e,t,i,r)=>{let a=e.length>2,n=ie(i[3]),s=ie(i[2]),o=k.size(i)/n/s,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/n],l=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/n],d=[i[0],i[1],i[2],i[3]/n],p=[{type:12,data:o},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Xe(t,p),p.push(...M(u,l,d));let c=(s-1)*t.strides[1]+l[1],h=f=>{let g=B("output",e[0].dataType,d.length,n),y=ne(g.type.tensor),_=Qe(t,g.type.value,y),m=S("x",e[0].dataType,u.length,n),w=S("w",e[1].dataType,l.length,n),$=[m,w];a&&$.push(S("b",e[2].dataType,e[2].dims,n));let b=a?"value += b[output_channel];":"",x=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Ye(t,x),`
...
}`};return{name:"Einsum",shaderCache:{hint:i.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=o.filter(p=>i.symbolToInfo.has(p)).map(p=>({type:12,data:i.symbolToInfo.get(p)?.dimValue||0}));l.push({type:12,data:n});let d=e.map((p,c)=>[...M(p)]).reduce((p,c)=>p.concat(c),l);return d.push(...M(r)),{outputs:[{dims:r,dataType:t}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:d}},getShaderSource:u}},Xo=(e,t)=>{let i=new Zo(e.inputs,t.equation),r=i.outputDims,a=e.inputs.map((n,s)=>n.dims);e.compute(Qo(a,e.inputs[0].dataType,i,r))},Yo=e=>{let t=e.equation.replace(/\s+/g,"");return Q({equation:t})}}),Jo,cr,eu,tu,iu,Mp=T(()=>{N(),W(),G(),Jo=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,i=Array.from(e[1].getBigInt64Array(),Number),r=i.length<t.length?0:i.length-t.length,a=t.length<i.length?0:t.length-i.length;for(;r<i.length&&a<t.length;++r,++a)if(i[r]!==t[a]&&i[r]!==1&&t[a]!==1)throw new Error("Expand requires shape to be broadcastable to input")},cr=(e,t)=>{let i=e.length-t.length,r=[];for(let a=0;a<i;++a)r.push(e[a]);for(let a=0;a<t.length;++a)r.push(t[a]===1?e[a+i]:t[a]);return r},eu=(e,t)=>e.length>t.length?cr(e,t):cr(t,e),tu=e=>{let t=e[0].dims,i=Array.from(e[1].getBigInt64Array(),Number),r=eu(t,i),a=e[0].dataType,n=a===9||k.size(t)===1,s=a===9||t.length>0&&t[t.length-1]%4===0?4:1,o=n||r.length>0&&r[r.length-1]%4===0?4:1,u=Math.ceil(k.size(r)/o),l=p=>{let c=S("input",a,t.length,s),h=B("output",a,r.length,o),f;if(a===9){let g=(y,_,m="")=>`
...
${f}`},d=[{type:12,data:u},...M(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${s}${o}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d})}},iu=e=>{Jo(e.inputs),e.compute(tu(e.inputs),{inputs:[0]})}}),ru,au,Up=T(()=>{N(),W(),G(),ji(),ru=e=>{let t=e[0].dataType,i=k.size(e[0].dims),r=k.size(e[1].dims),a=r%4===0,n=s=>{let o=S("x",t,[1],4),u=S("bias",t,[1],4),l=B("y",t,[1],4),d=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],p=h=>`
...
}`};return{name:"FastGeluWithBias",shaderCache:{hint:`${a}`,inputDependencies:["type","type"]},getShaderSource:n,getRunData:s=>({outputs:[{dims:s[0].dims,dataType:s[0].dataType}],programUniforms:[{type:12,data:Math.ceil(i/4)},{type:12,data:r}],dispatchGroup:{x:Math.ceil(i/st/4)}})}},au=e=>{e.inputs.length<2||k.size(e.inputs[1].dims)===0?Us(e):e.compute(ru(e.inputs))}}),nu,su,ou,uu,Pp=T(()=>{N(),W(),re(),G(),nu=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},su=(e,t)=>{let i=e[0].dims,r=e[1].dims,a=i.length,n=k.normalizeAxis(t.axis,a),s=i.slice(0);s.splice(n,1,...r);let o=i[n],u=e[0].dataType===9?4:1,l=Math.ceil(k.size(s)/u),d=[{type:12,data:l},{type:6,data:o},{type:12,data:n},...M(e[0].dims,e[1].dims,s)],p=c=>{let h=S("data",e[0].dataType,e[0].dims.length,u),f=S("inputIndices",e[1].dataType,e[1].dims.length),g=B("output",e[0].dataType,s.length,u),y=m=>{let w=r.length,$=`var indicesIndices${m}  = ${f.type.indices}(0);`;for(let b=0;b<w;b++)$+=`${w>1?`indicesIndices${m}[${b}]`:`indicesIndices${m}`} = ${s.length>1?`outputIndices${m}[uniforms.axis + ${b}]`:`outputIndices${m}`};`;$+=`
...
}`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((h,f)=>f!==1).map(h=>h.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(h,f)=>"rank")},getRunData:()=>({outputs:[{dims:o,dataType:l}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:c}},fu=(e,t)=>{let i=e.inputs;cu(i,t),e.compute(hu(e.inputs,t))},mu=e=>Q({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),gu,_u,yu,$u,Vp=T(()=>{N(),W(),re(),G(),gu=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
          indices input tensors be of same rank.`)},_u=(e,t)=>{let i=e[0].dims,r=e[0].dataType,a=i.length,n=e[1].dims,s=e[1].dataType,o=k.normalizeAxis(t.axis,a),u=i[o],l=n.slice(0),d=k.size(l),p=S("input",r,a),c=S("indicesInput",s,n.length),h=B("output",r,l.length),f=[{type:12,data:d},{type:6,data:u},{type:12,data:o}];return f.push(...M(i,n,l)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:f}),getShaderSource:g=>`
...
}`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:o,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:d},{inputs:[t,i],outputs:[-1]})[0]},xt=(e,t,i,r,a,n,s,o)=>{let u=n;if(s&&k.size(s.dims)>0){if(r===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=Mu(e,n,s,t,r,i*a,o),u=u.reshape([t,r,i,a]),i===1||r===1?u:e.compute(ye(u,hr.perm),{inputs:[u],outputs:[-1]})[0]}else return n.dims.length===3&&(u=n.reshape([t,r,i,a])),i===1||r===1?u:e.compute(ye(u,hr.perm),{inputs:[u],outputs:[-1]})[0]},Uu=(e,t)=>{let i=Ru(e.inputs,t),r=e.inputs[0],a=he(e.inputs,1),n=he(e.inputs,2),s=he(e.inputs,3),o=he(e.inputs,4),u=he(e.inputs,5),l=he(e.inputs,6),d=he(e.inputs,7);if(r.dims.length===5)throw new Error("Packed QKV is not implemented");if(a?.dims.length===5)throw new Error("Packed KV is not implemented");let p=a&&n&&a.dims.length===4&&n.dims.length===4,c=xt(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,r,s,0);if(p)return yt(e,c,a,n,o,void 0,l,d,u,i);if(!a||!n)throw new Error("key and value must be provided");let h=xt(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.headSize,a,s,i.hiddenSize),f=xt(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.vHeadSize,n,s,2*i.hiddenSize);yt(e,c,h,f,o,void 0,l,d,u,i)}}),qu,Nu,Vu,Lu,fr,Wu,Gu,Hu=T(()=>{N(),W(),re(),G(),qu=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Nu=(e,t)=>{let i=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(a=>i.push(Number(a))),r=i.length),Q({numOutputs:r,axis:t.axis,splitSizes:i})},Vu=e=>`
...
}`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:h,getRunData:()=>({outputs:l,dispatchGroup:{x:Math.ceil(r/64)},programUniforms:c})}},Wu=(e,t)=>{qu(e.inputs);let i=e.inputs.length===1?t:Nu(e.inputs,t);e.compute(fr(e.inputs,i),{inputs:[0]})},Gu=e=>{let t=e.axis,i=e.splitSizes,r=e.numOutputs<0?i.length:e.numOutputs;if(r!==i.length)throw new Error("numOutputs and splitSizes lengh must be equal");return Q({axis:t,numOutputs:r,splitSizes:i})}}),Fu,Xt,Ku,ju=T(()=>{N(),W(),re(),G(),Fu=(e,t)=>{let[i,r,a,n]=e,{numHeads:s,rotaryEmbeddingDim:o}=t;if(i.dims.length!==3&&i.dims.length!==4)throw new Error(`Input 'x' is expected to have 3 or 4 dimensions, got ${i.dims.length}`);if(!k.areEqual(r.dims,[])&&!k.areEqual(r.dims,[1])&&r.dims.length!==2)throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${r.dims.length}`);if(a.dims.length!==2)throw new Error(`Input 'cos_cache' is expected to have 2 dimensions, got ${a.dims.length}`);if(n.dims.length!==2)throw new Error(`Input 'sin_cache' is expected to have 2 dimensions, got ${n.dims.length}`);if(!k.areEqual(a.dims,n.dims))throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");if(o>0&&s===0)throw new Error("num_heads must be provided if rotary_embedding_dim is specified");let u=i.dims[0],l=i.dims[i.dims.length-2],d=a.dims[0],p=k.sizeFromDimension(i.dims,1)/l,c=o===0?a.dims[1]*2:p/s;if(o>c)throw new Error("rotary_embedding_dim must be less than or equal to head_size");if(r.dims.length===2){if(u!==r.dims[0])throw new Error(`Input 'position_ids' dimension 0 should be of size batch_size, got ${r.dims[0]}`);if(l!==r.dims[1])throw new Error(`Input 'position_ids' dimension 1 should be of size sequence_length, got ${r.dims[1]}`)}if(c/2!==a.dims[1]&&o/2!==a.dims[1])throw new Error(`Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${a.dims[1]}`);if(l>d)throw new Error("Updating cos_cache and sin_cache in RotaryEmbedding is not currently supported")},Xt=(e,t)=>{let{interleaved:i,numHeads:r,rotaryEmbeddingDim:a,scale:n}=t,s=e[0].dims[0],o=k.sizeFromDimension(e[0].dims,1),u=e[0].dims[e[0].dims.length-2],l=o/u,d=e[2].dims[1],p=a===0?d*2:l/r,c=new Array(s,u,l/p,p-d),h=k.computeStrides(c),f=[{type:1,data:n},{type:12,data:c},{type:12,data:h},...e[0].dims.length===3?new Array({type:12,data:[o,l,p,1]}):[],...e[0].dims.length===4?new Array({type:12,data:[o,p,u*p,1]}):[],...M(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)],g=y=>{let _=S("input",e[0].dataType,e[0].dims.length),m=S("position_ids",e[1].dataType,e[1].dims.length),w=S("cos_cache",e[2].dataType,e[2].dims.length),$=S("sin_cache",e[3].dataType,e[3].dims.length),b=B("output",e[0].dataType,e[0].dims.length);return y.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:c.length},{name:"global_strides",type:"u32",length:h.length},{name:"input_output_strides",type:"u32",length:h.length}]),`
...
`};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:n},getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:u}),getShaderSource:l}},Yu=(e,t)=>{let i=Zu(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let r=e.inputs[0],a=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,n=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,s=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,o=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,u=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,d=i.kvNumHeads?i.kvNumHeads:i.numHeads,p=Q({axis:2,numOutputs:3,splitSizes:[i.numHeads*i.headSize,d*i.headSize,d*i.headSize]}),[c,h,f]=!a&&!n?e.compute(fr([r],p),{inputs:[r],outputs:[-1,-1,-1]}):[r,a,n],g,y;if(t.doRotary){let $=e.compute(Xu(i.batchSize,i.sequenceLength,u,l),{inputs:[u,l],outputs:[-1]})[0],b=e.inputs[7],x=e.inputs[8],v=Q({interleaved:t.rotaryInterleaved!==0,numHeads:i.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),I=[c,$,b,x],z=[-1];g=e.compute(Xt(I,v),{inputs:I,outputs:z})[0],I.splice(0,1,h);let O=Q({interleaved:t.rotaryInterleaved!==0,numHeads:i.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});y=e.compute(Xt(I,O),{inputs:I,outputs:z})[0]}let _=xt(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,t.doRotary?g:c,void 0,0),m=mr(e,t.doRotary?y:h,i),w=mr(e,f,i);yt(e,_,m,w,void 0,void 0,s,o,void 0,i,u,l)}}),gr,Ju,el,tl,Hp=T(()=>{N(),W(),Le(),G(),gr=(e,t,i,r,a,n,s,o)=>{let u=ie(n),l=u===1?"f32":`vec${u}f`,d=u===1?"vec2f":`mat2x${u}f`,p=a*s,c=64;p===1&&(c=256);let h=[a,s,n/u],f=[a,s,2],g=["rank","type","type"],y=[];y.push(...M(h,f));let _=m=>{let w=S("x",t.dataType,3,u),$=S("scale",i.dataType,i.dims),b=S("bias",r.dataType,r.dims),x=B("output",1,3,2),v=[w,$,b,x];return`
...
}`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${o};${c}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:f,dataType:1}],dispatchGroup:{x:p},programUniforms:y}),getShaderSource:_},{inputs:[t,i,r],outputs:[-1]})[0]},Ju=(e,t,i)=>{let r=t[0].dims,a=r,n=2,s=r[0],o=r[1],u=k.sizeFromDimension(r,n),l=ie(u),d=k.size(a)/l,p=gr(e,t[0],t[1],t[2],s,u,o,i.epsilon),c=[s,o,u/l],h=[s,o],f=["type","none"],g=y=>{let _=S("x",t[0].dataType,c.length,l),m=S("scale_shift",1,h.length,2),w=B("output",t[0].dataType,c.length,l),$=[_,m,w];return`
...
}`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:y},{inputs:[t[0],g]})},tl=(e,t)=>{t.format==="NHWC"?el(e,e.inputs,t):Ju(e,e.inputs,t)}}),il,rl,al,Fp=T(()=>{N(),W(),G(),il=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},rl=(e,t,i)=>{let r=t.simplified,a=e[0].dims,n=e[1],s=!r&&e[2],o=a,u=k.normalizeAxis(t.axis,a.length),l=k.sizeToDimension(a,u),d=k.sizeFromDimension(a,u),p=k.size(n.dims),c=s?k.size(s.dims):0;if(p!==d||s&&c!==d)throw new Error(`Size of X.shape()[axis:] == ${d}.
Size of scale and bias (if provided) must match this.
Got scale size of ${p} and bias size of ${c}`);let h=[];for(let b=0;b<a.length;++b)b<u?h.push(a[b]):h.push(1);let f=ie(d),g=["type","type"],y=[{type:12,data:l},{type:1,data:d},{type:12,data:Math.floor(d/f)},{type:1,data:t.epsilon}];s&&g.push("type");let _=i>1,m=i>2,w=b=>{let x=ne(e[0].dataType),v=[S("x",e[0].dataType,e[0].dims,f),S("scale",n.dataType,n.dims,f)];s&&v.push(S("bias",s.dataType,s.dims,f)),v.push(B("output",e[0].dataType,o,f)),_&&v.push(B("mean_data_output",1,h)),m&&v.push(B("inv_std_output",1,h));let I=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
...
}`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${p};${c};${h};${g};${_}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:f,dataType:d}],dispatchGroup:{x:y},programUniforms:m}),getShaderSource:x}},ll=(e,t)=>{let i=e[0].dims,r=i.length,a=i[r-2],n=t.k,s=t.n,o=i.slice(0,r-2),u=k.size(o),l=e[1].dims[2]/4,d=e[0].dataType,p=ie(t.k),c=ie(l),h=o.concat([a,s]),f=128,g=s%8===0?8:s%4===0?4:1,y=f/g,_=y*c*8,m=_/p,w=_/t.blockSize,$=k.size(h)/g,b=[],x=[u,a,n/p],v=k.convertShape(e[1].dims).slice();v.splice(-1,1,l/c),b.push(...M(x)),b.push(...M(v)),b.push(...M(e[2].dims)),e.length===4&&b.push(...M(k.convertShape(e[3].dims)));let I=[u,a,s];b.push(...M(I));let z=O=>{let V=x.length,U=S("a",e[0].dataType,V,p),L=S("b",12,v.length,c),A=S("scales",e[2].dataType,e[2].dims.length),F=[U,L,A],q=e.length===4?S("zero_points",12,e[3].dims.length):void 0;q&&F.push(q);let D=I.length,Z=B("output",e[0].dataType,D),P=ne(e[0].dataType),te=()=>{switch(p){case 1:return`
...
}`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${p};${c};${y};${g}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:h,dataType:d}],dispatchGroup:{x:$},programUniforms:b}),getShaderSource:z}},dl=(e,t)=>{ol(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(ll(e.inputs,t)):e.compute(ul(e.inputs,t))},pl=e=>Q(e)}),cl,hl,fl,ml,gl,_l,yl,$l,wl,Zp=T(()=>{N(),W(),G(),cl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},hl=(e,t,i)=>{let r="";for(let a=t-1;a>=0;--a)r+=`
...
}`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getShaderSource:O,getRunData:()=>({outputs:[{dims:n,dataType:s}],dispatchGroup:{x:Math.ceil(o/_/64),y:1,z:1},programUniforms:z})}},Bl=(e,t)=>{Ol(e.inputs,t),e.compute(Al(e.inputs,t))},Rl=e=>Q({axis:e.axis,blockSize:e.blockSize})}),Dl,Ml,Ul,Yp=T(()=>{ke(),N(),G(),Dl=(e,t,i)=>{let r=e===t,a=e<t&&i<0,n=e>t&&i>0;if(r||a||n)throw new Error("Range these inputs' contents are invalid.")},Ml=(e,t,i,r)=>{let a=Math.abs(Math.ceil((t-e)/i)),n=[a],s=a,o=[{type:12,data:s},{type:r,data:e},{type:r,data:i},...M(n)],u=l=>{let d=B("output",r,n.length),p=d.type.value,c=[{name:"outputSize",type:"u32"},{name:"start",type:p},{name:"delta",type:p}];return`
...
}`,ql=(e,t)=>{let i=e[0].dims,r=e[1].dims,a=i,n=1,s=Math.ceil(k.size(r)/n),o=r[r.length-1],u=k.sizeFromDimension(i,o),l=k.sizeFromDimension(r,0)/o,d=[{type:12,data:s},{type:12,data:o},{type:12,data:u},...M(e[1].dims,e[2].dims,a)],p=c=>{let h=S("indices",e[1].dataType,e[1].dims.length),f=S("updates",e[2].dataType,e[2].dims.length,n),g=t.reduction!=="none"&&t.reduction!==""?Ha("output",e[0].dataType,a.length):B("output",e[0].dataType,a.length,n);return`
...
}`},ed=(e,t,i,r,a,n,s,o,u,l)=>{let d=i.length===2,[p,c]=d?[0,1]:[2,3],h=e.type.value,f=g=>{let y=g===p?"row":"col";return`
...
}`},id=(e,t,i,r,a,n)=>{let s=e.dims,o=Kl(n,t.axes,s.length),u=jl(s,r,a,t.axes),l=r.slice();r.length===0&&(l=s.map((m,w)=>m===0?1:u[w]/m),t.keepAspectRatioPolicy!=="stretch"&&(u=Zl(s,l,t)));let d=B("output",e.dataType,u.length),p=S("input",e.dataType,s.length),c=k.size(u),h=s.length===u.length&&s.every((m,w)=>m===u[w]),f=t.coordinateTransformMode==="tf_crop_and_resize",g=t.extrapolationValue,y=p.type.value,_=m=>`
${h?"":`
...
}`;return{name:"Slice",shaderCache:{hint:`${u.length}_${s.length}_${n.length}`,inputDependencies:["rank"]},getShaderSource:y,getRunData:()=>({outputs:[d],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:g})}},hd=(e,t)=>{ld(e.inputs,t);let i=dd(e.inputs,t);e.compute(cd(e.inputs,i),{inputs:[0]})},fd=e=>{let t=e.starts,i=e.ends,r=e.axes;return Q({starts:t,ends:i,axes:r})}}),md,gd,_d,yd,rc=T(()=>{N(),W(),re(),Le(),G(),md=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},gd=(e,t)=>{let i=e.inputs[0],r=i.dims,a=k.size(r),n=r.length,s=k.normalizeAxis(t.axis,n),o=s<r.length-1,u,l=[];o?(l=Array.from({length:n},(v,I)=>I),l[s]=n-1,l[n-1]=s,u=e.compute(ye(i,l),{inputs:[i],outputs:[-1]})[0]):u=i;let d=u.dims,p=d[n-1],c=a/p,h=ie(p),f=p/h,g=64;c===1&&(g=256);let y=(v,I)=>I===4?`max(max(${v}.x, ${v}.y), max(${v}.z, ${v}.w))`:I===2?`max(${v}.x, ${v}.y)`:I===3?`max(max(${v}.x, ${v}.y), ${v}.z)`:v,_=S("x",u.dataType,u.dims,h),m=B("result",u.dataType,u.dims,h),w=_.type.value,$=ne(u.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,b=v=>`
...
if (lindex == 0) {
rowSumShared = ${w}(${Ve("threadShared[0]",h)});
}
workgroupBarrier();
 ...
 * limitations under the License.
 * =============================================================================
 */typeof exports=="object"&&typeof module=="object"&&(module.exports=Ct),console.log("wow3"),Ct.env.wasm.numThreads=4,self.onmessage=async He=>{const{type:Oe,userImageBuffer:Ae,topoImageBuffer:lt}=He.data;if(Oe==="createSession"){console.log("createSession in worker 2");try{const ce=performance.now(),T=await Ct.InferenceSession.create("../../superpoint_lightglue_pipeline.ort.onnx",{executionProviders:["wasm"],graphOptimizationLevel:"all",wasm:{numThreads:navigator.hardwareConcurrency?Math.max(1,Math.min(4,navigator.hardwareConcurrency)):2,simd:!0,threads:!0}}),de=performance.now();self.session=T,self.postMessage({type:"sessionCreated",data:{sessionTime:de-ce}})}catch(ce){self.postMessage({type:"error",data:{message:ce.message}})}}if(Oe==="runInference"){if(!self.session){self.postMessage({type:"error",data:{message:"Session is not initialized."}});return}let ce=null,T=null,de=null,Ne=null;try{if(!Ae||!lt){self.postMessage({type:"error",data:{message:"Both user and topo images must be provided."}});return}de=new Blob([Ae]),ce=await createImageBitmap(de),Ne=new Blob([lt]),T=await createImageBitmap(Ne);const le=[ce,T],De={width:ce.width,height:ce.height},$e={width:T.width,height:T.height},me=256,at=256,dt=le.map((Bt,J)=>tp(Bt,me,at,J)),Ot=new Float32Array([...dt[0],...dt[1]]),At={images:new Ct.Tensor("float32",Ot,[2,1,at,me])},ri=performance.now(),pt=await self.session.run(At),fe=performance.now();self.postMessage({type:"inferenceComplete",data:{inferenceTime:fe-ri,results:pt,images:le,imgWidth:me,imgHeight:at,userImageDims:De,topoImageDims:$e}})}catch(le){self.postMessage({type:"error",data:{message:le.message}})}finally{ce&&typeof ce.close=="function"&&ce.close(),T&&typeof T.close=="function"&&T.close(),ce=null,T=null,de=null,Ne=null}}};function tp(He,Oe,Ae,lt){const T=new OffscreenCanvas(Oe,Ae).getContext("2d");T.drawImage(He,0,0,Oe,Ae);const de=T.getImageData(0,0,Oe,Ae).data,Ne=new Float32Array(Oe*Ae);for(let le=0;le<Oe*Ae;le++){const De=de[le*4]/255,$e=de[le*4+1]/255,me=de[le*4+2]/255;Ne[le]=.299*De+.587*$e+.114*me}return Ne}})();
