...
}`})(),M=(...E)=>{if(E.length!==s)throw new Error(`indices length must be ${s}`);let C=E.map(h).join(",");return s===0?A("0u"):s===1?A(C[0]):(f.get=!0,f.getByIndices=!0,f.indicesToOffset=!0,`get_${e}(${C})`)},Z=E=>s<2?A(E):(f.getByIndices=!0,f.indicesToOffset=!0,`get_${e}ByIndices(${E})`),P=s<2?"":`
...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Ka=(e,t)=>new ja(e,t)}),Za,Ni,Qa,Xa,Ya,Ja,we,en,tn,je=T(()=>{N(),W(),ae(),G(),Za=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},Ni=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Qa=(e,t)=>k.sortBasedOnPerm(e,Ni(e.length,t)),Xa=(e,t,i,r)=>{let a=`fn perm(i: ${r.type.indices}) -> ${i.type.indices} {
var a: ${i.type.indices};`;for(let n=0;n<t;++n)a+=`a[${e[n]}]=i[${n}];`;return a+="return a;}"},Ya=(e,t)=>{let i=[],r=[];for(let a=0;a<e.length;++a)e[a]!==1&&i.push(e[a]),e[t[a]]!==1&&r.push(t[a]);return{newShape:i,newPerm:r}},Ja=(e,t)=>{let i=0;for(let r=0;r<e.length;++r)if(t[e[r]]!==1){if(e[r]<i)return!1;i=e[r]}return!0},we=(e,t)=>{let i=e.dataType,r=e.dims.length,a=Ni(r,t),n=Qa(e.dims,a),s=e.dims,o=n,u=r<2||Ja(a,e.dims),l;if(u)return l=f=>{let g=S("input",i,s,4),y=B("output",i,o,4);return`
...
}`},{name:"TransposeShared",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let g=k.size(n);return{outputs:[{dims:n,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(o[1]/f),y:Math.ceil(o[0]/f)},programUniforms:[{type:12,data:g},...D(s,o)]}},getShaderSource:l}}return l=f=>{let g=S("a",i,s.length),y=B("output",i,o.length);return`
${f.registerUniform("output_size","u32").declareVariables(g,y)}
...
}`;return{name:e,shaderCache:{hint:`${t};${c}`,inputDependencies:["type"]},getShaderSource:f,getRunData:()=>({outputs:[{dims:n,dataType:a}],dispatchGroup:{x:u},programUniforms:[{type:12,data:l}]})}},Ee=(e,t,i,r)=>{let a=e.inputs.length===1?i:Vi(e.inputs,i),n=a.axes;n.length===0&&!a.noopWithEmptyAxes&&(n=e.inputs[0].dims.map((h,f)=>f));let s=k.normalizeAxes(n,e.inputs[0].dims.length),o=s,u=e.inputs[0],l=pn(o,e.inputs[0].dims.length);l.length>0&&(u=e.compute(we(e.inputs[0],l),{inputs:[0],outputs:[-1]})[0],o=on(o.length,u.dims.length));let[d,p]=un(u.dims,o),c=d;a.keepDims&&(c=ln(d,s)),e.compute(cn(t,a.cacheKey,[u],r,e.inputs[0].dataType,c,p),{inputs:[u]})},hn=(e,t)=>{Ee(e,"ReduceMeanShared",t,"mean")},fn=(e,t)=>{Ee(e,"ReduceL1Shared",t,"l1")},mn=(e,t)=>{Ee(e,"ReduceL2Shared",t,"l2")},gn=(e,t)=>{Ee(e,"ReduceLogSumExpShared",t,"logSumExp")},_n=(e,t)=>{Ee(e,"ReduceMaxShared",t,"max")},yn=(e,t)=>{Ee(e,"ReduceMinShared",t,"min")},$n=(e,t)=>{Ee(e,"ReduceProdShared",t,"prod")},wn=(e,t)=>{Ee(e,"ReduceSumShared",t,"sum")},bn=(e,t)=>{Ee(e,"ReduceSumSquareShared",t,"sumSquare")},vn=(e,t)=>{Ee(e,"ReduceLogSumShared",t,"logSum")}}),Ce,xn,Ht,Vi,Oe,kn,Sn,In,Tn,zn,En,Cn,On,An,Bn,Ae,Rn,Mn,Dn,Un,Pn,qn,Nn,Vn,Ln,Wn,Li=T(()=>{N(),W(),ae(),G(),wp(),Ce=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},xn=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Ht=(e,t,i,r,a,n,s=!1,o=!1)=>{let u=[],l=i[0].dims,d=l.length,p=k.normalizeAxes(a,d),c=!o&&p.length===0;l.forEach((g,y)=>{c||p.indexOf(y)>=0?s&&u.push(1):u.push(g)});let h=u.length,f=k.size(u);return{name:e,shaderCache:t,getShaderSource:g=>{let y=[],_=S("_A",i[0].dataType,d),m=B("output",n,h),w=r(_,m,p),$=w[2];for(let b=0,x=0;b<d;b++)c||p.indexOf(b)>=0?(s&&x++,$=`for(var j${b}: u32 = 0; j${b} < ${l[b]}; j${b}++) {
...
`)}
}`},getRunData:()=>({outputs:[{dims:u,dataType:n}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:[{type:12,data:f},...D(l,u)]})}},Vi=(e,t)=>{let i=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(r=>i.push(Number(r))),Q({axes:i,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},Oe=(e,t,i,r)=>{let a=e.inputs,n=a.length===1?i:Vi(a,i);e.compute(Ht(t,{hint:n.cacheKey,inputDependencies:["rank"]},[a[0]],n.noopWithEmptyAxes&&n.axes.length===0?xn:r,n.axes,a[0].dataType,n.keepDims,n.noopWithEmptyAxes),{inputs:[0]})},kn=(e,t)=>{Ce(e.inputs),Oe(e,"ReduceLogSum",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${i.getByIndices("input_indices")};`,"value = log(value);"])},Sn=(e,t)=>{Ce(e.inputs),Oe(e,"ReduceL1",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += abs(${i.getByIndices("input_indices")});`,""])},In=(e,t)=>{Ce(e.inputs),Oe(e,"ReduceL2",t,(i,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${i.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])},Tn=(e,t)=>{Ce(e.inputs),Oe(e,"ReduceLogSumExp",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += exp(${i.getByIndices("input_indices")});`,"value = log(value);"])},zn=(e,t)=>{Ce(e.inputs),Oe(e,"ReduceMax",t,(i,r,a)=>{let n=[];for(let s=0;s<i.rank;s++)(a.indexOf(s)>=0||a.length===0)&&n.push(i.indicesSet("input_indices",s,0));return[`${n.join(`
`)}`,`var value = ${i.getByIndices("input_indices")};`,`value = max(value, ${i.getByIndices("input_indices")});`,""]})},En=(e,t)=>{Ce(e.inputs),Oe(e,"ReduceMean",t,(i,r,a)=>{let n=1;for(let s=0;s<i.rank;s++)(a.indexOf(s)>=0||a.length===0)&&(n*=e.inputs[0].dims[s]);return["var sum = f32(0);","",`sum += f32(${i.getByIndices("input_indices")});`,`let value = ${r.type.value}(sum / ${n});`]})},Cn=(e,t)=>{Ce(e.inputs),Oe(e,"ReduceMin",t,(i,r,a)=>{let n=[];for(let s=0;s<i.rank;s++)(a.indexOf(s)>=0||a.length===0)&&n.push(`input_indices[${s}] = 0;`);return[`${n.join(`
`)}`,`var value = ${i.getByIndices("input_indices")};`,`value = min(value, ${i.getByIndices("input_indices")});`,""]})},On=(e,t)=>{Ce(e.inputs),Oe(e,"ReduceProd",t,(i,r)=>[`var value = ${r.type.storage}(1);`,"",`value *= ${i.getByIndices("input_indices")};`,""])},An=(e,t)=>{Ce(e.inputs),Oe(e,"ReduceSum",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${i.getByIndices("input_indices")};`,""])},Bn=(e,t)=>{Ce(e.inputs),Oe(e,"ReduceSumSquare",t,(i,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${i.getByIndices("input_indices")}; value += t * t;`,""])},Ae=(e,t,i)=>{if(t.length===0)return i;let r=1,a=1;for(let n=0;n<t.length;n++)t.indexOf(n)===-1?r*=e[n]:a*=e[n];return a<32&&r>1024},Rn=(e,t)=>{Ae(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?En(e,t):hn(e,t)},Mn=(e,t)=>{Ae(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Sn(e,t):fn(e,t)},Dn=(e,t)=>{Ae(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?In(e,t):mn(e,t)},Un=(e,t)=>{Ae(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Tn(e,t):gn(e,t)},Pn=(e,t)=>{Ae(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?zn(e,t):_n(e,t)},qn=(e,t)=>{Ae(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Cn(e,t):yn(e,t)},Nn=(e,t)=>{Ae(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?On(e,t):$n(e,t)},Vn=(e,t)=>{Ae(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?An(e,t):wn(e,t)},Ln=(e,t)=>{Ae(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Bn(e,t):bn(e,t)},Wn=(e,t)=>{Ae(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?kn(e,t):vn(e,t)}}),Wi,Gn,Hn,Gi,bp=T(()=>{N(),ae(),Li(),Wi=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},Gn=(e,t)=>{Wi(e.inputs);let i=(r,a,n)=>{let s=[];for(let o=0;o<r.rank;o++)(n.indexOf(o)>=0||n.length===0)&&s.push(`input_indices[${o}] = 0;`);return[`${s.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?"<=":"<"} value) {
value = ${r.getByIndices("input_indices")};
best_index = i32(last_index);
}`,"",a.setByOffset("global_idx","best_index")]};e.compute(Ht("ArgMin",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],i,[t.axis],7,t.keepDims),{inputs:[0]})},Hn=(e,t)=>{Wi(e.inputs);let i=(r,a,n)=>{let s=[];for(let o=0;o<r.rank;o++)(n.indexOf(o)>=0||n.length===0)&&s.push(`input_indices[${o}] = 0;`);return[`${s.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
value = ${r.getByIndices("input_indices")};
best_index = i32(last_index);
}`,"",a.setByOffset("global_idx","best_index")]};e.compute(Ht("argMax",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],i,[t.axis],7,t.keepDims),{inputs:[0]})},Gi=e=>Q(e)}),Fn,Ft,jn,Kn,Zn,vt,Qn,Xn,Hi=T(()=>{N(),W(),Ri(),G(),Fn=(e,t)=>{let i=e[0],r=e[1],a=e[2],n=e[3],s=e[4],o=e[5];if(s&&o)throw new Error("Attention cannot have both past and attention_bias");if(i.dims.length!==3)throw new Error('Input "input" must have 3 dimensions');let u=i.dims[0],l=i.dims[1],d=i.dims[2];if(a.dims.length!==1)throw new Error('Input "bias" is expected to have 1 dimensions');if(r.dims.length!==2)throw new Error('Input "weights" is expected to have 2 dimensions');if(r.dims[0]!==d)throw new Error("Input 1 dimension 0 should have same length as dimension 2 of input 0");if(a.dims[0]!==r.dims[1])throw new Error('Input "bias" dimension 0 should have same length as dimension 1 of input "weights"');let p=a.dims[0]/3,c=p,h=c;if(t.qkvHiddenSizes.length>0){if(t.qkvHiddenSizes.length!==3)throw new Error("qkv_hidden_sizes attribute should have 3 elements");for(let w of t.qkvHiddenSizes)if(w%t.numHeads!==0)throw new Error("qkv_hidden_sizes should be divisible by num_heads");p=t.qkvHiddenSizes[0],c=t.qkvHiddenSizes[1],h=t.qkvHiddenSizes[2]}let f=l;if(p!==c)throw new Error("qkv_hidden_sizes first element should be same as the second");if(a.dims[0]!==p+c+h)throw new Error('Input "bias" dimension 0 should have same length as sum of Q/K/V hidden sizes');let g=0;if(s){if(c!==h)throw new Error('Input "past" expect k_hidden_size == v_hidden_size');if(s.dims.length!==5)throw new Error('Input "past" must have 5 dimensions');if(s.dims[0]!==2)throw new Error('Input "past" first dimension must be 2');if(s.dims[1]!==u)throw new Error('Input "past" second dimension must be batch_size');if(s.dims[2]!==t.numHeads)throw new Error('Input "past" third dimension must be num_heads');if(s.dims[4]!==c/t.numHeads)throw new Error('Input "past" fifth dimension must be k_hidden_size / num_heads');t.pastPresentShareBuffer||(g=s.dims[3])}let y=f+g,_=-1,m=0;if(n)throw new Error("Mask not supported");if(s)throw new Error("past is not supported");if(o){if(o.dims.length!==4)throw new Error('Input "attention_bias" must have 4 dimensions');if(o.dims[0]!==u||o.dims[1]!==t.numHeads||o.dims[2]!==l||o.dims[3]!==y)throw new Error('Expect "attention_bias" shape (batch_size, num_heads, sequence_length, total_sequence_length)')}return{batchSize:u,sequenceLength:l,pastSequenceLength:g,kvSequenceLength:f,totalSequenceLength:y,maxSequenceLength:_,inputHiddenSize:d,hiddenSize:p,vHiddenSize:h,headSize:Math.floor(p/t.numHeads),vHeadSize:Math.floor(h/t.numHeads),numHeads:t.numHeads,isUnidirectional:!1,pastPresentShareBuffer:!1,maskFilterValue:t.maskFilterValue,maskType:m,scale:t.scale,broadcastResPosBias:!1,passPastInKv:!1,qkvFormat:1}},Ft=(e,t,i)=>t&&e?`
...
`,jn=(e,t,i,r,a,n,s,o)=>{let u=re(s?1:n),l=64,d=n/u;d<l&&(l=32);let p=Math.ceil(n/u/l),c=[{type:12,data:t},{type:12,data:i},{type:12,data:r},{type:12,data:a},{type:12,data:d},{type:12,data:p}],h=se(e.dataType,u),f=me(1,u),g=["type"];s&&g.push("type"),o&&g.push("type");let y=_=>{let m=B("x",e.dataType,e.dims,u),w=[m],$=s?S("seq_lens",s.dataType,s.dims):void 0;$&&w.push($);let b=o?S("total_sequence_length_input",o.dataType,o.dims):void 0;b&&w.push(b);let x=me(e.dataType),v=[{name:"batch_size",type:"u32"},{name:"num_heads",type:"u32"},{name:"past_sequence_length",type:"u32"},{name:"sequence_length",type:"u32"},{name:"total_sequence_length",type:"u32"},{name:"elements_per_thread",type:"u32"}];return`
...
}`};return{name:"AttentionProbsSoftmax",shaderCache:{hint:`${l};${h};${u}`,inputDependencies:g},getShaderSource:y,getRunData:()=>({outputs:[],dispatchGroup:{x:1,y:a,z:t*i},programUniforms:c})}},Kn=(e,t,i,r,a,n,s,o,u)=>{let l=s+n.kvSequenceLength,d=[n.batchSize,n.numHeads,n.sequenceLength,l],p=e>1&&r,c=n.kvNumHeads?n.kvNumHeads:n.numHeads,h=p?[n.batchSize,c,l,n.headSize]:void 0,f=n.nReps?n.nReps:1,g=n.scale===0?1/Math.sqrt(n.headSize):n.scale,y=re(n.headSize),_=n.headSize/y,m=12,w={x:Math.ceil(l/m),y:Math.ceil(n.sequenceLength/m),z:n.batchSize*n.numHeads},$=[{type:12,data:n.sequenceLength},{type:12,data:_},{type:12,data:l},{type:12,data:n.numHeads},{type:12,data:n.headSize},{type:1,data:g},{type:12,data:s},{type:12,data:n.kvSequenceLength},{type:12,data:f}],b=p&&r&&k.size(r.dims)>0,x=["type","type"];b&&x.push("type"),a&&x.push("type"),o&&x.push("type"),u&&x.push("type");let v=[{dims:d,dataType:t.dataType,gpuDataType:0}];p&&v.push({dims:h,dataType:t.dataType,gpuDataType:0});let I=z=>{let O=S("q",t.dataType,t.dims,y),V=S("key",i.dataType,i.dims,y),U=[O,V];if(b){let P=S("past_key",r.dataType,r.dims,y);U.push(P)}a&&U.push(S("attention_bias",a.dataType,a.dims));let L=o?S("seq_lens",o.dataType,o.dims):void 0;L&&U.push(L);let A=u?S("total_sequence_length_input",u.dataType,u.dims):void 0;A&&U.push(A);let F=B("output",t.dataType,d),q=[F];p&&q.push(B("present_key",t.dataType,h,y));let M=me(1,y),Z=[{name:"M",type:"u32"},{name:"K",type:"u32"},{name:"N",type:"u32"},{name:"num_heads",type:"u32"},{name:"head_size",type:"u32"},{name:"alpha",type:"f32"},{name:"past_sequence_length",type:"u32"},{name:"kv_sequence_length",type:"u32"},{name:"n_reps",type:"u32"}];return`
const TILE_SIZE = ${m}u;
...
}`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${r}_${s}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:m,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l?[{type:12,data:u},...D(n)]:[{type:12,data:u}]})}},es=e=>Q(e),ts=(e,t)=>{let{inputs:i,outputCount:r}=e,a=es({...t,outputCount:r});if(J.webgpu.validateInputContent&&Yn(i,a),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Jn(i,a))}}),is,rs,as,xp=T(()=>{W(),G(),is=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},rs=e=>{let t=e[0].dims,i=e[0].dims[2],r=k.size(t)/4,a=e[0].dataType,n=S("input",a,t,4),s=S("bias",a,[i],4),o=S("residual",a,t,4),u=B("output",a,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:l=>`
...
}`}},as=e=>{is(e.inputs),e.compute(rs(e.inputs))}}),ns,K,ss,os,us,ls,ds,ps,cs,hs,fs,ms,gs,_s,ys,$s,xt,ws,jt,bs,vs,xs,ks,Ss,Is,Ts,zs,Es,Cs,Os,As,Bs,Rs,Ms,Ds,Fi,Us,ji,Ki,Ps,qs,Ns,Vs,Ls,Ws,Zi=T(()=>{N(),W(),ae(),G(),ns=(e,t,i,r,a,n,s)=>{let o=Math.ceil(t/4),u="";typeof a=="string"?u=`${a}(a)`:u=a("a");let l=S("inputData",i,[o],4),d=B("outputData",r,[o],4),p=[{name:"vec_size",type:"u32"}];return s&&p.push(...s),`
...
}`},K=(e,t,i,r,a,n=e.dataType,s,o)=>{let u=[{type:12,data:Math.ceil(k.size(e.dims)/4)}];return s&&u.push(...s),{name:t,shaderCache:{hint:a,inputDependencies:["type"]},getShaderSource:l=>ns(l,k.size(e.dims),e.dataType,n,i,r,o),getRunData:l=>({outputs:[{dims:e.dims,dataType:n}],dispatchGroup:{x:Math.ceil(k.size(l[0].dims)/64/4)},programUniforms:u})}},ss=e=>{e.compute(K(e.inputs[0],"Abs","abs"))},os=e=>{e.compute(K(e.inputs[0],"Acos","acos"))},us=e=>{e.compute(K(e.inputs[0],"Acosh","acosh"))},ls=e=>{e.compute(K(e.inputs[0],"Asin","asin"))},ds=e=>{e.compute(K(e.inputs[0],"Asinh","asinh"))},ps=e=>{e.compute(K(e.inputs[0],"Atan","atan"))},cs=e=>{e.compute(K(e.inputs[0],"Atanh","atanh"))},hs=e=>Q(e),fs=(e,t)=>{let i;switch(t.to){case 10:i="vec4<f16>";break;case 1:i="vec4<f32>";break;case 12:i="vec4<u32>";break;case 6:i="vec4<i32>";break;case 9:i="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(K(e.inputs[0],"Cast",i,void 0,t.cacheKey,t.to))},ms=e=>{let t,i,r=e.length>=2&&e[1].data!==0,a=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,i=a?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,i=a?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return Q({min:t,max:i})},gs=(e,t)=>{let i=t||ms(e.inputs),r=me(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Clip",a=>`clamp(${a}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,i.cacheKey,void 0,[{type:e.inputs[0].dataType,data:i.min},{type:e.inputs[0].dataType,data:i.max}],[{name:"min",type:r},{name:"max",type:r}]),{inputs:[0]})},_s=e=>{e.compute(K(e.inputs[0],"Ceil","ceil"))},ys=e=>{e.compute(K(e.inputs[0],"Cos","cos"))},$s=e=>{e.compute(K(e.inputs[0],"Cosh","cosh"))},xt=e=>Q(e),ws=(e,t)=>{let i=me(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
}`,bs=e=>{let t=me(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Erf",i=>`erf_vf32(${i})`,jt(t)))},vs=e=>{e.compute(K(e.inputs[0],"Exp","exp"))},xs=e=>{e.compute(K(e.inputs[0],"Floor","floor"))},ks=e=>{let t=me(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Gelu",i=>`0.5 * ${i} * (1.0 + erf_vf32(${i} * 0.7071067811865475))`,jt(t)))},Ss=(e,t)=>{let i=me(e.inputs[0].dataType);e.compute(K(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${t.alpha});`,t.cacheKey))},Is=e=>{e.compute(K(e.inputs[0],"Not",t=>`!${t}`))},Ts=e=>{e.compute(K(e.inputs[0],"Neg",t=>`-${t}`))},zs=e=>{e.compute(K(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Es=e=>{let t=me(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Relu",i=>`select(vec4<${t}>(0.0), ${i}, ${i} > vec4<${t}>(0.0))`))},Cs=e=>{e.compute(K(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Os=e=>Q(e),As=(e,t)=>{let i=me(e.inputs[0].dataType);e.compute(K(e.inputs[0],"HardSigmoid",r=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${t.alpha} * ${r} + vec4<${i}>(${t.beta})))`,void 0,t.cacheKey))},Bs=e=>{e.compute(K(e.inputs[0],"Sin","sin"))},Rs=e=>{e.compute(K(e.inputs[0],"Sinh","sinh"))},Ms=e=>{e.compute(K(e.inputs[0],"Sqrt","sqrt"))},Ds=e=>{e.compute(K(e.inputs[0],"Tan","tan"))},Fi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Us=e=>{e.compute(K(e.inputs[0],"Tanh",Fi))},ji=(e="f32")=>`
...
`,Ki=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Ps=e=>{let t=me(e.inputs[0].dataType);e.compute(K(e.inputs[0],"FastGelu",Ki,ji(t),void 0,e.inputs[0].dataType))},qs=(e,t)=>{let i=me(e.inputs[0].dataType);return e.compute(K(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${i}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${i}>(${t.alpha});`,t.cacheKey)),0},Ns=e=>{e.compute(K(e.inputs[0],"Log","log"))},Vs=(e,t)=>`
...
`,Ls=e=>`quick_gelu_impl(${e})`,Ws=(e,t)=>{let i=me(e.inputs[0].dataType);e.compute(K(e.inputs[0],"QuickGelu",Ls,Vs(i,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Gs,Hs,Fs,kp=T(()=>{W(),G(),Zi(),Gs=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Hs=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let i=S("input",e[0].dataType,e[0].dims,4),r=S("bias",e[0].dataType,[e[0].dims[2]],4),a=B("output",e[0].dataType,t,4),n=k.size(t)/4,s=se(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:o=>`
...
${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
${_}
}`},Ks=(e,t,i,r,a,n,s=i.dataType)=>{let o=i.dims.map(g=>Number(g)??1),u=r.dims.map(g=>Number(g)??1),l=!k.areEqual(o,u),d=o,p=k.size(o),c=!1,h=!1,f=[l];if(l){let g=pt.calcShape(o,u,!1);if(!g)throw new Error("Can't perform binary op on the given tensors");d=g.slice(),p=k.size(d);let y=k.size(o)===1,_=k.size(u)===1,m=o.length>0&&o[o.length-1]%4===0,w=u.length>0&&u[u.length-1]%4===0;f.push(y),f.push(_),f.push(m),f.push(w);let $=1;for(let b=1;b<d.length;b++){let x=o[o.length-b],v=u[u.length-b];if(x===v)$*=x;else break}$%4===0?(h=!0,c=!0):(y||_||m||w)&&(c=!0)}else c=!0;return f.push(c),{name:e,shaderCache:{hint:t+f.map(g=>g.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:g=>js(g,o,u,d,c,l,h,a,i.dataType,r.dataType,s,n),getRunData:()=>({outputs:[{dims:d,dataType:s}],dispatchGroup:{x:Math.ceil(p/64/4)},programUniforms:[{type:12,data:Math.ceil(k.size(d)/4)},...D(o,u,d)]})}},Be=(e,t,i,r,a,n)=>{e.compute(Ks(t,a??"",e.inputs[0],e.inputs[1],i,r,n))},Zs=e=>{Be(e,"Add",(t,i)=>`${t}+${i}`)},Qs=e=>{Be(e,"Div",(t,i)=>`${t}/${i}`)},Xs=e=>{Be(e,"Equal",{scalar:(t,i)=>`u32(${t}==${i})`,vector:(t,i)=>`vec4<u32>(${t}==${i})`},void 0,void 0,9)},Ys=e=>{Be(e,"Mul",(t,i)=>`${t}*${i}`)},Js=e=>{let t=S("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Be(e,"Pow",{scalar:(i,r)=>`pow_custom(${i},${r})`,vector:(i,r)=>`pow_vector_custom(${i},${r})`},`
...
`)},eo=e=>{Be(e,"Sub",(t,i)=>`${t}-${i}`)},to=e=>{Be(e,"Greater",{scalar:(t,i)=>`u32(${t}>${i})`,vector:(t,i)=>`vec4<u32>(${t}>${i})`},void 0,void 0,9)},io=e=>{Be(e,"Less",{scalar:(t,i)=>`u32(${t}<${i})`,vector:(t,i)=>`vec4<u32>(${t}<${i})`},void 0,void 0,9)},ro=e=>{Be(e,"GreaterOrEqual",{scalar:(t,i)=>`u32(${t}>=${i})`,vector:(t,i)=>`vec4<u32>(${t}>=${i})`},void 0,void 0,9)},ao=e=>{Be(e,"LessOrEqual",{scalar:(t,i)=>`u32(${t}<=${i})`,vector:(t,i)=>`vec4<u32>(${t}<=${i})`},void 0,void 0,9)}}),no,so,oo,uo,lo,po,Ip=T(()=>{N(),W(),ae(),G(),no=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let i=0,r=e[i],a=r.dataType,n=r.dims.length;e.forEach((s,o)=>{if(o!==i){if(s.dataType!==a)throw new Error("input tensors should be one type");if(s.dims.length!==n)throw new Error("input tensors should have the same shape");s.dims.forEach((u,l)=>{if(l!==t&&u!==r.dims[l])throw new Error("non concat dimensions must match")})}})},so=(e,t)=>`
...
${oo(s,p)}
}`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:i,dataType:r}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:d}),getShaderSource:f}},lo=(e,t)=>{let i=e.inputs,r=i[0].dims,a=k.normalizeAxis(t.axis,r.length);no(i,a);let n=r.slice();n[a]=i.reduce((o,u)=>o+(u.dims.length>a?u.dims[a]:0),0);let s=i.filter(o=>k.size(o.dims)>0);e.compute(uo(s,a,n,i[0].dataType),{inputs:s})},po=e=>Q({axis:e.axis})}),it,rt,at,Qi,nt=T(()=>{N(),W(),it=(e,t,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${i}(uniforms.clip_min)), ${t}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
   value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
`;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},rt=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},at=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Qi=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[i,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:i,beta:r}}else if(t==="Clip"){let[i,r]=e?.activation_params||[Aa,Ba];return{activation:t,clipMax:r,clipMin:i}}else if(t==="LeakyRelu"){let[i]=e?.activation_params||[.01];return{activation:t,alpha:i}}return{activation:t}}}),le,co,Xi=T(()=>{le=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},co=e=>`
...
`}),kt,Yi,Ji=T(()=>{N(),W(),G(),nt(),kt=(e,t,i,r,a)=>{let n=r-i;return`
...
`},Yi=(e,t,i,r,a=!1,n)=>{let s=e[0].dims,o=e[1].dims,u=s[s.length-2],l=o[o.length-1],d=s[s.length-1],p=re(l),c=re(d),h=re(u),f=k.size(i)/p/h,g=e.length>2,y=r?r.slice(0,-2):i.slice(0,-2),_=[k.size(y),u,l],m=[{type:12,data:f},{type:12,data:u},{type:12,data:l},{type:12,data:d}];rt(t,m),m.push(...D(y,s,o)),g&&m.push(...D(e[2].dims)),m.push(...D(_));let w=$=>{let b=qi("batch_dims",e[0].dataType,y.length),x=S("a",e[0].dataType,s.length,c),v=S("b",e[1].dataType,o.length,p),I=B("output",e[0].dataType,_.length,p),z=se(I.type.tensor),O=it(t,I.type.value,z),V=[x,v],U="";if(g){let F=a?p:1;V.push(S("bias",e[2].dataType,e[2].dims.length,F)),U=`${a?`value += bias[col / ${F}];`:`value += ${I.type.value}(bias[row + i]);`}`}let L=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];at(t,L);let A=()=>{let F=`var a_data: ${x.type.value};`;for(let q=0;q<c;q++)F+=`
...
${kt("a_indices",x,x.rank-2,b.rank,"batch_indices")}
...
${kt("b_indices",v,v.rank-2,b.rank,"batch_indices")}
...
`};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${p};${c};${h};${a}`,inputDependencies:g?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:m}),getShaderSource:w}}}),fo,mo,er,tr,go,ir,_o,Kt,rr=T(()=>{N(),W(),G(),nt(),Ji(),Xi(),fo=(e,t)=>e?`
...
}`,er=(e,t,i="f32",r,a=!1,n=32,s=!1,o=32)=>{let u=t[1]*e[1],l=t[0]*e[0],d=a?u:n,p=a?n:u,c=d/t[0],h=n/t[1];if(!((a&&c===4&&e[1]===4||!a&&(c===3||c===4))&&d%t[0]===0&&n%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${a} is true, innerElementSize ${c} and workPerThread[1] ${e[1]} must be 4.
...
${kt("aIndices",s,s.rank-2,n.rank,"batchIndices")}
...
${kt("bIndices",o,o.rank-2,n.rank,"batchIndices")}
...
`},Kt=(e,t,i,r,a=!1,n)=>{let s=e[0].dims,o=e[1].dims,u=s.slice(0,-2),l=o.slice(0,-2),d=r?r.slice(0,-2):i.slice(0,-2),p=k.size(d),c=s[s.length-2],h=s[s.length-1],f=o[o.length-1],g=h%4===0&&f%4===0,y=c<=8?[4,1,1]:[4,4,1],_=[8,8,1],m=[Math.ceil(f/_[0]/y[0]),Math.ceil(c/_[1]/y[1]),Math.ceil(p/_[2]/y[2])],w=g?4:1,$=[...u,c,h/w],b=$.length,x=[...l,h,f/w],v=x.length,I=[p,c,f/w],z=[{type:6,data:c},{type:6,data:f},{type:6,data:h}];rt(t,z),z.push(...D(d,$,x));let O=["rank","rank"],V=e.length>2;V&&(z.push(...D(e[2].dims)),O.push("rank")),z.push(...D(I));let U=L=>{let A=d.length,F=qi("batchDims",e[0].dataType,A,1),q=se(e[0].dataType),M=S("a",e[0].dataType,b,w),Z=S("b",e[1].dataType,v,w),P=B("result",e[0].dataType,I.length,w),te=[M,Z];if(V){let de=a?w:1;te.push(S("bias",e[2].dataType,e[2].dims.length,de))}let E=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];at(t,E);let C=se(P.type.tensor),H=it(t,P.type.value,C),Y=_o(w,V,H,[F,M,Z,P],a);return`
${L.registerUniforms(E).registerInternalVariables(F).declareVariables(...te,P)}
${Y}
${g?er(y,_,q,F):ir(y,_,q,F)}
        `};return{name:"MatMul",shaderCache:{hint:`${y};${t.activation};${g};${a}`,inputDependencies:O},getRunData:()=>({outputs:[{dims:n?n(i):i,dataType:e[0].dataType}],dispatchGroup:{x:m[0],y:m[1],z:m[2]},programUniforms:z}),getShaderSource:U}}}),yo,$o,zp=T(()=>{N(),Ve(),G(),nt(),Xi(),Tp(),rr(),yo=(e,t,i,r,a=!1,n,s=4,o=4,u=4,l="f32")=>{let d=z=>{switch(z){case 1:return"resData = x[xIndex];";case 3:return`resData = vec3<${l}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return"resData = x[xIndex / 4];";default:throw new Error(`innerElementSize ${z} is not supported.`)}},p=z=>{switch(z){case 1:return"return w[row * i32(uniforms.w_shape[3]) + colIn];";case 4:return"return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];";default:throw new Error(`innerElementSize ${z} is not supported.`)}},c=e?`
...
return ${le(o,l)}(0.0);`,b=le(u,l),x=le(e?s:o,l),v=le(e?o:s,l),I=it(n,b,l);return`
...
}`,E=S("x",e[0].dataType,e[0].dims.length,b===3?1:b),C=S("w",e[1].dataType,e[1].dims.length,Z),H=[E,C],Y=B("result",e[0].dataType,i.length,Z);if(s){let de=S("bias",e[2].dataType,e[2].dims.length,Z);H.push(de),te+=`
...
${g?er(w,m,P,void 0,!l,I):ir(w,m,P,void 0,!l,I,!1,void 0,o)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${b};${g};${z};${O};${V};${x};${v};${I}`,inputDependencies:A},getRunData:()=>({outputs:[{dims:u?u(i):i,dataType:e[0].dataType}],dispatchGroup:{x:$[0],y:$[1],z:$[2]},programUniforms:L}),getShaderSource:F}}}),wo,ar,St,bo,nr,vo,xo,ko,Ep=T(()=>{N(),Ve(),W(),G(),nt(),Xi(),wo=e=>{let t=1;for(let i=0;i<e.length;i++)t*=e[i];return t},ar=e=>typeof e=="number"?[e,e,e]:e,St=(e,t)=>t<=1?e:e+(e-1)*(t-1),bo=(e,t,i,r=1)=>{let a=St(t,r);return Math.floor((e[0]*(i-1)-i+a)/2)},nr=(e,t,i,r,a)=>{a==null&&(a=bo(e,t[0],r[0]));let n=[0,0,0,i];for(let s=0;s<3;s++)e[s]+2*a>=t[s]&&(n[s]=Math.trunc((e[s]-t[s]+2*a)/r[s]+1));return n},vo=(e,t,i,r,a,n,s,o,u,l)=>{let d,p,c,h;if(e==="VALID"&&(e=0),typeof e=="number"){d={top:e,bottom:e,left:e,right:e,front:e,back:e};let f=nr([t,i,r,1],[o,u,l],1,[a,n,s],e);p=f[0],c=f[1],h=f[2]}else if(Array.isArray(e)){if(!e.every((g,y,_)=>g===_[0]))throw Error(`Unsupported padding parameter: ${e}`);d={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let f=nr([t,i,r,1],[o,u,l],1,[a,n,s],e[0]);p=f[0],c=f[1],h=f[2]}else if(e==="SAME_UPPER"){p=Math.ceil(t/a),c=Math.ceil(i/n),h=Math.ceil(r/s);let f=(p-1)*a+o-t,g=(c-1)*n+u-i,y=(h-1)*s+l-r,_=Math.floor(f/2),m=f-_,w=Math.floor(g/2),$=g-w,b=Math.floor(y/2),x=y-b;d={top:w,bottom:$,left:b,right:x,front:_,back:m}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:d,outDepth:p,outHeight:c,outWidth:h}},xo=(e,t,i,r,a,n=!1,s="channelsLast")=>{let o,u,l,d,p;if(s==="channelsLast")[o,u,l,d,p]=e;else if(s==="channelsFirst")[o,p,u,l,d]=e;else throw new Error(`Unknown dataFormat ${s}`);let[c,,h,f,g]=t,[y,_,m]=ar(i),[w,$,b]=ar(r),x=St(h,w),v=St(f,$),I=St(g,b),{padInfo:z,outDepth:O,outHeight:V,outWidth:U}=vo(a,u,l,d,y,_,m,x,v,I),L=n?c*p:c,A=[0,0,0,0,0];return s==="channelsFirst"?A=[o,L,O,V,U]:s==="channelsLast"&&(A=[o,O,V,U,L]),{batchSize:o,dataFormat:s,inDepth:u,inHeight:l,inWidth:d,inChannels:p,outDepth:O,outHeight:V,outWidth:U,outChannels:L,padInfo:z,strideDepth:y,strideHeight:_,strideWidth:m,filterDepth:h,filterHeight:f,filterWidth:g,effectiveFilterDepth:x,effectiveFilterHeight:v,effectiveFilterWidth:I,dilationDepth:w,dilationHeight:$,dilationWidth:b,inShape:e,outShape:A,filterShape:t}},ko=(e,t,i,r,a,n)=>{let s=n==="channelsLast";s?e[0].dims[3]:e[0].dims[1];let o=[64,1,1],u={x:i.map((y,_)=>_)},l=[Math.ceil(wo(u.x.map(y=>i[y]))/o[0]),1,1];j("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${l}`);let d=1,p=k.size(i),c=[{type:12,data:p},{type:12,data:r},{type:12,data:a},{type:12,data:t.strides},{type:12,data:t.dilations}];rt(t,c),c.push(...D(e[0].dims,e[1].dims));let h=["rank","rank"],f=e.length===3;f&&(c.push(...D(e[2].dims)),h.push("rank")),c.push(...D(i));let g=y=>{let _=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:r.length},{name:"pads",type:"u32",length:a.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];at(t,_);let m=1,w=se(e[0].dataType),$=S("x",e[0].dataType,e[0].dims.length,d),b=S("W",e[1].dataType,e[1].dims.length,m),x=[$,b],v=B("result",e[0].dataType,i.length,m),I="";if(f){let V=S("bias",e[2].dataType,e[2].dims.length,m);x.push(V),I+=`
fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${w} {
return bias[${s?R("coords",4,5):R("coords",1,5)}];
}`}let z=le(d,w),O=it(t,z,w);return`
 ${I}
...
}`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${s};${d};${f}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:l[0],y:l[1],z:l[2]},programUniforms:c}),getShaderSource:g}}}),So,Io,Cp=T(()=>{N(),W(),G(),nt(),So=(e,t,i,r)=>{let a=e.length>2,n=a?"value += b[output_channel];":"",s=e[0].dims,o=e[1].dims,u=t.format==="NHWC",l=u?i[3]:i[1],d=l/t.group,p=u&&d>=4?re(l):1,c=k.size(i)/p,h=[{type:12,data:c},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:d}];rt(t,h),h.push(...D(s,[o[0],o[1],o[2],o[3]/p]));let f=a?["rank","rank","rank"]:["rank","rank"];h.push(...D([i[0],i[1],i[2],i[3]/p]));let g=y=>{let _=B("output",e[0].dataType,i.length,p),m=se(_.type.tensor),w=it(t,_.type.value,m),$=S("x",e[0].dataType,s.length),b=S("w",e[1].dataType,o.length,p),x=[$,b];a&&x.push(S("b",e[2].dataType,e[2].dims,p));let v=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];at(t,v);let I=u?`
...
}`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${p}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:h}),getShaderSource:g}},Io=(e,t,i,r)=>{let a=e.length>2,n=re(i[3]),s=re(i[2]),o=k.size(i)/n/s,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/n],l=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/n],d=[i[0],i[1],i[2],i[3]/n],p=[{type:12,data:o},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];rt(t,p),p.push(...D(u,l,d));let c=(s-1)*t.strides[1]+l[1],h=f=>{let g=B("output",e[0].dataType,d.length,n),y=se(g.type.tensor),_=it(t,g.type.value,y),m=S("x",e[0].dataType,u.length,n),w=S("w",e[1].dataType,l.length,n),$=[m,w];a&&$.push(S("b",e[2].dataType,e[2].dims,n));let b=a?"value += b[output_channel];":"",x=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return at(t,x),`
...
}`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${n};${s};${c};${l[0]};${l[1]}`,inputDependencies:a?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:p}),getShaderSource:h}}}),To,Zt,zo,Qt,sr,or,Eo,Co,ur,Op=T(()=>{W(),zp(),Ep(),rr(),Cp(),nt(),Ji(),je(),To=(e,t,i,r,a,n)=>{let s=e[0],o=e.slice(n?1:2,n?3:4),u=o.length,l=t[0],d=t.slice(2).map((c,h)=>c+(c-1)*(i[h]-1)),p=o.map((c,h)=>c+r[h]+r[h+u]).map((c,h)=>Math.floor((c-d[h]+a[h])/a[h]));return p.splice(0,0,s),p.splice(n?3:1,0,l),p},Zt=[2,3,1,0],zo=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let i=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[1]*t.group;if(i!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let a=e[0].dims.length-2;if(t.dilations.length!==a)throw new Error(`dilations should be ${a}D`);if(t.strides.length!==a)throw new Error(`strides should be ${a}D`);if(t.pads.length!==a*2)throw new Error(`pads should be ${a*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Qt=(e,t)=>{let i=e.kernelShape.slice();i.length<t[1].dims.length-2&&i.push(...Array(t[1].dims.length-2-i.length).fill(0));for(let n=2;n<t[1].dims.length;++n)i[n-2]===0&&(i[n-2]=t[1].dims[n]);let r=e.pads.slice();Vt.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,i,r,e.format==="NHWC",e.autoPad);let a=Object.assign({},e);return Object.assign(a,{kernelShape:i,pads:r}),a},sr=e=>{let t=Qi(e),i=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],a=e.dilations,n=e.group,s=e.kernel_shape,o=e.pads,u=e.strides,l=e.w_is_const();return{autoPad:r,format:i,dilations:a,group:n,kernelShape:s,pads:o,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},or=(e,t,i,r)=>{let a=i.format==="NHWC",n=To(t[0].dims,t[1].dims,i.dilations,i.pads,i.strides,a);if(i.group!==1){let x=[t[0]];if(a){let v=e.kernelCustomData.wT??e.compute(we(t[1],Zt),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=v),x.push(v)}else x.push(t[1]);t.length===3&&x.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&a&&t[1].dims[0]===i.group&&t[1].dims[1]===1&&i.dilations[0]===1&&i.dilations[1]===1?e.compute(Io(x,i,n,r),{inputs:x}):e.compute(So(x,i,n,r),{inputs:x});return}let s=t.length===3,o=t[0].dims[a?1:2],u=t[0].dims[a?2:3],l=t[0].dims[a?3:1],d=t[1].dims[2],p=t[1].dims[3],c=n[a?1:2],h=n[a?2:3],f=n[a?3:1],g=a&&d===o&&p===u&&i.pads[0]===0&&i.pads[1]===0;if(g||d===1&&p===1&&i.dilations[0]===1&&i.dilations[1]===1&&i.strides[0]===1&&i.strides[1]===1&&i.pads[0]===0&&i.pads[1]===0){let x=n[0],v,I,z,O=[];if(a){let L=e.kernelCustomData.wT??e.compute(we(t[1],Zt),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];if(i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=L),g){let A=o*u*l;v=t[0].reshape([1,x,A]),I=L.reshape([1,A,f]),z=[1,x,f]}else v=t[0].reshape([x,o*u,l]),I=L.reshape([1,l,f]),z=[x,c*h,f];O.push(v),O.push(I)}else v=t[0].reshape([x,l,o*u]),I=t[1].reshape([1,f,l]),z=[x,f,c*h],O.push(I),O.push(v);s&&O.push(t[2]);let V=z[2],U=O[0].dims[O[0].dims.length-1];V<8&&U<8?e.compute(Yi(O,i,n,z,a,r),{inputs:O}):e.compute(Kt(O,i,n,z,a,r),{inputs:O});return}let y=!0,_=e.kernelCustomData.wT??e.compute(we(t[1],Zt),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=_);let m=[t[0],_];s&&m.push(t[2]);let w=a?c*h:f,$=a?f:c*h,b=d*p*l;e.compute($o(m,i,n,w,$,b,s,y,r),{inputs:m})},Eo=(e,t)=>{let i=t.format==="NHWC",r=[e.inputs[0].reshape(i?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let a=[0,t.pads[0],0,t.pads[1]],n=[1].concat(t.strides),s=[1].concat(t.dilations),o=[1].concat(t.kernelShape),u=Qt({...t,pads:a,strides:n,dilations:s,kernelShape:o},r);or(e,r,u,l=>i?[l[0],l[2],l[3]]:[l[0],l[1],l[3]])},Co=(e,t,i)=>{let r=i.format==="NHWC"?"channelsLast":"channelsFirst",a=Qt(i,t),n=i.autoPad==="NOTSET"?i.pads:i.autoPad,s=xo(t[0].dims,t[1].dims,i.strides,i.dilations,n,!1,r);e.compute(ko(t,a,s.outShape,[s.filterDepth,s.filterHeight,s.filterWidth],[s.padInfo.front,s.padInfo.top,s.padInfo.left],r))},ur=(e,t)=>{if(zo(e.inputs,t),e.inputs[0].dims.length===3)Eo(e,t);else if(e.inputs[0].dims.length===5)Co(e,e.inputs,t);else{let i=Qt(t,e.inputs);or(e,e.inputs,i)}}}),Oo,Ap=T(()=>{N(),Ve(),W(),G(),Oo=(e,t,i)=>{let r=e.length>2,a=t.outputShape,n=t.format==="NHWC",s=t.group,o=e[1].dims,u=o[2]/s,l=o[3],d=n?re(u):1,p=n&&l===1&&u>=4,c=p?Math.floor(u/4)*4:Math.floor(u/d)*d,h=u-c,f=n?re(l):1,g=n?l===1?d:f:1,y=k.size(a)/f,_=[Math.ceil(y/64),1,1];j("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${_}`);let m=["rank","rank"],w=[t.strides[0],t.strides[1]],$=[t.kernelShape[n?1:2],t.kernelShape[n?2:3]],b=[t.dilations[0],t.dilations[1]],x=[$[0]+(t.dilations[0]<=1?0:(t.kernelShape[n?1:2]-1)*(t.dilations[0]-1)),$[1]+(t.dilations[1]<=1?0:(t.kernelShape[n?2:3]-1)*(t.dilations[1]-1))],v=[x[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),x[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],I=[{type:12,data:y},{type:12,data:w},{type:12,data:$},{type:12,data:b},{type:12,data:x},{type:6,data:v},{type:12,data:c},{type:12,data:u},{type:12,data:l},...D(e[0].dims,e[1].dims)];r&&(I.push(...D(e[2].dims)),m.push("rank")),I.push(...D(a));let z=O=>{let V=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:w.length},{name:"filter_dims",type:"u32",length:$.length},{name:"dilations",type:"u32",length:$.length},{name:"effective_filter_dims",type:"u32",length:x.length},{name:"pads",type:"i32",length:v.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],U=se(e[0].dataType),L=n?1:2,A=n?2:3,F=n?3:1,q=S("W",e[1].dataType,e[1].dims.length,g),M=S("Dy",e[0].dataType,e[0].dims.length,d),Z=[M,q];r&&Z.push(S("bias",e[2].dataType,[a[F]].length,f));let P=B("result",e[0].dataType,a.length,f),te=()=>{let H="";if(p)d===4?H+=`
...
${C}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${d}${g}${f}${p}${h}`,inputDependencies:m},getRunData:()=>({dispatchGroup:{x:_[0],y:_[1],z:_[2]},outputs:[{dims:i?i(a):a,dataType:e[0].dataType}],programUniforms:I}),getShaderSource:z}}}),Ao,Bo,Ro,lr,Mo,Do,dr,Uo,Po,Bp=T(()=>{Ap(),nt(),je(),Ao=(e,t,i,r,a,n)=>(e-1)*t+i+(r-1)*a+1-n,Bo=(e,t,i,r,a)=>{let n=Math.floor(e/2);t==="SAME_UPPER"?(i[r]=n,i[a]=e-n):t==="SAME_LOWER"&&(i[r]=e-n,i[a]=n)},Ro=(e,t,i,r,a,n,s,o,u,l)=>{let d=e.length-2,p=l.length===0;u.length<d&&u.push(...Array(d-u.length).fill(0));let c=e[0],h=t[o?3:1]*a;for(let f=0,g=e.length-d-(o?1:0);f<d;++f,++g){let y=e[g],_=p?y*s[f]:l[f],m=Ao(y,s[f],n[f],t[g],i[f],_);Bo(m,r,n,f,f+d),p&&l.push(s[f]*(y-1)+u[f]+(t[g]-1)*i[f]+1-n[f]-n[f+d])}l.splice(0,0,c),l.splice(o?3:1,0,h)},lr=(e,t)=>{let i=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((p,c)=>p*c,1)===0){i.length=0;for(let p=2;p<t[1].dims.length;++p)i.push(t[1].dims[p])}let r=e.format==="NHWC";i.splice(0,0,t[1].dims[0]),i.splice(r?3:1,0,t[1].dims[1]);let a=e.pads.slice(),n=e.outputShape.slice(),s=e.outputPadding.slice(),o=t[0].dims,u=e.dilations.slice();if(u.reduce((p,c)=>p+c,0)===0){let p=t[0].dims.length-2;u=new Array(p).fill(1)}let l=e.strides.slice();if(l.reduce((p,c)=>p+c,0)===0){let p=t[0].dims.length-2;l=new Array(p).fill(1)}Ro(o,i,u,e.autoPad,e.group,a,l,r,s,n);let d=Object.assign({},e);return Object.assign(d,{kernelShape:i,pads:a,outputPadding:s,outputShape:n,dilations:u,strides:l}),d},Mo=e=>{let t=Qi(e),i=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],a=e.dilations,n=e.group,s=e.kernelShape,o=e.pads,u=e.strides,l=e.wIsConst(),d=e.outputPadding,p=e.outputShape;return{autoPad:r,format:i,dilations:a,group:n,kernelShape:s,outputPadding:d,outputShape:p,pads:o,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},Do=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let i=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[0];if(i!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let a=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==a))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.reduce((s,o)=>s+o,0)>0&&t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.reduce((s,o)=>s+o,0)>0&&t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.reduce((s,o)=>s+o,0)>0&&t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.outputPadding.length!==n&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${n}D`);if(t.kernelShape.reduce((s,o)=>s+o,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},dr=(e,t,i,r)=>{let a=e.kernelCustomData.wT??e.compute(we(t[1],[2,3,0,1]),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=a);let n=[t[0],a];t.length===3&&n.push(t[2]),e.compute(Oo(n,i,r),{inputs:n})},Uo=(e,t)=>{let i=t.format==="NHWC",r=[e.inputs[0].reshape(i?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let a=t.kernelShape;(a.length===0||a[0]===0)&&(a=[e.inputs[1].dims[2]]);let n=t.dilations;(n.length===0||n[0]===0)&&(n=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let o=t.pads;o.length===0&&(o=[0,0]),o=[0,o[0],0,o[1]],s=[1].concat(s),n=[1].concat(n),a=[1].concat(a);let u=t.outputPadding;u=[0].concat(u);let l=lr({...t,pads:o,strides:s,dilations:n,kernelShape:a,outputPadding:u},r);dr(e,r,l,d=>i?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},Po=(e,t)=>{if(Do(e.inputs,t),e.inputs[0].dims.length===3)Uo(e,t);else{let i=lr(t,e.inputs);dr(e,e.inputs,i)}}}),qo,No,Vo,Rp=T(()=>{N(),W(),ae(),G(),qo=(e,t,i,r)=>{let a=k.size(t),n=t.length,s=S("input",e,n),o=B("output",e,n),u=i.dataType===6?i.getInt32Array()[0]:Number(i.getBigInt64Array()[0]),l=k.normalizeAxis(u,n),d=p=>{let c=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,h=R("uniforms.input_shape","uniforms.axis",n),f=r.reverse?c+(r.exclusive?" + 1":""):"0",g=r.reverse?h:c+(r.exclusive?"":" + 1");return`
     ...
     }`};return{name:"CumSum",shaderCache:{hint:r.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:[{type:12,data:a},{type:12,data:l},...D(t,t)]}),getShaderSource:d}},No=(e,t)=>{let i=e.inputs[0].dims,r=e.inputs[0].dataType,a=e.inputs[1];e.compute(qo(r,i,a,t),{inputs:[0]})},Vo=e=>{let t=e.exclusive===1,i=e.reverse===1;return Q({exclusive:t,reverse:i})}}),Lo,Wo,Go,Ho,Fo,Mp=T(()=>{N(),W(),ae(),G(),Lo=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},Wo=(e,t,i,r)=>{let a=[];a.push(`fn perm(i: ${r.type.indices}) -> ${i.type.indices} {
...
}`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:_=>{let m=u?[i,r*l,a*l,n/l**2]:[i,n/l**2,r*l,a*l],w=k.size(m),$=p.dims,b=k.sortBasedOnPerm($,o);return{outputs:[{dims:m,dataType:_[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:[{type:12,data:w},...D($,b)]}},getShaderSource:y}},Ho=(e,t)=>{Lo(e.inputs),e.compute(Go(e.inputs[0],t))},Fo=e=>Q({blocksize:e.blocksize,mode:e.mode,format:e.format})}),Xt,It,pr,jo,Ko,Zo,Qo,cr,Xo,Yo,Jo,Dp=T(()=>{N(),W(),ae(),G(),Xt="[a-zA-Z]|\\.\\.\\.",It="("+Xt+")+",pr="^"+It+"$",jo="("+It+",)*"+It,Ko="^"+jo+"$",Zo=class{constructor(e=-1){this.symbolToIndices=new Map,this.inputIndex=e}addSymbol(e,t){let i=this.symbolToIndices.get(e);i===void 0?i=[t]:i.push(t),this.symbolToIndices.set(e,i)}},Qo=class{constructor(e,t){this.equation=t,this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[i,r]=t.includes("->")?t.split("->",2):[t,""];if(!i.match(RegExp(Ko)))throw new Error("Invalid LHS term");if(i.split(",").forEach((a,n)=>{let s=e[n].dims.slice();if(!a.match(RegExp(pr)))throw new Error("Invalid LHS term");let o=this.processTerm(a,!0,s,n);this.lhs.push(o)}),r==="")r+=[...this.symbolToInfo.entries()].filter(([a,n])=>n.count===1||a==="...").map(([a])=>a).join("");else if(!r.match(RegExp(It)))throw new Error("Invalid RHS");r.match(RegExp(Xt,"g"))?.forEach(a=>{if(a==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let n=this.symbolToInfo.get(a);if(n===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(n.dimValue)}}),this.rhs=this.processTerm(r,!1,this.outputDims)}addSymbol(e,t,i){let r=this.symbolToInfo.get(e);if(r!==void 0){if(r.dimValue!==t&&r.count!==1)throw new Error("Dimension mismatch");r.count++,r.inputIndices.push(i)}else r={count:1,dimValue:t,inputIndices:[i]};this.symbolToInfo.set(e,r)}processTerm(e,t,i,r=-1){let a=i.length,n=!1,s=[],o=0;if(!e.match(RegExp(pr))&&!t&&e!=="")throw new Error("Invalid LHS term");let u=e.match(RegExp(Xt,"g")),l=new Zo(r);return u?.forEach((d,p)=>{if(d==="..."){if(n)throw new Error("Only one ellipsis is allowed per input term");n=!0;let c=a-u.length+1;if(c<0)throw new Error("Ellipsis out of bounds");if(s=i.slice(o,o+c),this.hasEllipsis){if(this.ellipsisDims.length!==s.length||this.ellipsisDims.toString()!==s.toString())throw new Error("Ellipsis dimensions mismatch")}else if(t)this.hasEllipsis=!0,this.ellipsisDims=s;else throw new Error("Ellipsis must be specified in the LHS");for(let h=0;h<s.length;h++){let f=String.fromCharCode(48+h);l.addSymbol(f,p+h),this.addSymbol(f,i[o++],r)}}else l.addSymbol(d,p+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(d,i[o++],r)}),l}},cr=e=>e+"_max",Xo=(e,t,i,r)=>{let a=e.map(l=>l.length).map((l,d)=>S(`input${d}`,t,l)),n=k.size(r),s=B("output",t,r.length),o=[...i.symbolToInfo.keys()].filter(l=>!i.rhs.symbolToIndices.has(l)),u=l=>{let d=[],p="var prod = 1.0;",c="var sum = 0.0;",h="sum += prod;",f=[],g=[],y=[],_=[],m=i.symbolToInfo.size===i.rhs.symbolToIndices.size;i.symbolToInfo.forEach(($,b)=>{if(i.rhs.symbolToIndices.has(b)){let x=i.rhs.symbolToIndices.get(b)?.[0];x!==void 0&&i.lhs.forEach((v,I)=>{if($.inputIndices.includes(I)){let z=v.symbolToIndices.get(b);if(z===void 0)throw new Error("Invalid symbol error");z.forEach(O=>{d.push(`${a[I].indicesSet(`input${I}Indices`,O,s.indicesGet("outputIndices",x))}`)})}})}else i.lhs.forEach((x,v)=>{if($.inputIndices.includes(v)){let I=x.symbolToIndices.get(b);if(I===void 0)throw new Error("Invalid symbol error");I.forEach(z=>{f.push(`${a[v].indicesSet(`input${v}Indices`,z,`${b}`)}`)}),_.push(`prod *= ${a[v].getByIndices(`input${v}Indices`)};`)}}),g.push(`for(var ${b}: u32 = 0; ${b} < uniforms.${cr(b)}; ${b}++) {`),y.push("}")});let w=m?[...d,`let sum = ${a.map(($,b)=>$.getByIndices(`input${b}Indices`)).join(" * ")};`]:[...d,c,...g,...f,p,..._,h,...y];return`
 ${l.registerUniforms(o.map($=>({name:`${cr($)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...a,s)}
...
}`};return{name:"Einsum",shaderCache:{hint:i.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=o.filter(p=>i.symbolToInfo.has(p)).map(p=>({type:12,data:i.symbolToInfo.get(p)?.dimValue||0}));l.push({type:12,data:n});let d=e.map((p,c)=>[...D(p)]).reduce((p,c)=>p.concat(c),l);return d.push(...D(r)),{outputs:[{dims:r,dataType:t}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:d}},getShaderSource:u}},Yo=(e,t)=>{let i=new Qo(e.inputs,t.equation),r=i.outputDims,a=e.inputs.map((n,s)=>n.dims);e.compute(Xo(a,e.inputs[0].dataType,i,r))},Jo=e=>{let t=e.equation.replace(/\s+/g,"");return Q({equation:t})}}),eu,hr,tu,iu,ru,Up=T(()=>{N(),W(),G(),eu=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,i=Array.from(e[1].getBigInt64Array(),Number),r=i.length<t.length?0:i.length-t.length,a=t.length<i.length?0:t.length-i.length;for(;r<i.length&&a<t.length;++r,++a)if(i[r]!==t[a]&&i[r]!==1&&t[a]!==1)throw new Error("Expand requires shape to be broadcastable to input")},hr=(e,t)=>{let i=e.length-t.length,r=[];for(let a=0;a<i;++a)r.push(e[a]);for(let a=0;a<t.length;++a)r.push(t[a]===1?e[a+i]:t[a]);return r},tu=(e,t)=>e.length>t.length?hr(e,t):hr(t,e),iu=e=>{let t=e[0].dims,i=Array.from(e[1].getBigInt64Array(),Number),r=tu(t,i),a=e[0].dataType,n=a===9||k.size(t)===1,s=a===9||t.length>0&&t[t.length-1]%4===0?4:1,o=n||r.length>0&&r[r.length-1]%4===0?4:1,u=Math.ceil(k.size(r)/o),l=p=>{let c=S("input",a,t.length,s),h=B("output",a,r.length,o),f;if(a===9){let g=(y,_,m="")=>`
...
${f}`},d=[{type:12,data:u},...D(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${s}${o}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d})}},ru=e=>{eu(e.inputs),e.compute(iu(e.inputs),{inputs:[0]})}}),au,nu,Pp=T(()=>{N(),W(),G(),Zi(),au=e=>{let t=e[0].dataType,i=k.size(e[0].dims),r=k.size(e[1].dims),a=r%4===0,n=s=>{let o=S("x",t,[1],4),u=S("bias",t,[1],4),l=B("y",t,[1],4),d=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],p=h=>`
...
}`};return{name:"FastGeluWithBias",shaderCache:{hint:`${a}`,inputDependencies:["type","type"]},getShaderSource:n,getRunData:s=>({outputs:[{dims:s[0].dims,dataType:s[0].dataType}],programUniforms:[{type:12,data:Math.ceil(i/4)},{type:12,data:r}],dispatchGroup:{x:Math.ceil(i/ct/4)}})}},nu=e=>{e.inputs.length<2||k.size(e.inputs[1].dims)===0?Ps(e):e.compute(au(e.inputs))}}),su,ou,uu,lu,qp=T(()=>{N(),W(),ae(),G(),su=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},ou=(e,t)=>{let i=e[0].dims,r=e[1].dims,a=i.length,n=k.normalizeAxis(t.axis,a),s=i.slice(0);s.splice(n,1,...r);let o=i[n],u=e[0].dataType===9?4:1,l=Math.ceil(k.size(s)/u),d=[{type:12,data:l},{type:6,data:o},{type:12,data:n},...D(e[0].dims,e[1].dims,s)],p=c=>{let h=S("data",e[0].dataType,e[0].dims.length,u),f=S("inputIndices",e[1].dataType,e[1].dims.length),g=B("output",e[0].dataType,s.length,u),y=m=>{let w=r.length,$=`var indicesIndices${m}  = ${f.type.indices}(0);`;for(let b=0;b<w;b++)$+=`${w>1?`indicesIndices${m}[${b}]`:`indicesIndices${m}`} = ${s.length>1?`outputIndices${m}[uniforms.axis + ${b}]`:`outputIndices${m}`};`;$+=`
...
}`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((h,f)=>f!==1).map(h=>h.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(h,f)=>"rank")},getRunData:()=>({outputs:[{dims:o,dataType:l}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:c}},mu=(e,t)=>{let i=e.inputs;hu(i,t),e.compute(fu(e.inputs,t))},gu=e=>Q({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),_u,yu,$u,wu,Lp=T(()=>{N(),W(),ae(),G(),_u=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
          indices input tensors be of same rank.`)},yu=(e,t)=>{let i=e[0].dims,r=e[0].dataType,a=i.length,n=e[1].dims,s=e[1].dataType,o=k.normalizeAxis(t.axis,a),u=i[o],l=n.slice(0),d=k.size(l),p=S("input",r,a),c=S("indicesInput",s,n.length),h=B("output",r,l.length),f=[{type:12,data:d},{type:6,data:u},{type:12,data:o}];return f.push(...D(i,n,l)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:f}),getShaderSource:g=>`
...
indices[${Ue}] = batch;
indices[${Le}] = channel;`+(()=>{switch(i.paddingMode){case"zeros":return`
if (r >= 0 && r < H && c >=0 && c < W) {
 indices[${st}] = u32(r);
 indices[${ot}] = u32(c);
} else {
...
let result = pixel_at_grid(i32(round(y)), i32(round(x)), H_in, W_in, indices[${Ue}], indices[${Le}], border);
...
let p11 = pixel_at_grid(y1, x1, H_in, W_in, indices[${Ue}], indices[${Le}], border);
let p12 = pixel_at_grid(y1, x2, H_in, W_in, indices[${Ue}], indices[${Le}], border);
let p21 = pixel_at_grid(y2, x1, H_in, W_in, indices[${Ue}], indices[${Le}], border);
let p22 = pixel_at_grid(y2, x2, H_in, W_in, indices[${Ue}], indices[${Le}], border);
...
for (var h = 0; h < 4; h++) {
 for (var w = 0; w < 4; w++) {
   p[h][w] = pixel_at_grid(h + y0, w + x0, H_in, W_in, indices[${Ue}], indices[${Le}], border);
 }
}
...
}`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:o,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:d},{inputs:[t,i],outputs:[-1]})[0]},Tt=(e,t,i,r,a,n,s,o)=>{let u=n;if(s&&k.size(s.dims)>0){if(r===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=Uu(e,n,s,t,r,i*a,o),u=u.reshape([t,r,i,a]),i===1||r===1?u:e.compute(we(u,fr.perm),{inputs:[u],outputs:[-1]})[0]}else return n.dims.length===3&&(u=n.reshape([t,r,i,a])),i===1||r===1?u:e.compute(we(u,fr.perm),{inputs:[u],outputs:[-1]})[0]},Pu=(e,t)=>{let i=Mu(e.inputs,t),r=e.inputs[0],a=_e(e.inputs,1),n=_e(e.inputs,2),s=_e(e.inputs,3),o=_e(e.inputs,4),u=_e(e.inputs,5),l=_e(e.inputs,6),d=_e(e.inputs,7);if(r.dims.length===5)throw new Error("Packed QKV is not implemented");if(a?.dims.length===5)throw new Error("Packed KV is not implemented");let p=a&&n&&a.dims.length===4&&n.dims.length===4,c=Tt(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,r,s,0);if(p)return vt(e,c,a,n,o,void 0,l,d,u,i);if(!a||!n)throw new Error("key and value must be provided");let h=Tt(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.headSize,a,s,i.hiddenSize),f=Tt(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.vHeadSize,n,s,2*i.hiddenSize);vt(e,c,h,f,o,void 0,l,d,u,i)}}),Nu,Vu,Lu,Wu,mr,Gu,Hu,Fu=T(()=>{N(),W(),ae(),G(),Nu=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Vu=(e,t)=>{let i=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(a=>i.push(Number(a))),r=i.length),Q({numOutputs:r,axis:t.axis,splitSizes:i})},Lu=e=>`
...
}`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:h,getRunData:()=>({outputs:l,dispatchGroup:{x:Math.ceil(r/64)},programUniforms:c})}},Gu=(e,t)=>{Nu(e.inputs);let i=e.inputs.length===1?t:Vu(e.inputs,t);e.compute(mr(e.inputs,i),{inputs:[0]})},Hu=e=>{let t=e.axis,i=e.splitSizes,r=e.numOutputs<0?i.length:e.numOutputs;if(r!==i.length)throw new Error("numOutputs and splitSizes lengh must be equal");return Q({axis:t,numOutputs:r,splitSizes:i})}}),ju,Yt,Ku,Zu=T(()=>{N(),W(),ae(),G(),ju=(e,t)=>{let[i,r,a,n]=e,{numHeads:s,rotaryEmbeddingDim:o}=t;if(i.dims.length!==3&&i.dims.length!==4)throw new Error(`Input 'x' is expected to have 3 or 4 dimensions, got ${i.dims.length}`);if(!k.areEqual(r.dims,[])&&!k.areEqual(r.dims,[1])&&r.dims.length!==2)throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${r.dims.length}`);if(a.dims.length!==2)throw new Error(`Input 'cos_cache' is expected to have 2 dimensions, got ${a.dims.length}`);if(n.dims.length!==2)throw new Error(`Input 'sin_cache' is expected to have 2 dimensions, got ${n.dims.length}`);if(!k.areEqual(a.dims,n.dims))throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");if(o>0&&s===0)throw new Error("num_heads must be provided if rotary_embedding_dim is specified");let u=i.dims[0],l=i.dims[i.dims.length-2],d=a.dims[0],p=k.sizeFromDimension(i.dims,1)/l,c=o===0?a.dims[1]*2:p/s;if(o>c)throw new Error("rotary_embedding_dim must be less than or equal to head_size");if(r.dims.length===2){if(u!==r.dims[0])throw new Error(`Input 'position_ids' dimension 0 should be of size batch_size, got ${r.dims[0]}`);if(l!==r.dims[1])throw new Error(`Input 'position_ids' dimension 1 should be of size sequence_length, got ${r.dims[1]}`)}if(c/2!==a.dims[1]&&o/2!==a.dims[1])throw new Error(`Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${a.dims[1]}`);if(l>d)throw new Error("Updating cos_cache and sin_cache in RotaryEmbedding is not currently supported")},Yt=(e,t)=>{let{interleaved:i,numHeads:r,rotaryEmbeddingDim:a,scale:n}=t,s=e[0].dims[0],o=k.sizeFromDimension(e[0].dims,1),u=e[0].dims[e[0].dims.length-2],l=o/u,d=e[2].dims[1],p=a===0?d*2:l/r,c=new Array(s,u,l/p,p-d),h=k.computeStrides(c),f=[{type:1,data:n},{type:12,data:c},{type:12,data:h},...e[0].dims.length===3?new Array({type:12,data:[o,l,p,1]}):[],...e[0].dims.length===4?new Array({type:12,data:[o,p,u*p,1]}):[],...D(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)],g=y=>{let _=S("input",e[0].dataType,e[0].dims.length),m=S("position_ids",e[1].dataType,e[1].dims.length),w=S("cos_cache",e[2].dataType,e[2].dims.length),$=S("sin_cache",e[3].dataType,e[3].dims.length),b=B("output",e[0].dataType,e[0].dims.length);return y.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:c.length},{name:"global_strides",type:"u32",length:h.length},{name:"input_output_strides",type:"u32",length:h.length}]),`
...
`};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:n},getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:u}),getShaderSource:l}},Ju=(e,t)=>{let i=Qu(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let r=e.inputs[0],a=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,n=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,s=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,o=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,u=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,d=i.kvNumHeads?i.kvNumHeads:i.numHeads,p=Q({axis:2,numOutputs:3,splitSizes:[i.numHeads*i.headSize,d*i.headSize,d*i.headSize]}),[c,h,f]=!a&&!n?e.compute(mr([r],p),{inputs:[r],outputs:[-1,-1,-1]}):[r,a,n],g,y;if(t.doRotary){let $=e.compute(Yu(i.batchSize,i.sequenceLength,u,l),{inputs:[u,l],outputs:[-1]})[0],b=e.inputs[7],x=e.inputs[8],v=Q({interleaved:t.rotaryInterleaved!==0,numHeads:i.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),I=[c,$,b,x],z=[-1];g=e.compute(Yt(I,v),{inputs:I,outputs:z})[0],I.splice(0,1,h);let O=Q({interleaved:t.rotaryInterleaved!==0,numHeads:i.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});y=e.compute(Yt(I,O),{inputs:I,outputs:z})[0]}let _=Tt(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,t.doRotary?g:c,void 0,0),m=gr(e,t.doRotary?y:h,i),w=gr(e,f,i);vt(e,_,m,w,void 0,void 0,s,o,void 0,i,u,l)}}),_r,el,tl,il,Fp=T(()=>{N(),W(),je(),G(),_r=(e,t,i,r,a,n,s,o)=>{let u=re(n),l=u===1?"f32":`vec${u}f`,d=u===1?"vec2f":`mat2x${u}f`,p=a*s,c=64;p===1&&(c=256);let h=[a,s,n/u],f=[a,s,2],g=["rank","type","type"],y=[];y.push(...D(h,f));let _=m=>{let w=S("x",t.dataType,3,u),$=S("scale",i.dataType,i.dims),b=S("bias",r.dataType,r.dims),x=B("output",1,3,2),v=[w,$,b,x];return`
...
if (local_idx == 0) {
let sum_final = ${Fe("workgroup_shared[0][0]",u)} / f32(hight * ${u});
let squared_sum_final = ${Fe("workgroup_shared[0][1]",u)} / f32(hight * ${u});
...
}`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${o};${c}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:f,dataType:1}],dispatchGroup:{x:p},programUniforms:y}),getShaderSource:_},{inputs:[t,i,r],outputs:[-1]})[0]},el=(e,t,i)=>{let r=t[0].dims,a=r,n=2,s=r[0],o=r[1],u=k.sizeFromDimension(r,n),l=re(u),d=k.size(a)/l,p=_r(e,t[0],t[1],t[2],s,u,o,i.epsilon),c=[s,o,u/l],h=[s,o],f=["type","none"],g=y=>{let _=S("x",t[0].dataType,c.length,l),m=S("scale_shift",1,h.length,2),w=B("output",t[0].dataType,c.length,l),$=[_,m,w];return`
...
}`};e.compute({name:"InstanceNormalization",shaderCache:{hint:`${l}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:[{type:12,data:d},...D(c,h,c)]}),getShaderSource:g},{inputs:[t[0],p]})},tl=(e,t,i)=>{let r=t[0].dims,a=r,n=r[0],s=r[r.length-1],o=k.sizeFromDimension(r,1)/s,u=re(s),l=k.size(a)/u,d=[{type:12,data:o},{type:12,data:Math.floor(s/u)}],p=["type","type"],c=!1,h=[0,r.length-1];for(let _=0;_<r.length-2;_++)c=c||r[_+1]!==1,h.push(_+1);c=c&&r[r.length-1]!==1;let f=c?e.compute(we(e.inputs[0],h),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:r.length},(_,m)=>r[h[m]])),g=_r(e,f,t[1],t[2],n,o,s,i.epsilon),y=_=>{let m=se(t[0].dataType),w=u===1?"vec2f":`mat${u}x2f`,$=v=>{let I=v===0?"x":"y",z=u===1?"f32":`vec${u}f`;switch(u){case 1:return`${m}(${z}(scale.${I}))`;case 2:return`vec2<${m}>(${z}(scale[0].${I}, scale[1].${I}))`;case 4:return`vec4<${m}>(${z}(scale[0].${I}, scale[1].${I}, scale[2].${I}, scale[3].${I}))`;default:throw new Error(`Not supported compoents ${u}`)}},b=S("input",t[0].dataType,t[0].dims,u),x=B("output",t[0].dataType,a,u);return`
...
let value = ${ht(x,f,"x[h + offset]")};
mean_vector += value;
mean_square_vector += value * value;
}
let mean = ${Fe("mean_vector",f)} / uniforms.norm_size;
let inv_std_dev = inverseSqrt(${Fe("mean_square_vector",f)} / uniforms.norm_size ${r?"":"- mean * mean"} + uniforms.epsilon);

for (var j: u32 = 0; j < uniforms.norm_size_vectorized; j++) {
let f32input = ${ht(x,f,"x[j + offset]")};
let f32scale = ${ht(x,f,"scale[j]")};
...
}`},$=[{dims:o,dataType:e[0].dataType}];return _&&$.push({dims:h,dataType:1}),m&&$.push({dims:h,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${f};${i};${r}`,inputDependencies:g},getRunData:()=>({outputs:$,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:y}),getShaderSource:w}},nl=(e,t)=>{rl(e.inputs),e.compute(al(e.inputs,t,e.outputCount))}}),sl,ol,Kp=T(()=>{W(),Ji(),rr(),sl=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},ol=e=>{sl(e.inputs);let t=pt.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let i=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(i<8&&r<8)e.compute(Yi(e.inputs,{activation:""},t));else{let a=t[t.length-2],n=k.size(e.inputs[0].dims.slice(0,-2)),s=k.size(e.inputs[1].dims.slice(0,-2));if(n!==1&&a===1&&s===1){let o=e.inputs[0].reshape([1,n,r]),u=e.inputs[1].reshape([1,r,i]),l=[1,n,i],d=[o,u];e.compute(Kt(d,{activation:""},t,l),{inputs:d})}else e.compute(Kt(e.inputs,{activation:""},t))}}}),ul,ll,dl,pl,cl,Zp=T(()=>{N(),W(),ae(),G(),ul=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let i=e[0],r=i.dims.length;if(i.dims[r-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let a=Math.floor((t.k+t.blockSize-1)/t.blockSize),n=t.blockSize/8*t.bits,s=e[1];if(!k.areEqual(s.dims,[t.n,a,n]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let o=e[2].dims;if(k.size(o)!==t.n*a)throw new Error("scales input size error.");if(e.length===4){let u=e[3].dims,l=t.bits>4?t.n*a:t.n*Math.floor((a+1)/2);if(k.size(u)!==l)throw new Error("zeroPoints input size error.")}},ll=(e,t)=>{let i=e[0].dims,r=i.length,a=i[r-2],n=t.k,s=t.n,o=i.slice(0,r-2),u=k.size(o),l=e[1].dims[2]/4,d=e[0].dataType,p=re(t.k),c=re(l),h=re(s),f=o.concat([a,s]),g=a>1&&s/h%2===0?2:1,y=k.size(f)/h/g,_=64,m=[],w=[u,a,n/p],$=k.convertShape(e[1].dims).slice();$.splice(-1,1,l/c),m.push(...D(w)),m.push(...D($)),m.push(...D(e[2].dims)),e.length===4&&m.push(...D(k.convertShape(e[3].dims)));let b=[u,a,s/h];m.push(...D(b));let x=v=>{let I=w.length,z=S("a",e[0].dataType,I,p),O=S("b",12,$.length,c),V=S("scales",e[2].dataType,e[2].dims.length),U=[z,O,V],L=e.length===4?S("zero_points",12,e[3].dims.length):void 0;L&&U.push(L);let A=b.length,F=B("output",e[0].dataType,A,h),q=se(e[0].dataType),M=(()=>{switch(p){case 1:return`array<${q}, 8>`;case 2:return`mat4x2<${q}>`;case 4:return`mat2x4<${q}>`;default:throw new Error(`${p}-component is not supported.`)}})(),Z=()=>{let E=`
// reuse a data
...
}`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${p};${c};${y};${g}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:h,dataType:d}],dispatchGroup:{x:$},programUniforms:b}),getShaderSource:z}},pl=(e,t)=>{ul(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(dl(e.inputs,t)):e.compute(ll(e.inputs,t))},cl=e=>Q(e)}),hl,fl,ml,gl,_l,yl,$l,wl,bl,Qp=T(()=>{N(),W(),G(),hl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},fl=(e,t,i)=>{let r="";for(let a=t-1;a>=0;--a)r+=`
...
`},yl=(e,t,i)=>{switch(i.mode){case 0:return fl(e,t,i.pads.length);case 1:return ml(e,t,i.pads.length);case 2:return gl(e,t,i.pads.length);case 3:return _l(e,t,i.pads.length);default:throw new Error("Invalid mode")}},$l=(e,t)=>{let i=k.padShape(e[0].dims.slice(),t.pads),r=e[0].dims,a=k.size(i),n=[{type:12,data:a},{type:6,data:t.pads}],s=e.length>=3&&e[2].data;t.mode===0&&n.push({type:s?e[2].dataType:1,data:t.value}),n.push(...D(e[0].dims,i));let o=["rank"],u=l=>{let d=B("output",e[0].dataType,i.length),p=S("x",e[0].dataType,r.length),c=p.type.value,h=yl(d,r.length,t),f=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&f.push({name:"constant_value",type:s?c:"f32"}),`
 ...
 ${e.mainStart()}
   ...
   output[global_idx] = value;
 }`}},br=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,vl=e=>`${br(e)};${e.countIncludePad}`,xl=e=>`${br(e)};${e.storageOrder};${e.dilations}`,vr=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),xr=(e,t,i,r)=>{let[a,n]=yr(t,r,i),s=S("x",t.dataType,t.dims.length),o=s.type.value,u="value += x_val;",l="";a.countIncludePad?l+=`value /= ${o}(uniforms.kernelSize);`:l+=`value /= ${o}(i32(uniforms.kernelSize) - pad);`;let[d,p,c,h,f]=$r(n,a);d.push(...D(t.dims,n));let g=["rank"];return{name:e,shaderCache:{hint:`${r.cacheKey};${c};${h};${f}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:n,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(k.size(n)/64)},programUniforms:d}),getShaderSource:y=>wr(y,s,t.dims.length,n.length,a,u,l,0,p,c,h,f)}},kl=e=>{let t=e.count_include_pad!==0,i=vr(e);if(i.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let r={countIncludePad:t,...i,cacheKey:""};return{...r,cacheKey:vl(r)}},Sl=(e,t)=>{zt(e.inputs),e.compute(xr("AveragePool",e.inputs[0],!1,t))},kr={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},Il=e=>{let t=e.format;return{format:t,...kr,cacheKey:t}},Tl=(e,t)=>{zt(e.inputs),e.compute(xr("GlobalAveragePool",e.inputs[0],!0,t))},Sr=(e,t,i,r)=>{let[a,n]=yr(t,r,i),s=`
value = max(x_val, value);
`,o="",u=S("x",t.dataType,t.dims.length),l=["rank"],[d,p,c,h,f]=$r(n,a);return d.push(...D(t.dims,n)),{name:e,shaderCache:{hint:`${r.cacheKey};${c};${h};${f}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:n,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(k.size(n)/64)},programUniforms:d}),getShaderSource:g=>wr(g,u,t.dims.length,n.length,a,s,o,t.dataType===10?-65504:-1e5,p,c,h,f)}},zl=(e,t)=>{zt(e.inputs),e.compute(Sr("MaxPool",e.inputs[0],!1,t))},El=e=>{let t=e.storage_order,i=e.dilations,r=vr(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let a={storageOrder:t,dilations:i,...r,cacheKey:""};return{...a,cacheKey:xl(a)}},Cl=e=>{let t=e.format;return{format:t,...kr,cacheKey:t}},Ol=(e,t)=>{zt(e.inputs),e.compute(Sr("GlobalMaxPool",e.inputs[0],!0,t))}}),Al,Bl,Rl,Ml,Yp=T(()=>{N(),W(),ae(),G(),Al=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((i,r)=>i===e[2].dims[r]).reduce((i,r)=>i&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((a,n)=>n===t.axis||a===e[0].dims[n]).reduce((a,n)=>a&&n,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(i/r)||t.blockSize>Math.ceil(i/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Bl=(e,t)=>{let i=k.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,a=r===3,n=e[0].dims,s=e[1].dataType,o=k.size(n),u=r===3||r===2,l=u?[Math.ceil(k.size(e[0].dims)/4)]:e[0].dims,d=e[1].dims,p=e.length>2?e[2]:void 0,c=p?u?[Math.ceil(k.size(p.dims)/4)]:p.dims:void 0,h=d.length===0||d.length===1&&d[0]===1,f=h===!1&&d.length===1,g=re(o),y=h&&(!u||g===4),_=y?g:1,m=y&&!u?g:1,w=S("input",u?12:r,l.length,m),$=S("scale",s,d.length),b=p?S("zero_point",u?12:r,c.length):void 0,x=B("output",s,n.length,_),v=[w,$];b&&v.push(b);let I=[l,d];p&&I.push(c);let z=[{type:12,data:o/_},{type:12,data:i},{type:12,data:t.blockSize},...D(...I,n)],O=V=>{let U=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
...
}`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getShaderSource:O,getRunData:()=>({outputs:[{dims:n,dataType:s}],dispatchGroup:{x:Math.ceil(o/_/64),y:1,z:1},programUniforms:z})}},Rl=(e,t)=>{Al(e.inputs,t),e.compute(Bl(e.inputs,t))},Ml=e=>Q({axis:e.axis,blockSize:e.blockSize})}),Dl,Ul,Pl,Jp=T(()=>{Te(),N(),G(),Dl=(e,t,i)=>{let r=e===t,a=e<t&&i<0,n=e>t&&i>0;if(r||a||n)throw new Error("Range these inputs' contents are invalid.")},Ul=(e,t,i,r)=>{let a=Math.abs(Math.ceil((t-e)/i)),n=[a],s=a,o=[{type:12,data:s},{type:r,data:e},{type:r,data:i},...D(n)],u=l=>{let d=B("output",r,n.length),p=d.type.value,c=[{name:"outputSize",type:"u32"},{name:"start",type:p},{name:"delta",type:p}];return`
${l.registerUniforms(c).declareVariables(d)}
${l.mainStart()}
${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
output[global_idx] = uniforms.start + ${p}(global_idx) * uniforms.delta;
}`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:o})}},Pl=e=>{let t=0,i=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],i=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],i=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),J.webgpu.validateInputContent&&Dl(t,i,r),e.compute(Ul(t,i,r,e.inputs[0].dataType),{inputs:[]})}}),ql,Ir,Tr,Nl,Vl,Ll,ec=T(()=>{N(),W(),ae(),G(),ql=(e,t,i,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let a=`{
     var oldValue = 0;
     loop {
       let newValueF32 =`,n=`;
   ...
   ${a}bitcast<${r}>(oldValue) + (${i})${n}`;case"max":return r==="i32"||r==="u32"?`atomicMax(&${t}, bitcast<${r}>(${i}));`:`
     ${a}max(bitcast<f32>(oldValue), (${i}))${n}`;case"min":return r==="i32"||r==="u32"?`atomicMin(&${t}, bitcast<${r}>(${i}));`:`${a}min(bitcast<${r}>(oldValue), (${i}))${n}`;case"mul":return`${a}(bitcast<${r}>(oldValue) * (${i}))${n}`;default:throw new Error(`Reduction ${e} is not supported.`)}},Ir=(e,t)=>`${e===1?`
...
data_offset += u32((u32(index) * element_count_dim));`,Tr=(e,t,i)=>`for (var i = 0u; i < uniforms.num_updates_elements; i++) {
let value = updates[uniforms.num_updates_elements * ${i?"global_idx":"idx"} + i];
${ql(e.reduction,"output[data_offset + i]","value",t)}
}`,Nl=(e,t)=>{let i=e[0].dims,r=e[1].dims,a=i,n=1,s=Math.ceil(k.size(r)/n),o=r[r.length-1],u=k.sizeFromDimension(i,o),l=k.sizeFromDimension(r,0)/o,d=[{type:12,data:s},{type:12,data:o},{type:12,data:u},...D(e[1].dims,e[2].dims,a)],p=c=>{let h=S("indices",e[1].dataType,e[1].dims.length),f=S("updates",e[2].dataType,e[2].dims.length,n),g=t.reduction!=="none"&&t.reduction!==""?Fa("output",e[0].dataType,a.length):B("output",e[0].dataType,a.length,n);return`
...
if (xScale < 1.0 || floor(xScale) != xScale) {
 ...
 ${zr("xResized","lengthOriginal","lengthResized",t)}
}
`;case"pytorch_half_pixel":return`if (lengthResized > 1) {
         ...
         ${zr("xResized","lengthOriginal - 1","lengthResized - 1",t)}
...
let mean = ${Fe("sum",_)} / f32(uniforms.hidden_size);
let inv_std_dev = inverseSqrt(${Fe("square_sum",_)} / f32(uniforms.hidden_size) ${a?"":"- mean * mean"} + uniforms.epsilon);
...
}`},$=[{dims:o,dataType:e[0].dataType}];return i>1&&$.push({dims:d,dataType:1}),i>2&&$.push({dims:d,dataType:1}),i>3&&$.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${_};${h};${f};${g}`,inputDependencies:e.map((b,x)=>"type")},getShaderSource:w,getRunData:()=>({outputs:$,dispatchGroup:{x:Math.ceil(u/l)},programUniforms:m})}},ld=(e,t)=>{od(e.inputs);let i=[0];e.outputCount>1&&i.push(-3),e.outputCount>2&&i.push(-3),e.outputCount>3&&i.push(3),e.compute(ud(e.inputs,t,e.outputCount,!1),{outputs:i})}}),dd,Et,pd,Cr,cd,hd,fd,md,rc=T(()=>{N(),W(),ae(),G(),dd=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((i,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},Et=(e,t)=>{let i=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>i.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>i.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return i},pd=(e,t)=>{if(e.length>1){let i=Et(e,1),r=Et(e,2),a=Et(e,3);return a.length===0&&(a=[...Array(e[0].dims.length).keys()]),Q({starts:i,ends:r,axes:a})}else return t},Cr=(e,t,i,r,a)=>{let n=e;return e<0&&(n+=i[r[t]]),a[t]<0?Math.max(0,Math.min(n,i[r[t]]-1)):Math.max(0,Math.min(n,i[r[t]]))},cd=(e,t,i)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
var input_indices: ${e.type.indices};
var carry = 0u;
...
return input_indices;
}`,hd=(e,t)=>{let i=e[0].dims,r=k.size(i),a=t.axes.length>0?k.normalizeAxes(t.axes,i.length):[...Array(i.length).keys()],n=Et(e,4);n.forEach(_=>_!==0||(()=>{throw new Error("step cannot be 0")})),n.length===0&&(n=Array(a.length).fill(1));let s=t.starts.map((_,m)=>Cr(_,m,i,a,n)),o=t.ends.map((_,m)=>Cr(_,m,i,a,n));if(a.length!==s.length||a.length!==o.length)throw new Error("start, ends and axes should have the same number of elements");if(a.length!==i.length)for(let _=0;_<i.length;++_)a.includes(_)||(s.splice(_,0,0),o.splice(_,0,i[_]),n.splice(_,0,1));let u=n.map(_=>Math.sign(_));n.forEach((_,m,w)=>{if(_<0){let $=(o[m]-s[m])/_,b=s[m],x=b+$*n[m];s[m]=x,o[m]=b,w[m]=-_}});let l=i.slice(0);a.forEach((_,m)=>{l[_]=Math.ceil((o[_]-s[_])/n[_])});let d={dims:l,dataType:e[0].dataType},p=B("output",e[0].dataType,l.length),c=S("input",e[0].dataType,e[0].dims.length),h=k.size(l),f=[{name:"outputSize",type:"u32"},{name:"starts",type:"u32",length:s.length},{name:"signs",type:"i32",length:u.length},{name:"steps",type:"u32",length:n.length}],g=[{type:12,data:h},{type:12,data:s},{type:6,data:u},{type:12,data:n},...D(e[0].dims,l)],y=_=>`
...
}`;return{name:"Slice",shaderCache:{hint:`${u.length}_${s.length}_${n.length}`,inputDependencies:["rank"]},getShaderSource:y,getRunData:()=>({outputs:[d],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:g})}},fd=(e,t)=>{dd(e.inputs,t);let i=pd(e.inputs,t);e.compute(hd(e.inputs,i),{inputs:[0]})},md=e=>{let t=e.starts,i=e.ends,r=e.axes;return Q({starts:t,ends:i,axes:r})}}),gd,_d,yd,$d,ac=T(()=>{N(),W(),ae(),je(),G(),gd=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},_d=(e,t)=>{let i=e.inputs[0],r=i.dims,a=k.size(r),n=r.length,s=k.normalizeAxis(t.axis,n),o=s<r.length-1,u,l=[];o?(l=Array.from({length:n},(v,I)=>I),l[s]=n-1,l[n-1]=s,u=e.compute(we(i,l),{inputs:[i],outputs:[-1]})[0]):u=i;let d=u.dims,p=d[n-1],c=a/p,h=re(p),f=p/h,g=64;c===1&&(g=256);let y=(v,I)=>I===4?`max(max(${v}.x, ${v}.y), max(${v}.z, ${v}.w))`:I===2?`max(${v}.x, ${v}.y)`:I===3?`max(max(${v}.x, ${v}.y), ${v}.z)`:v,_=S("x",u.dataType,u.dims,h),m=B("result",u.dataType,u.dims,h),w=_.type.value,$=se(u.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,b=v=>`
...
if (lindex == 0) {
rowSumShared = ${w}(${Fe("threadShared[0]",h)});
}
workgroupBarrier();
...
}`,x=e.compute({name:"Softmax",shaderCache:{hint:`${h};${g}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:d,dataType:u.dataType}],dispatchGroup:{x:c},programUniforms:[{type:6,data:f}]}),getShaderSource:b},{inputs:[u],outputs:[o?-1:0]})[0];o&&e.compute(we(x,l),{inputs:[x]})},yd=(e,t)=>{gd(e.inputs),_d(e,t)},$d=e=>Q({axis:e.axis})}),Or,wd,bd,vd,xd,nc=T(()=>{N(),W(),G(),Or=e=>Array.from(e.getBigInt64Array(),Number),wd=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==10&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, float16, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(Or(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},bd=(e,t)=>{let i=[];for(let r=0;r<e.length;++r)i.push(e[r]*t[r]);return i},vd=(e,t)=>{let i=e[0].dims,r=t??Or(e[1]),a=bd(i,r),n=k.size(a),s=e[0].dataType,o=S("input",s,i.length),u=B("output",s,a.length),l=d=>`
...
${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
${l}
}`},Sd=e=>{let t=e[1].dims,i=e[2].dims,r=e[0].dims,a=e[1].dataType,n=!(k.areEqual(t,i)&&k.areEqual(i,r)),s=t,o=k.size(t);if(n){let l=pt.calcShape(pt.calcShape(t,i,!1),r,!1);if(!l)throw new Error("Can't perform where op on the given tensors");s=l,o=k.size(s)}let u=Math.ceil(o/4);return{name:"Where",shaderCache:{inputDependencies:["rank","rank","rank"]},getShaderSource:l=>kd(l,e,s,n,a),getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:Math.ceil(o/64/4)},programUniforms:[{type:12,data:u},...D(r,t,i,s)]})}},Id=e=>{e.compute(Sd(e.inputs))}}),Td,oc=T(()=>{bp(),Hi(),vp(),xp(),kp(),Sp(),Ip(),Op(),Bp(),Rp(),Mp(),Dp(),Up(),Pp(),qp(),Np(),Vp(),Lp(),Wp(),Gp(),Hp(),Fp(),jp(),Kp(),Zp(),qu(),Qp(),Xp(),Yp(),Jp(),ec(),Li(),tc(),Zu(),ic(),rc(),ac(),Fu(),nc(),je(),Zi(),sc(),Td=new Map([["Abs",[ss]],["Acos",[os]],["Acosh",[us]],["Add",[Zs]],["ArgMax",[Hn,Gi]],["ArgMin",[Gn,Gi]],["Asin",[ls]],["Asinh",[ds]],["Atan",[ps]],["Atanh",[cs]],["Attention",[Xn]],["AveragePool",[Sl,kl]],["BatchNormalization",[ts]],["BiasAdd",[as]],["BiasSplitGelu",[Fs]],["Cast",[fs,hs]],["Ceil",[_s]],["Clip",[gs]],["Concat",[lo,po]],["Conv",[ur,sr]],["ConvTranspose",[Po,Mo]],["Cos",[ys]],["Cosh",[$s]],["CumSum",[No,Vo]],["DepthToSpace",[Ho,Fo]],["DequantizeLinear",[Rl,Ml]],["Div",[Qs]],["Einsum",[Yo,Jo]],["Elu",[ws,xt]],["Equal",[Xs]],["Erf",[bs]],["Exp",[vs]],["Expand",[ru]],["FastGelu",[nu]],["Floor",[xs]],["FusedConv",[ur,sr]],["Gather",[lu,uu]],["GatherElements",[wu,$u]],["GatherBlockQuantized",[mu,gu]],["GatherND",[pu,cu]],["Gelu",[ks]],["Gemm",[ku,xu]],["GlobalAveragePool",[Tl,Il]],["GlobalMaxPool",[Ol,Cl]],["Greater",[to]],["GreaterOrEqual",[ro]],["GridSample",[Bu,Ru]],["GroupQueryAttention",[Ju]],["HardSigmoid",[As,Os]],["InstanceNormalization",[il]],["LayerNormalization",[nl]],["LeakyRelu",[Ss,xt]],["Less",[io]],["LessOrEqual",[ao]],["Log",[Ns]],["MatMul",[ol]],["MatMulNBits",[pl,cl]],["MaxPool",[zl,El]],["Mul",[Ys]],["MultiHeadAttention",[Pu,Du]],["Neg",[Ts]],["Not",[Is]],["Pad",[bl]],["Pow",[Js]],["QuickGelu",[Ws,xt]],["Range",[Pl]],["Reciprocal",[zs]],["ReduceMin",[qn]],["ReduceMean",[Rn]],["ReduceMax",[Pn]],["ReduceSum",[Vn]],["ReduceProd",[Nn]],["ReduceL1",[Mn]],["ReduceL2",[Dn]],["ReduceLogSum",[Wn]],["ReduceLogSumExp",[Un]],["ReduceSumSquare",[Ln]],["Relu",[Es]],["Resize",[nd,sd]],["RotaryEmbedding",[Ku]],["ScatterND",[Ll,Vl]],["Sigmoid",[Cs]],["Sin",[Bs]],["Sinh",[Rs]],["Slice",[fd,md]],["SkipLayerNormalization",[ld]],["Split",[Gu,Hu]],["Sqrt",[Ms]],["Softmax",[yd,$d]],["Sub",[eo]],["Tan",[Ds]],["Tanh",[Us]],["ThresholdedRelu",[qs,xt]],["Tile",[xd]],["Transpose",[en,tn]],["Where",[Id]]])}),zd,uc=T(()=>{Te(),Ve(),G(),zd=class{constructor(e){this.backend=e,this.repo=new Map,this.attributesBound=!1}getArtifact(e){return this.repo.get(e)}setArtifact(e,t){this.repo.set(e,t)}run(e,t,i,r,a){Ie(e.programInfo.name);let n=this.backend.device,s=this.backend.getComputePassEncoder();this.backend.writeTimestamp(this.backend.pendingDispatchNumber*2);let o=[];for(let l of t)o.push({binding:o.length,resource:{buffer:l.buffer}});for(let l of i)o.push({binding:o.length,resource:{buffer:l.buffer}});a&&o.push({binding:o.length,resource:a});let u=n.createBindGroup({layout:e.computePipeline.getBindGroupLayout(0),entries:o,label:e.programInfo.name});if(this.backend.sessionStatus==="capturing"){let l={kernelId:this.backend.currentKernelId,computePipeline:e.computePipeline,bindGroup:u,dispatchGroup:r};this.backend.capturedCommandList.get(this.backend.currentSessionId).push(l)}s.setPipeline(e.computePipeline),s.setBindGroup(0,u),s.dispatchWorkgroups(...r),this.backend.writeTimestamp(this.backend.pendingDispatchNumber*2+1),this.backend.pendingDispatchNumber++,(this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber||this.backend.queryType==="at-passes")&&this.backend.endComputePass(),this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber&&this.backend.flush(),be(e.programInfo.name)}dispose(){}build(e,t){Ie(e.name);let i=this.backend.device,r=[];[{feature:"shader-f16",extension:"f16"},{feature:"subgroups",extension:"subgroups"}].forEach(l=>{i.features.has(l.feature)&&r.push(`enable ${l.extension};`)});let a=Ka(t,this.backend.device.limits),n=e.getShaderSource(a),s=`${r.join(`
`)}
${a.additionalImplementations}
${n}`,o=i.createShaderModule({code:s,label:e.name});j("verbose",()=>`[WebGPU] ${e.name} shader code: ${s}`);let u=i.createComputePipeline({compute:{module:o,entryPoint:"main"},layout:"auto",label:e.name});return be(e.name),{programInfo:e,computePipeline:u,uniformVariablesInfo:a.variablesInfo}}normalizeDispatchGroupSize(e){let t=typeof e=="number"?e:e.x,i=typeof e=="number"?1:e.y||1,r=typeof e=="number"?1:e.z||1,a=this.backend.device.limits.maxComputeWorkgroupsPerDimension;if(t<=a&&i<=a&&r<=a)return[t,i,r];let n=t*i*r,s=Math.ceil(Math.sqrt(n));if(s>a){if(s=Math.ceil(Math.cbrt(n)),s>a)throw new Error("Total dispatch size exceeds WebGPU maximum.");return[s,s,s]}else return[s,s,1]}}}),Ed={};ce(Ed,{WebGpuBackend:()=>Bd});var Cd,Od,Ad,Bd,lc=T(()=>{Te(),N(),Ve(),Ra(),$p(),oc(),uc(),Cd=(e,t)=>{if(t.length!==e.length)throw new Error(`inputDependencies length ${t.length} is not equal to inputTensors length ${e.length}.`);let i=[];for(let r=0;r<e.length;++r){let a=e[r].dataType;switch(t[r]){case"none":{i.push("");break}case"type":{i.push(`${a}`);break}case"rank":{let n=e[r].dims.length;i.push(`${a};${n}`);break}case"dims":{let n=e[r].dims.join(",");i.push(`${a};${n}`);break}default:throw new Error(`unsupported input dependency: ${t[r]}`)}}return i.join("|")},Od=(e,t,i)=>{let r=e.name;return e.shaderCache?.hint&&(r+="["+e.shaderCache.hint+"]"),r+=":"+i+`:${Cd(t,e.shaderCache?.inputDependencies??new Array(t.length).fill("dims"))}`,r},Ad=class{constructor(e){e&&(this.architecture=e.architecture,this.vendor=e.vendor)}isArchitecture(e){return this.architecture===e}isVendor(e){return this.vendor===e}},Bd=class{constructor(){this.currentSessionId=null,this.currentKernelId=null,this.commandEncoder=null,this.computePassEncoder=null,this.maxDispatchNumber=16,this.pendingDispatchNumber=0,this.pendingKernels=[],this.pendingQueries=new Map,this.sessionStatus="default",this.capturedCommandList=new Map,this.capturedPendingKernels=new Map,this.sessionExternalDataMapping=new Map}get currentKernelCustomData(){if(this.currentKernelId===null)throw new Error("currentKernelCustomData(): currentKernelId is null. (should not happen)");let e=this.kernelCustomData.get(this.currentKernelId);return e||(e={},this.kernelCustomData.set(this.currentKernelId,e)),e}async initialize(e,t){this.env=e;let i=[],r={requiredLimits:{maxComputeWorkgroupStorageSize:t.limits.maxComputeWorkgroupStorageSize,maxComputeWorkgroupsPerDimension:t.limits.maxComputeWorkgroupsPerDimension,maxStorageBufferBindingSize:t.limits.maxStorageBufferBindingSize,maxBufferSize:t.limits.maxBufferSize,maxComputeInvocationsPerWorkgroup:t.limits.maxComputeInvocationsPerWorkgroup,maxComputeWorkgroupSizeX:t.limits.maxComputeWorkgroupSizeX,maxComputeWorkgroupSizeY:t.limits.maxComputeWorkgroupSizeY,maxComputeWorkgroupSizeZ:t.limits.maxComputeWorkgroupSizeZ},requiredFeatures:i},a=n=>t.features.has(n)&&i.push(n)&&!0;a("chromium-experimental-timestamp-query-inside-passes")||a("timestamp-query"),a("shader-f16"),a("subgroups"),this.device=await t.requestDevice(r),this.adapterInfo=new Ad(t.info||await t.requestAdapterInfo()),this.gpuDataManager=Ga(this),this.programManager=new zd(this),this.kernels=new Map,this.kernelPersistentData=new Map,this.kernelCustomData=new Map,Si(e.logLevel,!!e.debug),this.device.onuncapturederror=n=>{n.error instanceof GPUValidationError&&console.error(`An uncaught WebGPU validation error was raised: ${n.error.message}`)},Object.defineProperty(this.env.webgpu,"device",{value:this.device,writable:!1,enumerable:!0,configurable:!1}),Object.defineProperty(this.env.webgpu,"adapter",{value:t,writable:!1,enumerable:!0,configurable:!1}),this.setQueryType()}dispose(){typeof this.querySet<"u"&&this.querySet.destroy(),this.gpuDataManager.dispose()}getCommandEncoder(){return this.commandEncoder||(this.commandEncoder=this.device.createCommandEncoder()),this.commandEncoder}getComputePassEncoder(){if(!this.computePassEncoder){let e=this.getCommandEncoder(),t={};this.queryType==="at-passes"&&(t.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:this.pendingDispatchNumber*2,endOfPassWriteIndex:this.pendingDispatchNumber*2+1}),this.computePassEncoder=e.beginComputePass(t)}return this.computePassEncoder}endComputePass(){this.computePassEncoder&&(this.computePassEncoder.end(),this.computePassEncoder=null)}flush(){if(!this.commandEncoder)return;Ie(),this.endComputePass();let e;this.queryType!=="none"&&(this.commandEncoder.resolveQuerySet(this.querySet,0,this.pendingDispatchNumber*2,this.queryResolveBuffer,0),e=this.device.createBuffer({size:this.pendingDispatchNumber*2*8,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST}),this.pendingQueries.set(e,this.pendingKernels),this.pendingKernels=[],this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer,0,e,0,this.pendingDispatchNumber*2*8)),this.device.queue.submit([this.commandEncoder.finish()]),this.gpuDataManager.refreshPendingBuffers(),this.commandEncoder=null,this.pendingDispatchNumber=0,this.queryType!=="none"&&e.mapAsync(GPUMapMode.READ).then(()=>{let t=new BigUint64Array(e.getMappedRange()),i=this.pendingQueries.get(e);for(let r=0;r<t.length/2;r++){let a=i[r],n=a.kernelId,s=this.kernels.get(n),o=s.kernelType,u=s.kernelName,l=a.programName,d=a.inputTensorViews,p=a.outputTensorViews,c=t[r*2],h=t[r*2+1];typeof this.queryTimeBase>"u"&&(this.queryTimeBase=c);let f=Number(c-this.queryTimeBase),g=Number(h-this.queryTimeBase);if(!Number.isSafeInteger(f)||!Number.isSafeInteger(g))throw new RangeError("incorrect timestamp range");if(this.env.webgpu.profiling?.ondata)this.env.webgpu.profiling.ondata({version:1,inputsMetadata:d.map(y=>({dims:y.dims,dataType:Ne(y.dataType)})),outputsMetadata:p.map(y=>({dims:y.dims,dataType:Ne(y.dataType)})),kernelId:n,kernelType:o,kernelName:u,programName:l,startTime:f,endTime:g});else{let y="";d.forEach((m,w)=>{y+=`input[${w}]: [${m.dims}] | ${Ne(m.dataType)}, `});let _="";p.forEach((m,w)=>{_+=`output[${w}]: [${m.dims}] | ${Ne(m.dataType)}, `}),console.log(`[profiling] kernel "${n}|${o}|${u}|${l}" ${y}${_}execution time: ${g-f} ns`)}_t("GPU",`${l}::${c}::${h}`)}e.unmap(),this.pendingQueries.delete(e)}),be()}run(e,t,i,r,a,n){Ie(e.name);let s=[];for(let m=0;m<t.length;++m){let w=t[m].data;if(w===0)continue;let $=this.gpuDataManager.get(w);if(!$)throw new Error(`no GPU data for input: ${w}`);s.push($)}let{outputs:o,dispatchGroup:u,programUniforms:l}=e.getRunData(t),d=i.length===0?o.map((m,w)=>w):i;if(d.length!==o.length)throw new Error(`Output size ${d.length} must be equal to ${o.length}.`);let p=[],c=[];for(let m=0;m<o.length;++m){if(!Number.isInteger(d[m])||d[m]<-3||d[m]>=n)throw new Error(`Invalid output index: ${d[m]}`);if(d[m]===-3)continue;let w=d[m]===-1,$=d[m]===-2,b=w||$?a(o[m].dataType,o[m].dims):r(d[m],o[m].dataType,o[m].dims);if(p.push(b),b.data===0)continue;let x=this.gpuDataManager.get(b.data);if(!x)throw new Error(`no GPU data for output: ${b.data}`);if(w&&this.temporaryData.push(x),$){let v=this.kernelPersistentData.get(this.currentKernelId);v||(v=[],this.kernelPersistentData.set(this.currentKernelId,v)),v.push(x)}c.push(x)}if(s.length!==t.length||c.length!==p.length){if(c.length===0)return be(e.name),p;throw new Error(`Program ${e.name} has zero-sized tensor(s) in inputs or outputs. This is not supported now.`)}let h;if(l){let m=0,w=[];l.forEach(v=>{let I=typeof v.data=="number"?[v.data]:v.data;if(I.length===0)return;let z=v.type===10?2:4,O,V;v.type===10?(V=I.length>4?16:I.length>2?8:I.length*z,O=I.length>4?16:z*I.length):(V=I.length<=2?I.length*z:16,O=16),m=Math.ceil(m/V)*V,w.push(m);let U=v.type===10?8:4;m+=I.length>4?Math.ceil(I.length/U)*O:I.length*z});let $=16;m=Math.ceil(m/$)*$;let b=new ArrayBuffer(m);l.forEach((v,I)=>{let z=w[I],O=typeof v.data=="number"?[v.data]:v.data;if(v.type===6)new Int32Array(b,z,O.length).set(O);else if(v.type===12)new Uint32Array(b,z,O.length).set(O);else if(v.type===10)new Uint16Array(b,z,O.length).set(O);else if(v.type===1)new Float32Array(b,z,O.length).set(O);else throw new Error(`Unsupported uniform type: ${Ne(v.type)}`)});let x=this.gpuDataManager.create(m,GPUBufferUsage.COPY_DST|GPUBufferUsage.UNIFORM);this.device.queue.writeBuffer(x.buffer,0,b,0,m),this.gpuDataManager.release(x.id),h={offset:0,size:m,buffer:x.buffer}}let f=this.programManager.normalizeDispatchGroupSize(u),g=f[1]===1&&f[2]===1,y=Od(e,t,g),_=this.programManager.getArtifact(y);if(_||(_=this.programManager.build(e,f),this.programManager.setArtifact(y,_),j("info",()=>`[artifact] key: ${y}, programName: ${e.name}`)),l&&_.uniformVariablesInfo){if(l.length!==_.uniformVariablesInfo.length)throw new Error(`Uniform variables count mismatch: expect ${_.uniformVariablesInfo.length}, got ${l.length} in program "${_.programInfo.name}".`);for(let m=0;m<l.length;m++){let w=l[m],$=w.type,b=typeof w.data=="number"?1:w.data.length,[x,v]=_.uniformVariablesInfo[m];if($!==x||b!==v)throw new Error(`Uniform variable ${m} mismatch: expect type ${x} with size ${v}, got type ${$} with size ${b} in program "${_.programInfo.name}".`)}}if(j("info",()=>`[ProgramManager] run "${e.name}" (key=${y}) with ${f[0]}x${f[1]}x${f[2]}`),this.queryType!=="none"||this.sessionStatus==="capturing"){let m={kernelId:this.currentKernelId,programName:_.programInfo.name,inputTensorViews:t,outputTensorViews:p};this.pendingKernels.push(m),this.sessionStatus==="capturing"&&this.capturedPendingKernels.get(this.currentSessionId).push(m)}return this.programManager.run(_,s,c,f,h),be(e.name),p}upload(e,t){this.gpuDataManager.upload(e,t)}memcpy(e,t){this.gpuDataManager.memcpy(e,t)}async download(e,t){await this.gpuDataManager.download(e,t)}alloc(e){return this.gpuDataManager.create(e).id}free(e){return this.gpuDataManager.release(e)}createKernel(e,t,i,r){let a=Td.get(e);if(!a)throw new Error(`kernel not implemented: ${e}`);let n={kernelType:e,kernelName:r,kernelEntry:a[0],attributes:[a[1],i]};this.kernels.set(t,n)}releaseKernel(e){let t=this.kernelPersistentData.get(e);if(t){for(let i of t)this.gpuDataManager.release(i.id);this.kernelPersistentData.delete(e)}this.kernelCustomData.delete(e),this.kernels.delete(e)}computeKernel(e,t,i){let r=this.kernels.get(e);if(!r)throw new Error(`kernel not created: ${e}`);let a=r.kernelType,n=r.kernelName,s=r.kernelEntry,o=r.attributes;if(this.currentKernelId!==null)throw new Error(`kernel "[${a}] ${n}" is not allowed to be called recursively`);this.currentKernelId=e,o[0]&&(o[1]=o[0](o[1]),o[0]=void 0),j("info",()=>`[WebGPU] Start to run kernel "[${a}] ${n}"...`);let u=this.env.debug;this.temporaryData=[];try{return u&&this.device.pushErrorScope("validation"),s(t,o[1]),0}catch(l){return i.push(Promise.resolve(`[WebGPU] Kernel "[${a}] ${n}" failed. ${l}`)),1}finally{u&&i.push(this.device.popErrorScope().then(l=>l?`GPU validation error for kernel "[${a}] ${n}": ${l.message}`:null));for(let l of this.temporaryData)this.gpuDataManager.release(l.id);this.temporaryData=[],this.currentKernelId=null}}registerBuffer(e,t,i,r){let a=this.sessionExternalDataMapping.get(e);a||(a=new Map,this.sessionExternalDataMapping.set(e,a));let n=a.get(t),s=this.gpuDataManager.registerExternalBuffer(i,r,n);return a.set(t,[s,i]),s}unregisterBuffers(e){let t=this.sessionExternalDataMapping.get(e);t&&(t.forEach(i=>this.gpuDataManager.unregisterExternalBuffer(i[0])),this.sessionExternalDataMapping.delete(e))}getBuffer(e){let t=this.gpuDataManager.get(e);if(!t)throw new Error(`no GPU data for buffer: ${e}`);return t.buffer}createDownloader(e,t,i){return async()=>{let r=await Ui(this,e,t);return Ii(r.buffer,i)}}writeTimestamp(e){this.queryType==="inside-passes"&&this.computePassEncoder.writeTimestamp(this.querySet,e)}setQueryType(){this.queryType="none",(this.env.webgpu.profiling?.mode==="default"||(typeof this.env.trace>"u"?this.env.wasm.trace:this.env.trace))&&(this.device.features.has("chromium-experimental-timestamp-query-inside-passes")?this.queryType="inside-passes":this.device.features.has("timestamp-query")&&(this.queryType="at-passes"),this.queryType!=="none"&&typeof this.querySet>"u"&&(this.querySet=this.device.createQuerySet({type:"timestamp",count:this.maxDispatchNumber*2}),this.queryResolveBuffer=this.device.createBuffer({size:this.maxDispatchNumber*2*8,usage:GPUBufferUsage.COPY_SRC|GPUBufferUsage.QUERY_RESOLVE})))}captureBegin(){j("info","captureBegin"),this.capturedCommandList.get(this.currentSessionId)||this.capturedCommandList.set(this.currentSessionId,[]),this.capturedPendingKernels.get(this.currentSessionId)||this.capturedPendingKernels.set(this.currentSessionId,[]),this.flush(),this.sessionStatus="capturing"}captureEnd(){j("info","captureEnd"),this.flush(),this.sessionStatus="default"}replay(){j("info","replay"),this.sessionStatus="replaying";let e=this.capturedCommandList.get(this.currentSessionId),t=this.capturedPendingKernels.get(this.currentSessionId),i=e.length;this.pendingKernels=[];for(let r=0;r<i;r++){let a=this.getComputePassEncoder(),n=e[r];this.writeTimestamp(this.pendingDispatchNumber*2),a.setPipeline(n.computePipeline),a.setBindGroup(0,n.bindGroup),a.dispatchWorkgroups(...n.dispatchGroup),this.writeTimestamp(this.pendingDispatchNumber*2+1),this.pendingDispatchNumber++,this.queryType!=="none"&&this.pendingKernels.push(t[r]),(this.pendingDispatchNumber>=this.maxDispatchNumber||this.queryType==="at-passes")&&this.endComputePass(),this.pendingDispatchNumber>=this.maxDispatchNumber&&this.flush()}this.flush(),this.sessionStatus="default"}onCreateSession(){this.gpuDataManager.onCreateSession()}onReleaseSession(e){this.unregisterBuffers(e),this.capturedCommandList.has(e)&&this.capturedCommandList.delete(e),this.capturedPendingKernels.has(e)&&this.capturedPendingKernels.delete(e),this.gpuDataManager.onReleaseSession(e)}onRunStart(e){this.currentSessionId=e,this.setQueryType()}}}),Rd={};ce(Rd,{init:()=>Dd});var Jt,Md,Dd,dc=T(()=>{N(),Ve(),W(),yp(),Jt=class tp{constructor(t,i,r,a){this.module=t,this.dataType=i,this.data=r,this.dims=a}getFloat32Array(){if(this.dataType!==1)throw new Error("Invalid data type");let t=k.size(this.dims);return t===0?new Float32Array:new Float32Array(this.module.HEAP8.buffer,this.data,t)}getBigInt64Array(){if(this.dataType!==7)throw new Error("Invalid data type");let t=k.size(this.dims);return t===0?new BigInt64Array:new BigInt64Array(this.module.HEAP8.buffer,this.data,t)}getInt32Array(){if(this.dataType!==6)throw new Error("Invalid data type");let t=k.size(this.dims);return t===0?new Int32Array:new Int32Array(this.module.HEAP8.buffer,this.data,t)}getUint16Array(){if(this.dataType!==10&&this.dataType!==4)throw new Error("Invalid data type");let t=k.size(this.dims);return t===0?new Uint16Array:new Uint16Array(this.module.HEAP8.buffer,this.data,t)}reshape(t){if(k.size(t)!==k.size(this.dims))throw new Error("Invalid new shape");return new tp(this.module,this.dataType,this.data,t)}},Md=class{constructor(e,t,i){this.module=e,this.backend=t,this.customDataOffset=0,this.customDataSize=0,this.adapterInfo=t.adapterInfo;let r=e.PTR_SIZE,a=i/e.PTR_SIZE,n=r===4?"i32":"i64";this.opKernelContext=Number(e.getValue(r*a++,n));let s=Number(e.getValue(r*a++,n));this.outputCount=Number(e.getValue(r*a++,n)),this.customDataOffset=Number(e.getValue(r*a++,"*")),this.customDataSize=Number(e.getValue(r*a++,n));let o=[];for(let u=0;u<s;u++){let l=Number(e.getValue(r*a++,n)),d=Number(e.getValue(r*a++,"*")),p=Number(e.getValue(r*a++,n)),c=[];for(let h=0;h<p;h++)c.push(Number(e.getValue(r*a++,n)));o.push(new Jt(e,l,d,c))}this.inputs=o}get kernelCustomData(){return this.backend.currentKernelCustomData}get customDataBuffer(){return this.module.HEAPU8.subarray(this.customDataOffset,this.customDataOffset+this.customDataSize)}compute(e,t){let i=t?.inputs?.map(s=>typeof s=="number"?this.inputs[s]:s)??this.inputs,r=t?.outputs??[],a=(s,o,u)=>new Jt(this.module,o,this.output(s,u),u),n=(s,o)=>{let u=tt(s,o);if(!u)throw new Error(`Unsupported data type: ${s}`);let l=u>0?this.backend.gpuDataManager.create(u).id:0;return new Jt(this.module,s,l,o)};return this.backend.run(e,i,r,a,n,this.outputCount)}output(e,t){let i=this.module.stackSave();try{let r=this.module.PTR_SIZE,a=r===4?"i32":"i64",n=this.module.stackAlloc((1+t.length)*r);this.module.setValue(n,t.length,a);for(let s=0;s<t.length;s++)this.module.setValue(n+r*(s+1),t[s],a);return this.module._JsepOutput(this.opKernelContext,e,n)}catch(r){throw new Error(`Failed to generate kernel's output[${e}] with dims [${t}]. If you are running with pre-allocated output, please make sure the output type/dims are correct. Error: ${r}`)}finally{this.module.stackRestore(i)}}},Dd=async(e,t,i,r)=>{let a=t.jsepInit;if(!a)throw new Error("Failed to initialize JSEP. The WebAssembly module is not built with JSEP support.");if(e==="webgpu"){let n=(lc(),oe(Ed)).WebGpuBackend,s=new n;await s.initialize(i,r),a("webgpu",[s,o=>s.alloc(Number(o)),o=>s.free(o),(o,u,l,d=!1)=>{if(d)j("verbose",()=>`[WebGPU] jsepCopyGpuToGpu: src=${Number(o)}, dst=${Number(u)}, size=${Number(l)}`),s.memcpy(Number(o),Number(u));else{j("verbose",()=>`[WebGPU] jsepCopyCpuToGpu: dataOffset=${Number(o)}, gpuDataId=${Number(u)}, size=${Number(l)}`);let p=t.HEAPU8.subarray(Number(o>>>0),Number(o>>>0)+Number(l));s.upload(Number(u),p)}},async(o,u,l)=>{j("verbose",()=>`[WebGPU] jsepCopyGpuToCpu: gpuDataId=${o}, dataOffset=${u}, size=${l}`),await s.download(Number(o),()=>t.HEAPU8.subarray(Number(u)>>>0,Number(u+l)>>>0))},(o,u,l)=>s.createKernel(o,Number(u),l,t.UTF8ToString(t._JsepGetNodeName(Number(u)))),o=>s.releaseKernel(o),(o,u,l,d)=>{j("verbose",()=>`[WebGPU] jsepRun: sessionHandle=${l}, kernel=${o}, contextDataOffset=${u}`);let p=new Md(t,s,Number(u));return s.computeKernel(Number(o),p,d)},()=>s.captureBegin(),()=>s.captureEnd(),()=>s.replay()])}else{let n=new Na(i);a("webnn",[n,()=>n.reserveTensorId(),s=>n.releaseTensorId(s),async(s,o,u,l,d)=>n.ensureTensor(s,o,u,l,d),(s,o)=>{n.uploadTensor(s,o)},async(s,o)=>n.downloadTensor(s,o)])}}}),Ud,Ar,Br,Ke,Pd,Rr,ei,Mr,Dr,Ur,Pr,qr,Nr,qd=T(()=>{mp(),gp(),N(),Je(),wi(),ka(),Ud=(e,t)=>{ee()._OrtInit(e,t)!==0&&X("Can't initialize onnxruntime.")},Ar=async e=>{Ud(e.wasm.numThreads,Nt(e.logLevel))},Br=async(e,t)=>{ee().asyncInit?.();{let i=(dc(),oe(Rd)).init;if(t==="webgpu"){if(typeof navigator>"u"||!navigator.gpu)throw new Error("WebGPU is not supported in current environment");let r=e.webgpu.adapter;if(r){if(typeof r.limits!="object"||typeof r.features!="object"||typeof r.requestDevice!="function")throw new Error("Invalid GPU adapter set in `env.webgpu.adapter`. It must be a GPUAdapter object.")}else{let a=e.webgpu.powerPreference;if(a!==void 0&&a!=="low-power"&&a!=="high-performance")throw new Error(`Invalid powerPreference setting: "${a}"`);let n=e.webgpu.forceFallbackAdapter;if(n!==void 0&&typeof n!="boolean")throw new Error(`Invalid forceFallbackAdapter setting: "${n}"`);if(r=await navigator.gpu.requestAdapter({powerPreference:a,forceFallbackAdapter:n}),!r)throw new Error('Failed to get GPU adapter. You may need to enable flag "--enable-unsafe-webgpu" if you are using Chrome.')}await i("webgpu",ee(),e,r)}if(t==="webnn"){if(typeof navigator>"u"||!navigator.ml)throw new Error("WebNN is not supported in current environment");await i("webnn",ee(),e)}}},Ke=new Map,Pd=e=>{let t=ee(),i=t.stackSave();try{let r=t.PTR_SIZE,a=t.stackAlloc(2*r);t._OrtGetInputOutputCount(e,a,a+r)!==0&&X("Can't get session input/output count.");let n=r===4?"i32":"i64";return[Number(t.getValue(a,n)),Number(t.getValue(a+r,n))]}finally{t.stackRestore(i)}},Rr=(e,t)=>{let i=ee(),r=i.stackSave(),a=0;try{let n=i.PTR_SIZE,s=i.stackAlloc(2*n);i._OrtGetInputOutputMetadata(e,t,s,s+n)!==0&&X("Can't get session input/output metadata.");let o=Number(i.getValue(s,"*"));a=Number(i.getValue(s+n,"*"));let u=i.HEAP32[a/4];if(u===0)return[o,0];let l=i.HEAPU32[a/4+1],d=[];for(let p=0;p<l;p++){let c=Number(i.getValue(a+8+p*n,"*"));d.push(c!==0?i.UTF8ToString(c):Number(i.getValue(a+8+(p+l)*n,"*")))}return[o,u,d]}finally{i.stackRestore(r),a!==0&&i._OrtFree(a)}},ei=e=>{let t=ee(),i=t._malloc(e.byteLength);if(i===0)throw new Error(`Can't create a session. failed to allocate a buffer of size ${e.byteLength}.`);return t.HEAPU8.set(e,i),[i,e.byteLength]},Mr=async(e,t)=>{let i,r,a=ee();Array.isArray(e)?[i,r]=e:e.buffer===a.HEAPU8.buffer?[i,r]=[e.byteOffset,e.byteLength]:[i,r]=ei(e);let n=0,s=0,o=0,u=[],l=[],d=[];try{if([s,u]=await xa(t),t?.externalData&&a.mountExternalData){let $=[];for(let b of t.externalData){let x=typeof b=="string"?b:b.path;$.push(ki(typeof b=="string"?b:b.data).then(v=>{a.mountExternalData(x,v)}))}await Promise.all($)}for(let $ of t?.executionProviders??[])if((typeof $=="string"?$:$.name)==="webnn"){if(a.shouldTransferToMLTensor=!1,typeof $!="string"){let b=$,x=b?.context,v=b?.gpuDevice,I=b?.deviceType,z=b?.powerPreference;x?a.currentContext=x:v?a.currentContext=await a.webnnCreateMLContext(v):a.currentContext=await a.webnnCreateMLContext({deviceType:I,powerPreference:z})}else a.currentContext=await a.webnnCreateMLContext();break}n=await a._OrtCreateSession(i,r,s),a.webgpuOnCreateSession?.(n),n===0&&X("Can't create a session."),a.jsepOnCreateSession?.(),a.currentContext&&(a.webnnRegisterMLContext(n,a.currentContext),a.currentContext=void 0,a.shouldTransferToMLTensor=!0);let[p,c]=Pd(n),h=!!t?.enableGraphCapture,f=[],g=[],y=[],_=[],m=[];for(let $=0;$<p;$++){let[b,x,v]=Rr(n,$);b===0&&X("Can't get an input name."),l.push(b);let I=a.UTF8ToString(b);f.push(I),y.push(x===0?{name:I,isTensor:!1}:{name:I,isTensor:!0,type:Ne(x),shape:v})}for(let $=0;$<c;$++){let[b,x,v]=Rr(n,$+p);b===0&&X("Can't get an output name."),d.push(b);let I=a.UTF8ToString(b);g.push(I),_.push(x===0?{name:I,isTensor:!1}:{name:I,isTensor:!0,type:Ne(x),shape:v});{if(h&&t?.preferredOutputLocation===void 0){m.push("gpu-buffer");continue}let z=typeof t?.preferredOutputLocation=="string"?t.preferredOutputLocation:t?.preferredOutputLocation?.[I]??"cpu",O=a.webnnIsGraphOutput;if(z==="cpu"&&O&&O(n,I)){m.push("ml-tensor-cpu-output");continue}if(z!=="cpu"&&z!=="cpu-pinned"&&z!=="gpu-buffer"&&z!=="ml-tensor")throw new Error(`Not supported preferred output location: ${z}.`);if(h&&z!=="gpu-buffer")throw new Error(`Not supported preferred output location: ${z}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`);m.push(z)}}let w=null;return m.some($=>$==="gpu-buffer"||$==="ml-tensor"||$==="ml-tensor-cpu-output")&&(o=a._OrtCreateBinding(n),o===0&&X("Can't create IO binding."),w={handle:o,outputPreferredLocations:m,outputPreferredLocationsEncoded:m.map($=>$==="ml-tensor-cpu-output"?"ml-tensor":$).map($=>xi($))}),Ke.set(n,[n,l,d,w,h,!1]),[n,f,g,y,_]}catch(p){throw l.forEach(c=>a._OrtFree(c)),d.forEach(c=>a._OrtFree(c)),o!==0&&a._OrtReleaseBinding(o)!==0&&X("Can't release IO binding."),n!==0&&a._OrtReleaseSession(n)!==0&&X("Can't release session."),p}finally{a._free(i),s!==0&&a._OrtReleaseSessionOptions(s)!==0&&X("Can't release session options."),u.forEach(p=>a._free(p)),a.unmountExternalData?.()}},Dr=e=>{let t=ee(),i=Ke.get(e);if(!i)throw new Error(`cannot release session. invalid session id: ${e}`);let[r,a,n,s,o]=i;s&&(o&&t._OrtClearBoundOutputs(s.handle)!==0&&X("Can't clear bound outputs."),t._OrtReleaseBinding(s.handle)!==0&&X("Can't release IO binding.")),t.jsepOnReleaseSession?.(e),t.webnnOnReleaseSession?.(e),t.webgpuOnReleaseSession?.(e),a.forEach(u=>t._OrtFree(u)),n.forEach(u=>t._OrtFree(u)),t._OrtReleaseSession(r)!==0&&X("Can't release session."),Ke.delete(e)},Ur=async(e,t,i,r,a,n,s=!1)=>{if(!e){t.push(0);return}let o=ee(),u=o.PTR_SIZE,l=e[0],d=e[1],p=e[3],c=p,h,f;if(l==="string"&&(p==="gpu-buffer"||p==="ml-tensor"))throw new Error("String tensor is not supported on GPU.");if(s&&p!=="gpu-buffer")throw new Error(`External buffer must be provided for input/output index ${n} when enableGraphCapture is true.`);if(p==="gpu-buffer"){let _=e[2].gpuBuffer;f=tt(et(l),d);{let m=o.jsepRegisterBuffer;if(!m)throw new Error('Tensor location "gpu-buffer" is not supported without using WebGPU.');h=m(r,n,_,f)}}else if(p==="ml-tensor"){let _=e[2].mlTensor;f=tt(et(l),d);let m=o.webnnRegisterMLTensor;if(!m)throw new Error('Tensor location "ml-tensor" is not supported without using WebNN.');h=m(r,_,et(l),d)}else{let _=e[2];if(Array.isArray(_)){f=u*_.length,h=o._malloc(f),i.push(h);for(let m=0;m<_.length;m++){if(typeof _[m]!="string")throw new TypeError(`tensor data at index ${m} is not a string`);o.setValue(h+m*u,ze(_[m],i),"*")}}else{let m=o.webnnIsGraphInput,w=o.webnnIsGraphOutput;if(l!=="string"&&m&&w){let $=o.UTF8ToString(a);if(m(r,$)||w(r,$)){let b=et(l);f=tt(b,d),c="ml-tensor";let x=o.webnnCreateTemporaryTensor,v=o.webnnUploadTensor;if(!x||!v)throw new Error('Tensor location "ml-tensor" is not supported without using WebNN.');let I=await x(r,b,d);v(I,new Uint8Array(_.buffer,_.byteOffset,_.byteLength)),h=I}else f=_.byteLength,h=o._malloc(f),i.push(h),o.HEAPU8.set(new Uint8Array(_.buffer,_.byteOffset,f),h)}else f=_.byteLength,h=o._malloc(f),i.push(h),o.HEAPU8.set(new Uint8Array(_.buffer,_.byteOffset,f),h)}}let g=o.stackSave(),y=o.stackAlloc(4*d.length);try{d.forEach((m,w)=>o.setValue(y+w*u,m,u===4?"i32":"i64"));let _=o._OrtCreateTensor(et(l),h,f,y,d.length,xi(c));_===0&&X(`Can't create tensor for input/output. session=${r}, index=${n}.`),t.push(_)}finally{o.stackRestore(g)}},Pr=async(e,t,i,r,a,n)=>{let s=ee(),o=s.PTR_SIZE,u=Ke.get(e);if(!u)throw new Error(`cannot run inference. invalid session id: ${e}`);let l=u[0],d=u[1],p=u[2],c=u[3],h=u[4],f=u[5],g=t.length,y=r.length,_=0,m=[],w=[],$=[],b=[],x=s.stackSave(),v=s.stackAlloc(g*o),I=s.stackAlloc(g*o),z=s.stackAlloc(y*o),O=s.stackAlloc(y*o);try{[_,m]=ya(n);for(let A=0;A<g;A++)await Ur(i[A],w,b,e,d[t[A]],t[A],h);for(let A=0;A<y;A++)await Ur(a[A],$,b,e,p[r[A]],g+r[A],h);for(let A=0;A<g;A++)s.setValue(v+A*o,w[A],"*"),s.setValue(I+A*o,d[t[A]],"*");for(let A=0;A<y;A++)s.setValue(z+A*o,$[A],"*"),s.setValue(O+A*o,p[r[A]],"*");if(c&&!f){let{handle:A,outputPreferredLocations:F,outputPreferredLocationsEncoded:q}=c;if(d.length!==g)throw new Error(`input count from feeds (${g}) is expected to be always equal to model's input count (${d.length}).`);for(let M=0;M<g;M++){let Z=t[M];await s._OrtBindInput(A,d[Z],w[M])!==0&&X(`Can't bind input[${M}] for session=${e}.`)}for(let M=0;M<y;M++){let Z=r[M];a[M]?.[3]?s._OrtBindOutput(A,p[Z],$[M],0)!==0&&X(`Can't bind pre-allocated output[${M}] for session=${e}.`):s._OrtBindOutput(A,p[Z],0,q[Z])!==0&&X(`Can't bind output[${M}] to ${F[M]} for session=${e}.`)}Ke.set(e,[l,d,p,c,h,!0])}s.jsepOnRunStart?.(l),s.webnnOnRunStart?.(l);let V;c?V=await s._OrtRunWithBinding(l,c.handle,y,z,_):V=await s._OrtRun(l,I,v,g,O,y,z,_),V!==0&&X("failed to call OrtRun().");let U=[],L=[];for(let A=0;A<y;A++){let F=Number(s.getValue(z+A*o,"*"));if(F===$[A]){U.push(a[A]);continue}let q=s.stackSave(),M=s.stackAlloc(4*o),Z=!1,P,te=0;try{s._OrtGetTensorData(F,M,M+o,M+2*o,M+3*o)!==0&&X(`Can't access output tensor data on index ${A}.`);let E=o===4?"i32":"i64",C=Number(s.getValue(M,E));te=s.getValue(M+o,"*");let H=s.getValue(M+o*2,"*"),Y=Number(s.getValue(M+o*3,E)),de=[];for(let pe=0;pe<Y;pe++)de.push(Number(s.getValue(H+pe*o,E)));s._OrtFree(H)!==0&&X("Can't free memory for tensor dims.");let Pe=de.reduce((pe,ne)=>pe*ne,1);P=Ne(C);let At=c?.outputPreferredLocations[r[A]];if(P==="string"){if(At==="gpu-buffer"||At==="ml-tensor")throw new Error("String tensor is not supported on GPU.");let pe=[];for(let ne=0;ne<Pe;ne++){let We=s.getValue(te+ne*o,"*"),mc=s.getValue(te+(ne+1)*o,"*"),gc=ne===Pe-1?void 0:mc-We;pe.push(s.UTF8ToString(We,gc))}U.push([P,de,pe,"cpu"])}else if(At==="gpu-buffer"&&Pe>0){let pe=s.jsepGetBuffer;if(!pe)throw new Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');let ne=pe(te),We=tt(C,Pe);if(We===void 0||!bi(P))throw new Error(`Unsupported data type: ${P}`);Z=!0,U.push([P,de,{gpuBuffer:ne,download:s.jsepCreateDownloader(ne,We,P),dispose:()=>{s._OrtReleaseTensor(F)!==0&&X("Can't release tensor.")}},"gpu-buffer"])}else if(At==="ml-tensor"&&Pe>0){let pe=s.webnnEnsureTensor,ne=s.webnnIsGraphInputOutputTypeSupported;if(!pe||!ne)throw new Error('preferredLocation "ml-tensor" is not supported without using WebNN.');if(tt(C,Pe)===void 0||!vi(P))throw new Error(`Unsupported data type: ${P}`);if(!ne(e,P,!1))throw new Error(`preferredLocation "ml-tensor" for ${P} output is not supported by current WebNN Context.`);let We=await pe(e,te,C,de,!1);Z=!0,U.push([P,de,{mlTensor:We,download:s.webnnCreateMLTensorDownloader(te,P),dispose:()=>{s.webnnReleaseTensorId(te),s._OrtReleaseTensor(F)}},"ml-tensor"])}else if(At==="ml-tensor-cpu-output"&&Pe>0){let pe=s.webnnCreateMLTensorDownloader(te,P)(),ne=U.length;Z=!0,L.push((async()=>{let We=[ne,await pe];return s.webnnReleaseTensorId(te),s._OrtReleaseTensor(F),We})()),U.push([P,de,[],"cpu"])}else{let pe=qt(P),ne=new pe(Pe);new Uint8Array(ne.buffer,ne.byteOffset,ne.byteLength).set(s.HEAPU8.subarray(te,te+ne.byteLength)),U.push([P,de,ne,"cpu"])}}finally{s.stackRestore(q),P==="string"&&te&&s._free(te),Z||s._OrtReleaseTensor(F)}}c&&!h&&(s._OrtClearBoundOutputs(c.handle)!==0&&X("Can't clear bound outputs."),Ke.set(e,[l,d,p,c,h,!1]));for(let[A,F]of await Promise.all(L))U[A][2]=F;return U}finally{s.webnnOnRunEnd?.(l),s.stackRestore(x),w.forEach(V=>s._OrtReleaseTensor(V)),$.forEach(V=>s._OrtReleaseTensor(V)),b.forEach(V=>s._free(V)),_!==0&&s._OrtReleaseRunOptions(_),m.forEach(V=>s._free(V))}},qr=e=>{let t=ee(),i=Ke.get(e);if(!i)throw new Error("invalid session id");let r=i[0],a=t._OrtEndProfiling(r);a===0&&X("Can't get an profile file name."),t._OrtFree(a)},Nr=e=>{let t=[];for(let i of e){let r=i[2];!Array.isArray(r)&&"buffer"in r&&t.push(r.buffer)}return t}}),Ze,ve,ft,Ct,Ot,ti,Vr,ii,ut,lt,Nd,Vd,Ld,Wd,Gd,Hd,Fd,jd,Kd=T(()=>{Te(),qd(),Je(),gi(),Ze=()=>!!J.wasm.proxy&&typeof document<"u",ft=!1,Ct=!1,Ot=!1,ii=new Map,ut=(e,t)=>{let i=ii.get(e);i?i.push(t):ii.set(e,[t])},lt=()=>{if(ft||!Ct||Ot||!ve)throw new Error("worker not ready")},Nd=e=>{switch(e.data.type){case"init-wasm":ft=!1,e.data.err?(Ot=!0,Vr[1](e.data.err)):(Ct=!0,Vr[0]()),ti&&(URL.revokeObjectURL(ti),ti=void 0);break;case"init-ep":case"copy-from":case"create":case"release":case"run":case"end-profiling":{let t=ii.get(e.data.type);e.data.err?t.shift()[1](e.data.err):t.shift()[0](e.data.out);break}}},Vd=async()=>{if(!Ct){if(ft)throw new Error("multiple calls to 'initWasm()' detected.");if(Ot)throw new Error("previous call to 'initWasm()' failed.");if(ft=!0,Ze())return new Promise((e,t)=>{ve?.terminate(),ha().then(([i,r])=>{try{ve=r,ve.onerror=n=>t(n),ve.onmessage=Nd,Vr=[e,t];let a={type:"init-wasm",in:J};if(!a.in.wasm.wasmPaths&&i){let n=ci();n&&(a.in.wasm.wasmPaths=n)}ve.postMessage(a),ti=i}catch(a){t(a)}},t)});try{await $i(J.wasm),await Ar(J),Ct=!0}catch(e){throw Ot=!0,e}finally{ft=!1}}},Ld=async e=>{if(Ze())return lt(),new Promise((t,i)=>{ut("init-ep",[t,i]);let r={type:"init-ep",in:{epName:e,env:J}};ve.postMessage(r)});await Br(J,e)},Wd=async e=>Ze()?(lt(),new Promise((t,i)=>{ut("copy-from",[t,i]);let r={type:"copy-from",in:{buffer:e}};ve.postMessage(r,[e.buffer])})):ei(e),Gd=async(e,t)=>{if(Ze()){if(t?.preferredOutputLocation)throw new Error('session option "preferredOutputLocation" is not supported for proxy.');return lt(),new Promise((i,r)=>{ut("create",[i,r]);let a={type:"create",in:{model:e,options:{...t}}},n=[];e instanceof Uint8Array&&n.push(e.buffer),ve.postMessage(a,n)})}else return Mr(e,t)},Hd=async e=>{if(Ze())return lt(),new Promise((t,i)=>{ut("release",[t,i]);let r={type:"release",in:e};ve.postMessage(r)});Dr(e)},Fd=async(e,t,i,r,a,n)=>{if(Ze()){if(i.some(s=>s[3]!=="cpu"))throw new Error("input tensor on GPU is not supported for proxy.");if(a.some(s=>s))throw new Error("pre-allocated output tensor is not supported for proxy.");return lt(),new Promise((s,o)=>{ut("run",[s,o]);let u=i,l={type:"run",in:{sessionId:e,inputIndices:t,inputs:u,outputIndices:r,options:n}};ve.postMessage(l,Nr(u))})}else return Pr(e,t,i,r,a,n)},jd=async e=>{if(Ze())return lt(),new Promise((t,i)=>{ut("end-profiling",[t,i]);let r={type:"end-profiling",in:e};ve.postMessage(r)});qr(e)}}),Lr,Zd,Qd,pc=T(()=>{Te(),Kd(),N(),li(),ka(),Lr=(e,t)=>{switch(e.location){case"cpu":return[e.type,e.dims,e.data,"cpu"];case"gpu-buffer":return[e.type,e.dims,{gpuBuffer:e.gpuBuffer},"gpu-buffer"];case"ml-tensor":return[e.type,e.dims,{mlTensor:e.mlTensor},"ml-tensor"];default:throw new Error(`invalid data location: ${e.location} for ${t()}`)}},Zd=e=>{switch(e[3]){case"cpu":return new Se(e[0],e[2],e[1]);case"gpu-buffer":{let t=e[0];if(!bi(t))throw new Error(`not supported data type: ${t} for deserializing GPU tensor`);let{gpuBuffer:i,download:r,dispose:a}=e[2];return Se.fromGpuBuffer(i,{dataType:t,dims:e[1],download:r,dispose:a})}case"ml-tensor":{let t=e[0];if(!vi(t))throw new Error(`not supported data type: ${t} for deserializing MLTensor tensor`);let{mlTensor:i,download:r,dispose:a}=e[2];return Se.fromMLTensor(i,{dataType:t,dims:e[1],download:r,dispose:a})}default:throw new Error(`invalid data location: ${e[3]}`)}},Qd=class{async fetchModelAndCopyToWasmMemory(e){return Wd(await ki(e))}async loadModel(e,t){Ie();let i;typeof e=="string"?i=await this.fetchModelAndCopyToWasmMemory(e):i=e,[this.sessionId,this.inputNames,this.outputNames,this.inputMetadata,this.outputMetadata]=await Gd(i,t),be()}async dispose(){return Hd(this.sessionId)}async run(e,t,i){Ie();let r=[],a=[];Object.entries(e).forEach(p=>{let c=p[0],h=p[1],f=this.inputNames.indexOf(c);if(f===-1)throw new Error(`invalid input '${c}'`);r.push(h),a.push(f)});let n=[],s=[];Object.entries(t).forEach(p=>{let c=p[0],h=p[1],f=this.outputNames.indexOf(c);if(f===-1)throw new Error(`invalid output '${c}'`);n.push(h),s.push(f)});let o=r.map((p,c)=>Lr(p,()=>`input "${this.inputNames[a[c]]}"`)),u=n.map((p,c)=>p?Lr(p,()=>`output "${this.outputNames[s[c]]}"`):null),l=await Fd(this.sessionId,a,o,s,u,i),d={};for(let p=0;p<l.length;p++)d[this.outputNames[s[p]]]=n[p]??Zd(l[p]);return be(),d}startProfiling(){}endProfiling(){jd(this.sessionId)}}}),Xd={};ce(Xd,{OnnxruntimeWebAssemblyBackend:()=>Gr,initializeFlags:()=>Wr,wasmBackend:()=>Yd});var Wr,Gr,Yd,cc=T(()=>{Te(),Kd(),pc(),Wr=()=>{(typeof J.wasm.initTimeout!="number"||J.wasm.initTimeout<0)&&(J.wasm.initTimeout=0);let e=J.wasm.simd;if(typeof e!="boolean"&&e!==void 0&&e!=="fixed"&&e!=="relaxed"&&(console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`),J.wasm.simd=!1),typeof J.wasm.proxy!="boolean"&&(J.wasm.proxy=!1),typeof J.wasm.trace!="boolean"&&(J.wasm.trace=!1),typeof J.wasm.numThreads!="number"||!Number.isInteger(J.wasm.numThreads)||J.wasm.numThreads<=0)if(typeof self<"u"&&!self.crossOriginIsolated)J.wasm.numThreads=1;else{let t=typeof navigator>"u"?ie("node:os").cpus().length:navigator.hardwareConcurrency;J.wasm.numThreads=Math.min(4,Math.ceil((t||1)/2))}},Gr=class{async init(e){Wr(),await Vd(),await Ld(e)}async createInferenceSessionHandler(e,t){let i=new Qd;return await i.loadModel(e,t),i}},Yd=new Gr}),Jd={};ce(Jd,{InferenceSession:()=>ui,TRACE:()=>_t,TRACE_FUNC_BEGIN:()=>Ie,TRACE_FUNC_END:()=>be,Tensor:()=>Se,default:()=>fc,env:()=>J,registerBackend:()=>fe}),Te(),Te(),Te();var hc="1.22.0",fc=na;{let e=(cc(),oe(Xd)).wasmBackend;fe("webgpu",e,5),fe("webnn",e,5),fe("cpu",e,10),fe("wasm",e,10)}return Object.defineProperty(J.versions,"web",{value:hc,enumerable:!0}),oe(Jd)})();/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */typeof ip=="object"&&typeof Hr=="object"&&(Hr.exports=ai);console.log("wow3");ai.env.wasm.numThreads=4;self.onmessage=async qe=>{const{type:ge,userImageBuffer:Re,topoImageBuffer:mt}=qe.data;if(ge==="createSession")try{console.log("🚀 [InferenceWorker] Starting session creation...");const ie=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent);let T=null,ce=!0;if(performance.memory){T=performance.memory.jsHeapSizeLimit;const dt=performance.memory.usedJSHeapSize,ke=T-dt,ue=(ke/1024/1024).toFixed(0),He=ie?300:700;if(console.log("💾 [InferenceWorker] Memory check:"),console.log(`   Free: ${ue} MB`),console.log(`   Required: ${He} MB`),ke<He*1024*1024)throw ce=!1,new Error(`Insufficient memory: Only ${ue} MB available, need at least ${He} MB. Please close other tabs/apps and try again, or use a device with more RAM.`)}else{if(console.warn("⚠️ [InferenceWorker] Cannot check available memory (Safari limitation)"),ie&&navigator.deviceMemory!==void 0&&navigator.deviceMemory<4)throw console.error(`⚠️ [InferenceWorker] Device has ${navigator.deviceMemory} GB RAM - may be insufficient`),ce=!1,new Error(`This device has only ${navigator.deviceMemory} GB RAM. Video analysis requires at least 4GB RAM. Please try on a more powerful device.`);console.log("⚠️ [InferenceWorker] Proceeding without memory check - may fail on low-memory devices")}const xe=performance.now(),oe=navigator.hardwareConcurrency||4,he=Math.max(1,Math.min(4,oe-2));console.log(`🧵 [InferenceWorker] Using ${he} threads (hardware: ${navigator.hardwareConcurrency||4}, reserved: 2)`),console.log("📥 [InferenceWorker] Starting model download and WASM initialization..."),console.log("   Model: superpoint_lightglue_pipeline.ort.onnx"),console.log("   This may take 1-2 minutes on first load (model needs to download)");const fe=(()=>{const ke=navigator.userAgent.match(/OS (\d+)_/);return ke?parseInt(ke[1],10)<=15:!1})(),Ge=!fe;fe&&console.log("⚠️ [InferenceWorker] iOS 15 or below detected - disabling SIMD");const De={executionProviders:["wasm"],graphOptimizationLevel:"basic",enableMemPattern:!1,enableCpuMemArena:!1,wasm:{numThreads:he,simd:Ge,threads:he>1}};console.log("⚙️ [InferenceWorker] Session config:",{threads:he,optimization:De.graphOptimizationLevel,memPattern:De.enableMemPattern,cpuArena:De.enableCpuMemArena});const Qe="/superpoint_lightglue_pipeline.ort.onnx";console.log(`📂 [InferenceWorker] Loading model from: ${Qe}`);const Rt=await ai.InferenceSession.create(Qe,De),Xe=performance.now();console.log(`✅ [InferenceWorker] Session created successfully in ${((Xe-xe)/1e3).toFixed(2)}s`),self.session=Rt,self.postMessage({type:"sessionCreated",data:{sessionTime:Xe-xe}})}catch(ie){console.error("❌ [InferenceWorker] Session creation failed:",ie),console.error("   Error details:",{message:ie.message,stack:ie.stack,name:ie.name});let T=ie.message;(ie.message.includes("Out of memory")||ie.message.includes("RangeError")||ie.message.includes("Insufficient memory"))&&(ie.message.includes("Insufficient memory")?T=ie.message:T="Device ran out of memory loading AI model. Try closing other apps/tabs and reloading the page.",console.error("💡 [InferenceWorker] Out of memory - Recovery steps:"),console.error("   1. Close ALL other browser tabs (each tab uses memory)"),console.error("   2. Close background apps (check task switcher)"),console.error("   3. Restart Safari/Browser completely"),console.error("   4. If still failing: Device has insufficient RAM for this feature"),console.error("   Note: This device may not support video analysis due to memory constraints")),self.postMessage({type:"error",data:{message:T}})}if(ge==="runInference"){if(!self.session){self.postMessage({type:"error",data:{message:"Session is not initialized."}});return}let ie=null,T=null,ce=null,xe=null;try{if(!Re||!mt){self.postMessage({type:"error",data:{message:"Both user and topo images must be provided."}});return}ce=new Blob([Re]),ie=await createImageBitmap(ce),xe=new Blob([mt]),T=await createImageBitmap(xe);const oe=[ie,T],Me={width:ie.width,height:ie.height},he={width:T.width,height:T.height},fe=256,Ge=256,De=oe.map((He,J)=>yc(He,fe,Ge,J)),Qe=new Float32Array([...De[0],...De[1]]),Xe={images:new ai.Tensor("float32",Qe,[2,1,Ge,fe])},dt=performance.now(),ke=await self.session.run(Xe),ue=performance.now();self.postMessage({type:"inferenceComplete",data:{inferenceTime:ue-dt,results:ke,imgWidth:fe,imgHeight:Ge,userImageDims:Me,topoImageDims:he}})}catch(oe){self.postMessage({type:"error",data:{message:oe.message}})}finally{ie&&typeof ie.close=="function"&&ie.close(),T&&typeof T.close=="function"&&T.close(),ie=null,T=null,ce=null,xe=null}}};function yc(qe,ge,Re,mt){const T=new OffscreenCanvas(ge,Re).getContext("2d",{willReadFrequently:!0});T.drawImage(qe,0,0,ge,Re);const ce=T.getImageData(0,0,ge,Re).data,xe=new Float32Array(ge*Re);for(let oe=0;oe<ge*Re;oe++){const Me=ce[oe*4]/255,he=ce[oe*4+1]/255,fe=ce[oe*4+2]/255;xe[oe]=.299*Me+.587*he+.114*fe}return xe}});export default $c();
