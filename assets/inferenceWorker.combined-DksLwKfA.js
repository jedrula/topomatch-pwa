...
}`;return{name:e,shaderCache:{hint:`${t};${h}`,inputDependencies:["type"]},getShaderSource:f,getRunData:()=>({outputs:[{dims:n,dataType:a}],dispatchGroup:{x:u},programUniforms:[{type:12,data:l}]})}},Te=(e,t,i,r)=>{let a=e.inputs.length===1?i:Ni(e.inputs,i),n=a.axes;n.length===0&&!a.noopWithEmptyAxes&&(n=e.inputs[0].dims.map((c,f)=>f));let s=k.normalizeAxes(n,e.inputs[0].dims.length),o=s,u=e.inputs[0],l=pn(o,e.inputs[0].dims.length);l.length>0&&(u=e.compute($e(e.inputs[0],l),{inputs:[0],outputs:[-1]})[0],o=on(o.length,u.dims.length));let[d,p]=un(u.dims,o),h=d;a.keepDims&&(h=ln(d,s)),e.compute(hn(t,a.cacheKey,[u],r,e.inputs[0].dataType,h,p),{inputs:[u]})},cn=(e,t)=>{Te(e,"ReduceMeanShared",t,"mean")},fn=(e,t)=>{Te(e,"ReduceL1Shared",t,"l1")},mn=(e,t)=>{Te(e,"ReduceL2Shared",t,"l2")},gn=(e,t)=>{Te(e,"ReduceLogSumExpShared",t,"logSumExp")},_n=(e,t)=>{Te(e,"ReduceMaxShared",t,"max")},yn=(e,t)=>{Te(e,"ReduceMinShared",t,"min")},$n=(e,t)=>{Te(e,"ReduceProdShared",t,"prod")},wn=(e,t)=>{Te(e,"ReduceSumShared",t,"sum")},bn=(e,t)=>{Te(e,"ReduceSumSquareShared",t,"sumSquare")},vn=(e,t)=>{Te(e,"ReduceLogSumShared",t,"logSum")}}),ze,xn,Wt,Ni,Ee,kn,Sn,In,Tn,zn,En,Cn,On,An,Bn,Ce,Rn,Dn,Mn,Un,Pn,qn,Nn,Vn,Ln,Wn,Vi=T(()=>{N(),W(),re(),G(),wp(),ze=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},xn=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Wt=(e,t,i,r,a,n,s=!1,o=!1)=>{let u=[],l=i[0].dims,d=l.length,p=k.normalizeAxes(a,d),h=!o&&p.length===0;l.forEach((g,y)=>{h||p.indexOf(y)>=0?s&&u.push(1):u.push(g)});let c=u.length,f=k.size(u);return{name:e,shaderCache:t,getShaderSource:g=>{let y=[],_=S("_A",i[0].dataType,d),m=B("output",n,c),w=r(_,m,p),$=w[2];for(let b=0,x=0;b<d;b++)h||p.indexOf(b)>=0?(s&&x++,$=`for(var j${b}: u32 = 0; j${b} < ${l[b]}; j${b}++) {
...
`)}
}`},getRunData:()=>({outputs:[{dims:u,dataType:n}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:[{type:12,data:f},...M(l,u)]})}},Ni=(e,t)=>{let i=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(r=>i.push(Number(r))),Q({axes:i,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},Ee=(e,t,i,r)=>{let a=e.inputs,n=a.length===1?i:Ni(a,i);e.compute(Wt(t,{hint:n.cacheKey,inputDependencies:["rank"]},[a[0]],n.noopWithEmptyAxes&&n.axes.length===0?xn:r,n.axes,a[0].dataType,n.keepDims,n.noopWithEmptyAxes),{inputs:[0]})},kn=(e,t)=>{ze(e.inputs),Ee(e,"ReduceLogSum",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${i.getByIndices("input_indices")};`,"value = log(value);"])},Sn=(e,t)=>{ze(e.inputs),Ee(e,"ReduceL1",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += abs(${i.getByIndices("input_indices")});`,""])},In=(e,t)=>{ze(e.inputs),Ee(e,"ReduceL2",t,(i,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${i.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])},Tn=(e,t)=>{ze(e.inputs),Ee(e,"ReduceLogSumExp",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += exp(${i.getByIndices("input_indices")});`,"value = log(value);"])},zn=(e,t)=>{ze(e.inputs),Ee(e,"ReduceMax",t,(i,r,a)=>{let n=[];for(let s=0;s<i.rank;s++)(a.indexOf(s)>=0||a.length===0)&&n.push(i.indicesSet("input_indices",s,0));return[`${n.join(`
`)}`,`var value = ${i.getByIndices("input_indices")};`,`value = max(value, ${i.getByIndices("input_indices")});`,""]})},En=(e,t)=>{ze(e.inputs),Ee(e,"ReduceMean",t,(i,r,a)=>{let n=1;for(let s=0;s<i.rank;s++)(a.indexOf(s)>=0||a.length===0)&&(n*=e.inputs[0].dims[s]);return["var sum = f32(0);","",`sum += f32(${i.getByIndices("input_indices")});`,`let value = ${r.type.value}(sum / ${n});`]})},Cn=(e,t)=>{ze(e.inputs),Ee(e,"ReduceMin",t,(i,r,a)=>{let n=[];for(let s=0;s<i.rank;s++)(a.indexOf(s)>=0||a.length===0)&&n.push(`input_indices[${s}] = 0;`);return[`${n.join(`
`)}`,`var value = ${i.getByIndices("input_indices")};`,`value = min(value, ${i.getByIndices("input_indices")});`,""]})},On=(e,t)=>{ze(e.inputs),Ee(e,"ReduceProd",t,(i,r)=>[`var value = ${r.type.storage}(1);`,"",`value *= ${i.getByIndices("input_indices")};`,""])},An=(e,t)=>{ze(e.inputs),Ee(e,"ReduceSum",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${i.getByIndices("input_indices")};`,""])},Bn=(e,t)=>{ze(e.inputs),Ee(e,"ReduceSumSquare",t,(i,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${i.getByIndices("input_indices")}; value += t * t;`,""])},Ce=(e,t,i)=>{if(t.length===0)return i;let r=1,a=1;for(let n=0;n<t.length;n++)t.indexOf(n)===-1?r*=e[n]:a*=e[n];return a<32&&r>1024},Rn=(e,t)=>{Ce(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?En(e,t):cn(e,t)},Dn=(e,t)=>{Ce(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Sn(e,t):fn(e,t)},Mn=(e,t)=>{Ce(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?In(e,t):mn(e,t)},Un=(e,t)=>{Ce(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Tn(e,t):gn(e,t)},Pn=(e,t)=>{Ce(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?zn(e,t):_n(e,t)},qn=(e,t)=>{Ce(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Cn(e,t):yn(e,t)},Nn=(e,t)=>{Ce(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?On(e,t):$n(e,t)},Vn=(e,t)=>{Ce(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?An(e,t):wn(e,t)},Ln=(e,t)=>{Ce(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Bn(e,t):bn(e,t)},Wn=(e,t)=>{Ce(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?kn(e,t):vn(e,t)}}),Li,Gn,Hn,Wi,bp=T(()=>{N(),re(),Vi(),Li=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},Gn=(e,t)=>{Li(e.inputs);let i=(r,a,n)=>{let s=[];for(let o=0;o<r.rank;o++)(n.indexOf(o)>=0||n.length===0)&&s.push(`input_indices[${o}] = 0;`);return[`${s.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?"<=":"<"} value) {
value = ${r.getByIndices("input_indices")};
best_index = i32(last_index);
}`,"",a.setByOffset("global_idx","best_index")]};e.compute(Wt("ArgMin",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],i,[t.axis],7,t.keepDims),{inputs:[0]})},Hn=(e,t)=>{Li(e.inputs);let i=(r,a,n)=>{let s=[];for(let o=0;o<r.rank;o++)(n.indexOf(o)>=0||n.length===0)&&s.push(`input_indices[${o}] = 0;`);return[`${s.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
value = ${r.getByIndices("input_indices")};
best_index = i32(last_index);
}`,"",a.setByOffset("global_idx","best_index")]};e.compute(Wt("argMax",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],i,[t.axis],7,t.keepDims),{inputs:[0]})},Wi=e=>Q(e)}),Fn,Gt,Kn,jn,Zn,yt,Qn,Xn,Gi=T(()=>{N(),W(),Bi(),G(),Fn=(e,t)=>{let i=e[0],r=e[1],a=e[2],n=e[3],s=e[4],o=e[5];if(s&&o)throw new Error("Attention cannot have both past and attention_bias");if(i.dims.length!==3)throw new Error('Input "input" must have 3 dimensions');let u=i.dims[0],l=i.dims[1],d=i.dims[2];if(a.dims.length!==1)throw new Error('Input "bias" is expected to have 1 dimensions');if(r.dims.length!==2)throw new Error('Input "weights" is expected to have 2 dimensions');if(r.dims[0]!==d)throw new Error("Input 1 dimension 0 should have same length as dimension 2 of input 0");if(a.dims[0]!==r.dims[1])throw new Error('Input "bias" dimension 0 should have same length as dimension 1 of input "weights"');let p=a.dims[0]/3,h=p,c=h;if(t.qkvHiddenSizes.length>0){if(t.qkvHiddenSizes.length!==3)throw new Error("qkv_hidden_sizes attribute should have 3 elements");for(let w of t.qkvHiddenSizes)if(w%t.numHeads!==0)throw new Error("qkv_hidden_sizes should be divisible by num_heads");p=t.qkvHiddenSizes[0],h=t.qkvHiddenSizes[1],c=t.qkvHiddenSizes[2]}let f=l;if(p!==h)throw new Error("qkv_hidden_sizes first element should be same as the second");if(a.dims[0]!==p+h+c)throw new Error('Input "bias" dimension 0 should have same length as sum of Q/K/V hidden sizes');let g=0;if(s){if(h!==c)throw new Error('Input "past" expect k_hidden_size == v_hidden_size');if(s.dims.length!==5)throw new Error('Input "past" must have 5 dimensions');if(s.dims[0]!==2)throw new Error('Input "past" first dimension must be 2');if(s.dims[1]!==u)throw new Error('Input "past" second dimension must be batch_size');if(s.dims[2]!==t.numHeads)throw new Error('Input "past" third dimension must be num_heads');if(s.dims[4]!==h/t.numHeads)throw new Error('Input "past" fifth dimension must be k_hidden_size / num_heads');t.pastPresentShareBuffer||(g=s.dims[3])}let y=f+g,_=-1,m=0;if(n)throw new Error("Mask not supported");if(s)throw new Error("past is not supported");if(o){if(o.dims.length!==4)throw new Error('Input "attention_bias" must have 4 dimensions');if(o.dims[0]!==u||o.dims[1]!==t.numHeads||o.dims[2]!==l||o.dims[3]!==y)throw new Error('Expect "attention_bias" shape (batch_size, num_heads, sequence_length, total_sequence_length)')}return{batchSize:u,sequenceLength:l,pastSequenceLength:g,kvSequenceLength:f,totalSequenceLength:y,maxSequenceLength:_,inputHiddenSize:d,hiddenSize:p,vHiddenSize:c,headSize:Math.floor(p/t.numHeads),vHeadSize:Math.floor(c/t.numHeads),numHeads:t.numHeads,isUnidirectional:!1,pastPresentShareBuffer:!1,maskFilterValue:t.maskFilterValue,maskType:m,scale:t.scale,broadcastResPosBias:!1,passPastInKv:!1,qkvFormat:1}},Gt=(e,t,i)=>t&&e?`
...
}`}},as=e=>{is(e.inputs),e.compute(rs(e.inputs))}}),ns,j,ss,os,us,ls,ds,ps,hs,cs,fs,ms,gs,_s,ys,$s,$t,ws,Ht,bs,vs,xs,ks,Ss,Is,Ts,zs,Es,Cs,Os,As,Bs,Rs,Ds,Ms,Hi,Us,Fi,Ki,Ps,qs,Ns,Vs,Ls,Ws,ji=T(()=>{N(),W(),re(),G(),ns=(e,t,i,r,a,n,s)=>{let o=Math.ceil(t/4),u="";typeof a=="string"?u=`${a}(a)`:u=a("a");let l=S("inputData",i,[o],4),d=B("outputData",r,[o],4),p=[{name:"vec_size",type:"u32"}];return s&&p.push(...s),`
...
}`},j=(e,t,i,r,a,n=e.dataType,s,o)=>{let u=[{type:12,data:Math.ceil(k.size(e.dims)/4)}];return s&&u.push(...s),{name:t,shaderCache:{hint:a,inputDependencies:["type"]},getShaderSource:l=>ns(l,k.size(e.dims),e.dataType,n,i,r,o),getRunData:l=>({outputs:[{dims:e.dims,dataType:n}],dispatchGroup:{x:Math.ceil(k.size(l[0].dims)/64/4)},programUniforms:u})}},ss=e=>{e.compute(j(e.inputs[0],"Abs","abs"))},os=e=>{e.compute(j(e.inputs[0],"Acos","acos"))},us=e=>{e.compute(j(e.inputs[0],"Acosh","acosh"))},ls=e=>{e.compute(j(e.inputs[0],"Asin","asin"))},ds=e=>{e.compute(j(e.inputs[0],"Asinh","asinh"))},ps=e=>{e.compute(j(e.inputs[0],"Atan","atan"))},hs=e=>{e.compute(j(e.inputs[0],"Atanh","atanh"))},cs=e=>Q(e),fs=(e,t)=>{let i;switch(t.to){case 10:i="vec4<f16>";break;case 1:i="vec4<f32>";break;case 12:i="vec4<u32>";break;case 6:i="vec4<i32>";break;case 9:i="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(j(e.inputs[0],"Cast",i,void 0,t.cacheKey,t.to))},ms=e=>{let t,i,r=e.length>=2&&e[1].data!==0,a=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,i=a?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,i=a?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return Q({min:t,max:i})},gs=(e,t)=>{let i=t||ms(e.inputs),r=pe(e.inputs[0].dataType);e.compute(j(e.inputs[0],"Clip",a=>`clamp(${a}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,i.cacheKey,void 0,[{type:e.inputs[0].dataType,data:i.min},{type:e.inputs[0].dataType,data:i.max}],[{name:"min",type:r},{name:"max",type:r}]),{inputs:[0]})},_s=e=>{e.compute(j(e.inputs[0],"Ceil","ceil"))},ys=e=>{e.compute(j(e.inputs[0],"Cos","cos"))},$s=e=>{e.compute(j(e.inputs[0],"Cosh","cosh"))},$t=e=>Q(e),ws=(e,t)=>{let i=pe(e.inputs[0].dataType);e.compute(j(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
}`,bs=e=>{let t=pe(e.inputs[0].dataType);e.compute(j(e.inputs[0],"Erf",i=>`erf_vf32(${i})`,Ht(t)))},vs=e=>{e.compute(j(e.inputs[0],"Exp","exp"))},xs=e=>{e.compute(j(e.inputs[0],"Floor","floor"))},ks=e=>{let t=pe(e.inputs[0].dataType);e.compute(j(e.inputs[0],"Gelu",i=>`0.5 * ${i} * (1.0 + erf_vf32(${i} * 0.7071067811865475))`,Ht(t)))},Ss=(e,t)=>{let i=pe(e.inputs[0].dataType);e.compute(j(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${t.alpha});`,t.cacheKey))},Is=e=>{e.compute(j(e.inputs[0],"Not",t=>`!${t}`))},Ts=e=>{e.compute(j(e.inputs[0],"Neg",t=>`-${t}`))},zs=e=>{e.compute(j(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Es=e=>{let t=pe(e.inputs[0].dataType);e.compute(j(e.inputs[0],"Relu",i=>`select(vec4<${t}>(0.0), ${i}, ${i} > vec4<${t}>(0.0))`))},Cs=e=>{e.compute(j(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Os=e=>Q(e),As=(e,t)=>{let i=pe(e.inputs[0].dataType);e.compute(j(e.inputs[0],"HardSigmoid",r=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${t.alpha} * ${r} + vec4<${i}>(${t.beta})))`,void 0,t.cacheKey))},Bs=e=>{e.compute(j(e.inputs[0],"Sin","sin"))},Rs=e=>{e.compute(j(e.inputs[0],"Sinh","sinh"))},Ds=e=>{e.compute(j(e.inputs[0],"Sqrt","sqrt"))},Ms=e=>{e.compute(j(e.inputs[0],"Tan","tan"))},Hi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Us=e=>{e.compute(j(e.inputs[0],"Tanh",Hi))},Fi=(e="f32")=>`
...
`,Ki=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Ps=e=>{let t=pe(e.inputs[0].dataType);e.compute(j(e.inputs[0],"FastGelu",Ki,Fi(t),void 0,e.inputs[0].dataType))},qs=(e,t)=>{let i=pe(e.inputs[0].dataType);return e.compute(j(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${i}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${i}>(${t.alpha});`,t.cacheKey)),0},Ns=e=>{e.compute(j(e.inputs[0],"Log","log"))},Vs=(e,t)=>`
...
`,Ls=e=>`quick_gelu_impl(${e})`,Ws=(e,t)=>{let i=pe(e.inputs[0].dataType);e.compute(j(e.inputs[0],"QuickGelu",Ls,Vs(i,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Gs,Hs,Fs,kp=T(()=>{W(),G(),ji(),Gs=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Hs=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let i=S("input",e[0].dataType,e[0].dims,4),r=S("bias",e[0].dataType,[e[0].dims[2]],4),a=B("output",e[0].dataType,t,4),n=k.size(t)/4,s=ne(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:o=>`
...
${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
${_}
}`},js=(e,t,i,r,a,n,s=i.dataType)=>{let o=i.dims.map(g=>Number(g)??1),u=r.dims.map(g=>Number(g)??1),l=!k.areEqual(o,u),d=o,p=k.size(o),h=!1,c=!1,f=[l];if(l){let g=nt.calcShape(o,u,!1);if(!g)throw new Error("Can't perform binary op on the given tensors");d=g.slice(),p=k.size(d);let y=k.size(o)===1,_=k.size(u)===1,m=o.length>0&&o[o.length-1]%4===0,w=u.length>0&&u[u.length-1]%4===0;f.push(y),f.push(_),f.push(m),f.push(w);let $=1;for(let b=1;b<d.length;b++){let x=o[o.length-b],v=u[u.length-b];if(x===v)$*=x;else break}$%4===0?(c=!0,h=!0):(y||_||m||w)&&(h=!0)}else h=!0;return f.push(h),{name:e,shaderCache:{hint:t+f.map(g=>g.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:g=>Ks(g,o,u,d,h,l,c,a,i.dataType,r.dataType,s,n),getRunData:()=>({outputs:[{dims:d,dataType:s}],dispatchGroup:{x:Math.ceil(p/64/4)},programUniforms:[{type:12,data:Math.ceil(k.size(d)/4)},...M(o,u,d)]})}},Oe=(e,t,i,r,a,n)=>{e.compute(js(t,a??"",e.inputs[0],e.inputs[1],i,r,n))},Zs=e=>{Oe(e,"Add",(t,i)=>`${t}+${i}`)},Qs=e=>{Oe(e,"Div",(t,i)=>`${t}/${i}`)},Xs=e=>{Oe(e,"Equal",{scalar:(t,i)=>`u32(${t}==${i})`,vector:(t,i)=>`vec4<u32>(${t}==${i})`},void 0,void 0,9)},Ys=e=>{Oe(e,"Mul",(t,i)=>`${t}*${i}`)},Js=e=>{let t=S("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Oe(e,"Pow",{scalar:(i,r)=>`pow_custom(${i},${r})`,vector:(i,r)=>`pow_vector_custom(${i},${r})`},`
...
`)},eo=e=>{Oe(e,"Sub",(t,i)=>`${t}-${i}`)},to=e=>{Oe(e,"Greater",{scalar:(t,i)=>`u32(${t}>${i})`,vector:(t,i)=>`vec4<u32>(${t}>${i})`},void 0,void 0,9)},io=e=>{Oe(e,"Less",{scalar:(t,i)=>`u32(${t}<${i})`,vector:(t,i)=>`vec4<u32>(${t}<${i})`},void 0,void 0,9)},ro=e=>{Oe(e,"GreaterOrEqual",{scalar:(t,i)=>`u32(${t}>=${i})`,vector:(t,i)=>`vec4<u32>(${t}>=${i})`},void 0,void 0,9)},ao=e=>{Oe(e,"LessOrEqual",{scalar:(t,i)=>`u32(${t}<=${i})`,vector:(t,i)=>`vec4<u32>(${t}<=${i})`},void 0,void 0,9)}}),no,so,oo,uo,lo,po,Ip=T(()=>{N(),W(),re(),G(),no=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let i=0,r=e[i],a=r.dataType,n=r.dims.length;e.forEach((s,o)=>{if(o!==i){if(s.dataType!==a)throw new Error("input tensors should be one type");if(s.dims.length!==n)throw new Error("input tensors should have the same shape");s.dims.forEach((u,l)=>{if(l!==t&&u!==r.dims[l])throw new Error("non concat dimensions must match")})}})},so=(e,t)=>`
...
`;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Xe=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},Ye=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Zi=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[i,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:i,beta:r}}else if(t==="Clip"){let[i,r]=e?.activation_params||[Aa,Ba];return{activation:t,clipMax:r,clipMin:i}}else if(t==="LeakyRelu"){let[i]=e?.activation_params||[.01];return{activation:t,alpha:i}}return{activation:t}}}),se,ho,Qi=T(()=>{se=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},ho=e=>`
...
`};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${p};${h};${c};${a}`,inputDependencies:g?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:m}),getShaderSource:w}}}),fo,mo,Ji,er,go,tr,_o,Ft,ir=T(()=>{N(),W(),G(),Je(),Yi(),Qi(),fo=(e,t)=>e?`
...
`},_o=(e,t,i,r,a=!1)=>{let[n,s,o,u]=r,l=ne(r[0].type.tensor);return`
...
}`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${p}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:c}),getShaderSource:g}},Io=(e,t,i,r)=>{let a=e.length>2,n=ie(i[3]),s=ie(i[2]),o=k.size(i)/n/s,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/n],l=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/n],d=[i[0],i[1],i[2],i[3]/n],p=[{type:12,data:o},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Xe(t,p),p.push(...M(u,l,d));let h=(s-1)*t.strides[1]+l[1],c=f=>{let g=B("output",e[0].dataType,d.length,n),y=ne(g.type.tensor),_=Qe(t,g.type.value,y),m=S("x",e[0].dataType,u.length,n),w=S("w",e[1].dataType,l.length,n),$=[m,w];a&&$.push(S("b",e[2].dataType,e[2].dims,n));let b=a?"value += b[output_channel];":"",x=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Ye(t,x),`
...
}`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:_=>{let m=u?[i,r*l,a*l,n/l**2]:[i,n/l**2,r*l,a*l],w=k.size(m),$=p.dims,b=k.sortBasedOnPerm($,o);return{outputs:[{dims:m,dataType:_[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:[{type:12,data:w},...M($,b)]}},getShaderSource:y}},Ho=(e,t)=>{Lo(e.inputs),e.compute(Go(e.inputs[0],t))},Fo=e=>Q({blocksize:e.blocksize,mode:e.mode,format:e.format})}),Zt,vt,dr,Ko,jo,Zo,Qo,pr,Xo,Yo,Jo,Mp=T(()=>{N(),W(),re(),G(),Zt="[a-zA-Z]|\\.\\.\\.",vt="("+Zt+")+",dr="^"+vt+"$",Ko="("+vt+",)*"+vt,jo="^"+Ko+"$",Zo=class{constructor(e=-1){this.symbolToIndices=new Map,this.inputIndex=e}addSymbol(e,t){let i=this.symbolToIndices.get(e);i===void 0?i=[t]:i.push(t),this.symbolToIndices.set(e,i)}},Qo=class{constructor(e,t){this.equation=t,this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[i,r]=t.includes("->")?t.split("->",2):[t,""];if(!i.match(RegExp(jo)))throw new Error("Invalid LHS term");if(i.split(",").forEach((a,n)=>{let s=e[n].dims.slice();if(!a.match(RegExp(dr)))throw new Error("Invalid LHS term");let o=this.processTerm(a,!0,s,n);this.lhs.push(o)}),r==="")r+=[...this.symbolToInfo.entries()].filter(([a,n])=>n.count===1||a==="...").map(([a])=>a).join("");else if(!r.match(RegExp(vt)))throw new Error("Invalid RHS");r.match(RegExp(Zt,"g"))?.forEach(a=>{if(a==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let n=this.symbolToInfo.get(a);if(n===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(n.dimValue)}}),this.rhs=this.processTerm(r,!1,this.outputDims)}addSymbol(e,t,i){let r=this.symbolToInfo.get(e);if(r!==void 0){if(r.dimValue!==t&&r.count!==1)throw new Error("Dimension mismatch");r.count++,r.inputIndices.push(i)}else r={count:1,dimValue:t,inputIndices:[i]};this.symbolToInfo.set(e,r)}processTerm(e,t,i,r=-1){let a=i.length,n=!1,s=[],o=0;if(!e.match(RegExp(dr))&&!t&&e!=="")throw new Error("Invalid LHS term");let u=e.match(RegExp(Zt,"g")),l=new Zo(r);return u?.forEach((d,p)=>{if(d==="..."){if(n)throw new Error("Only one ellipsis is allowed per input term");n=!0;let h=a-u.length+1;if(h<0)throw new Error("Ellipsis out of bounds");if(s=i.slice(o,o+h),this.hasEllipsis){if(this.ellipsisDims.length!==s.length||this.ellipsisDims.toString()!==s.toString())throw new Error("Ellipsis dimensions mismatch")}else if(t)this.hasEllipsis=!0,this.ellipsisDims=s;else throw new Error("Ellipsis must be specified in the LHS");for(let c=0;c<s.length;c++){let f=String.fromCharCode(48+c);l.addSymbol(f,p+c),this.addSymbol(f,i[o++],r)}}else l.addSymbol(d,p+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(d,i[o++],r)}),l}},pr=e=>e+"_max",Xo=(e,t,i,r)=>{let a=e.map(l=>l.length).map((l,d)=>S(`input${d}`,t,l)),n=k.size(r),s=B("output",t,r.length),o=[...i.symbolToInfo.keys()].filter(l=>!i.rhs.symbolToIndices.has(l)),u=l=>{let d=[],p="var prod = 1.0;",h="var sum = 0.0;",c="sum += prod;",f=[],g=[],y=[],_=[],m=i.symbolToInfo.size===i.rhs.symbolToIndices.size;i.symbolToInfo.forEach(($,b)=>{if(i.rhs.symbolToIndices.has(b)){let x=i.rhs.symbolToIndices.get(b)?.[0];x!==void 0&&i.lhs.forEach((v,I)=>{if($.inputIndices.includes(I)){let z=v.symbolToIndices.get(b);if(z===void 0)throw new Error("Invalid symbol error");z.forEach(O=>{d.push(`${a[I].indicesSet(`input${I}Indices`,O,s.indicesGet("outputIndices",x))}`)})}})}else i.lhs.forEach((x,v)=>{if($.inputIndices.includes(v)){let I=x.symbolToIndices.get(b);if(I===void 0)throw new Error("Invalid symbol error");I.forEach(z=>{f.push(`${a[v].indicesSet(`input${v}Indices`,z,`${b}`)}`)}),_.push(`prod *= ${a[v].getByIndices(`input${v}Indices`)};`)}}),g.push(`for(var ${b}: u32 = 0; ${b} < uniforms.${pr(b)}; ${b}++) {`),y.push("}")});let w=m?[...d,`let sum = ${a.map(($,b)=>$.getByIndices(`input${b}Indices`)).join(" * ")};`]:[...d,h,...g,...f,p,..._,c,...y];return`
...
${f}`},d=[{type:12,data:u},...M(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${s}${o}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d})}},ru=e=>{eu(e.inputs),e.compute(iu(e.inputs),{inputs:[0]})}}),au,nu,Pp=T(()=>{N(),W(),G(),ji(),au=e=>{let t=e[0].dataType,i=k.size(e[0].dims),r=k.size(e[1].dims),a=r%4===0,n=s=>{let o=S("x",t,[1],4),u=S("bias",t,[1],4),l=B("y",t,[1],4),d=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],p=c=>`
...
}`};return{name:"FastGeluWithBias",shaderCache:{hint:`${a}`,inputDependencies:["type","type"]},getShaderSource:n,getRunData:s=>({outputs:[{dims:s[0].dims,dataType:s[0].dataType}],programUniforms:[{type:12,data:Math.ceil(i/4)},{type:12,data:r}],dispatchGroup:{x:Math.ceil(i/st/4)}})}},nu=e=>{e.inputs.length<2||k.size(e.inputs[1].dims)===0?Ps(e):e.compute(au(e.inputs))}}),su,ou,uu,lu,qp=T(()=>{N(),W(),re(),G(),su=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},ou=(e,t)=>{let i=e[0].dims,r=e[1].dims,a=i.length,n=k.normalizeAxis(t.axis,a),s=i.slice(0);s.splice(n,1,...r);let o=i[n],u=e[0].dataType===9?4:1,l=Math.ceil(k.size(s)/u),d=[{type:12,data:l},{type:6,data:o},{type:12,data:n},...M(e[0].dims,e[1].dims,s)],p=h=>{let c=S("data",e[0].dataType,e[0].dims.length,u),f=S("inputIndices",e[1].dataType,e[1].dims.length),g=B("output",e[0].dataType,s.length,u),y=m=>{let w=r.length,$=`var indicesIndices${m}  = ${f.type.indices}(0);`;for(let b=0;b<w;b++)$+=`${w>1?`indicesIndices${m}[${b}]`:`indicesIndices${m}`} = ${s.length>1?`outputIndices${m}[uniforms.axis + ${b}]`:`outputIndices${m}`};`;$+=`
...
}`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((c,f)=>f!==1).map(c=>c.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(c,f)=>"rank")},getRunData:()=>({outputs:[{dims:o,dataType:l}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:h}},mu=(e,t)=>{let i=e.inputs;cu(i,t),e.compute(fu(e.inputs,t))},gu=e=>Q({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),_u,yu,$u,wu,Lp=T(()=>{N(),W(),re(),G(),_u=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
          indices input tensors be of same rank.`)},yu=(e,t)=>{let i=e[0].dims,r=e[0].dataType,a=i.length,n=e[1].dims,s=e[1].dataType,o=k.normalizeAxis(t.axis,a),u=i[o],l=n.slice(0),d=k.size(l),p=S("input",r,a),h=S("indicesInput",s,n.length),c=B("output",r,l.length),f=[{type:12,data:d},{type:6,data:u},{type:12,data:o}];return f.push(...M(i,n,l)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:f}),getShaderSource:g=>`
...
indices[${Be}] = batch;
indices[${qe}] = channel;`+(()=>{switch(i.paddingMode){case"zeros":return`
if (r >= 0 && r < H && c >=0 && c < W) {
 indices[${et}] = u32(r);
 indices[${tt}] = u32(c);
} else {
...
let result = pixel_at_grid(i32(round(y)), i32(round(x)), H_in, W_in, indices[${Be}], indices[${qe}], border);
...
let p11 = pixel_at_grid(y1, x1, H_in, W_in, indices[${Be}], indices[${qe}], border);
let p12 = pixel_at_grid(y1, x2, H_in, W_in, indices[${Be}], indices[${qe}], border);
let p21 = pixel_at_grid(y2, x1, H_in, W_in, indices[${Be}], indices[${qe}], border);
let p22 = pixel_at_grid(y2, x2, H_in, W_in, indices[${Be}], indices[${qe}], border);
...
for (var h = 0; h < 4; h++) {
 for (var w = 0; w < 4; w++) {
   p[h][w] = pixel_at_grid(h + y0, w + x0, H_in, W_in, indices[${Be}], indices[${qe}], border);
 }
}
...
}`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:c,getRunData:()=>({outputs:l,dispatchGroup:{x:Math.ceil(r/64)},programUniforms:h})}},Gu=(e,t)=>{Nu(e.inputs);let i=e.inputs.length===1?t:Vu(e.inputs,t);e.compute(fr(e.inputs,i),{inputs:[0]})},Hu=e=>{let t=e.axis,i=e.splitSizes,r=e.numOutputs<0?i.length:e.numOutputs;if(r!==i.length)throw new Error("numOutputs and splitSizes lengh must be equal");return Q({axis:t,numOutputs:r,splitSizes:i})}}),Ku,Qt,ju,Zu=T(()=>{N(),W(),re(),G(),Ku=(e,t)=>{let[i,r,a,n]=e,{numHeads:s,rotaryEmbeddingDim:o}=t;if(i.dims.length!==3&&i.dims.length!==4)throw new Error(`Input 'x' is expected to have 3 or 4 dimensions, got ${i.dims.length}`);if(!k.areEqual(r.dims,[])&&!k.areEqual(r.dims,[1])&&r.dims.length!==2)throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${r.dims.length}`);if(a.dims.length!==2)throw new Error(`Input 'cos_cache' is expected to have 2 dimensions, got ${a.dims.length}`);if(n.dims.length!==2)throw new Error(`Input 'sin_cache' is expected to have 2 dimensions, got ${n.dims.length}`);if(!k.areEqual(a.dims,n.dims))throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");if(o>0&&s===0)throw new Error("num_heads must be provided if rotary_embedding_dim is specified");let u=i.dims[0],l=i.dims[i.dims.length-2],d=a.dims[0],p=k.sizeFromDimension(i.dims,1)/l,h=o===0?a.dims[1]*2:p/s;if(o>h)throw new Error("rotary_embedding_dim must be less than or equal to head_size");if(r.dims.length===2){if(u!==r.dims[0])throw new Error(`Input 'position_ids' dimension 0 should be of size batch_size, got ${r.dims[0]}`);if(l!==r.dims[1])throw new Error(`Input 'position_ids' dimension 1 should be of size sequence_length, got ${r.dims[1]}`)}if(h/2!==a.dims[1]&&o/2!==a.dims[1])throw new Error(`Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${a.dims[1]}`);if(l>d)throw new Error("Updating cos_cache and sin_cache in RotaryEmbedding is not currently supported")},Qt=(e,t)=>{let{interleaved:i,numHeads:r,rotaryEmbeddingDim:a,scale:n}=t,s=e[0].dims[0],o=k.sizeFromDimension(e[0].dims,1),u=e[0].dims[e[0].dims.length-2],l=o/u,d=e[2].dims[1],p=a===0?d*2:l/r,h=new Array(s,u,l/p,p-d),c=k.computeStrides(h),f=[{type:1,data:n},{type:12,data:h},{type:12,data:c},...e[0].dims.length===3?new Array({type:12,data:[o,l,p,1]}):[],...e[0].dims.length===4?new Array({type:12,data:[o,p,u*p,1]}):[],...M(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)],g=y=>{let _=S("input",e[0].dataType,e[0].dims.length),m=S("position_ids",e[1].dataType,e[1].dims.length),w=S("cos_cache",e[2].dataType,e[2].dims.length),$=S("sin_cache",e[3].dataType,e[3].dims.length),b=B("output",e[0].dataType,e[0].dims.length);return y.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:h.length},{name:"global_strides",type:"u32",length:c.length},{name:"input_output_strides",type:"u32",length:c.length}]),`
...
`};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:n},getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:u}),getShaderSource:l}},Ju=(e,t)=>{let i=Qu(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let r=e.inputs[0],a=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,n=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,s=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,o=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,u=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,d=i.kvNumHeads?i.kvNumHeads:i.numHeads,p=Q({axis:2,numOutputs:3,splitSizes:[i.numHeads*i.headSize,d*i.headSize,d*i.headSize]}),[h,c,f]=!a&&!n?e.compute(fr([r],p),{inputs:[r],outputs:[-1,-1,-1]}):[r,a,n],g,y;if(t.doRotary){let $=e.compute(Yu(i.batchSize,i.sequenceLength,u,l),{inputs:[u,l],outputs:[-1]})[0],b=e.inputs[7],x=e.inputs[8],v=Q({interleaved:t.rotaryInterleaved!==0,numHeads:i.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),I=[h,$,b,x],z=[-1];g=e.compute(Qt(I,v),{inputs:I,outputs:z})[0],I.splice(0,1,c);let O=Q({interleaved:t.rotaryInterleaved!==0,numHeads:i.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});y=e.compute(Qt(I,O),{inputs:I,outputs:z})[0]}let _=xt(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,t.doRotary?g:h,void 0,0),m=mr(e,t.doRotary?y:c,i),w=mr(e,f,i);yt(e,_,m,w,void 0,void 0,s,o,void 0,i,u,l)}}),gr,el,tl,il,Fp=T(()=>{N(),W(),We(),G(),gr=(e,t,i,r,a,n,s,o)=>{let u=ie(n),l=u===1?"f32":`vec${u}f`,d=u===1?"vec2f":`mat2x${u}f`,p=a*s,h=64;p===1&&(h=256);let c=[a,s,n/u],f=[a,s,2],g=["rank","type","type"],y=[];y.push(...M(c,f));let _=m=>{let w=S("x",t.dataType,3,u),$=S("scale",i.dataType,i.dims),b=S("bias",r.dataType,r.dims),x=B("output",1,3,2),v=[w,$,b,x];return`
...
}`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${o};${h}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:f,dataType:1}],dispatchGroup:{x:p},programUniforms:y}),getShaderSource:_},{inputs:[t,i,r],outputs:[-1]})[0]},el=(e,t,i)=>{let r=t[0].dims,a=r,n=2,s=r[0],o=r[1],u=k.sizeFromDimension(r,n),l=ie(u),d=k.size(a)/l,p=gr(e,t[0],t[1],t[2],s,u,o,i.epsilon),h=[s,o,u/l],c=[s,o],f=["type","none"],g=y=>{let _=S("x",t[0].dataType,h.length,l),m=S("scale_shift",1,c.length,2),w=B("output",t[0].dataType,h.length,l),$=[_,m,w];return`
...
}`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:y},{inputs:[t[0],g]})},il=(e,t)=>{t.format==="NHWC"?tl(e,e.inputs,t):el(e,e.inputs,t)}}),rl,al,nl,Kp=T(()=>{N(),W(),G(),rl=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},al=(e,t,i)=>{let r=t.simplified,a=e[0].dims,n=e[1],s=!r&&e[2],o=a,u=k.normalizeAxis(t.axis,a.length),l=k.sizeToDimension(a,u),d=k.sizeFromDimension(a,u),p=k.size(n.dims),h=s?k.size(s.dims):0;if(p!==d||s&&h!==d)throw new Error(`Size of X.shape()[axis:] == ${d}.
...
}`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${p};${h};${y};${g}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:c,dataType:d}],dispatchGroup:{x:$},programUniforms:b}),getShaderSource:z}},pl=(e,t)=>{ul(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(dl(e.inputs,t)):e.compute(ll(e.inputs,t))},hl=e=>Q(e)}),cl,fl,ml,gl,_l,yl,$l,wl,bl,Qp=T(()=>{N(),W(),G(),cl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},fl=(e,t,i)=>{let r="";for(let a=t-1;a>=0;--a)r+=`
...
}`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getShaderSource:O,getRunData:()=>({outputs:[{dims:n,dataType:s}],dispatchGroup:{x:Math.ceil(o/_/64),y:1,z:1},programUniforms:z})}},Rl=(e,t)=>{Al(e.inputs,t),e.compute(Bl(e.inputs,t))},Dl=e=>Q({axis:e.axis,blockSize:e.blockSize})}),Ml,Ul,Pl,Jp=T(()=>{Se(),N(),G(),Ml=(e,t,i)=>{let r=e===t,a=e<t&&i<0,n=e>t&&i>0;if(r||a||n)throw new Error("Range these inputs' contents are invalid.")},Ul=(e,t,i,r)=>{let a=Math.abs(Math.ceil((t-e)/i)),n=[a],s=a,o=[{type:12,data:s},{type:r,data:e},{type:r,data:i},...M(n)],u=l=>{let d=B("output",r,n.length),p=d.type.value,h=[{name:"outputSize",type:"u32"},{name:"start",type:p},{name:"delta",type:p}];return`
${l.registerUniforms(h).declareVariables(d)}
${l.mainStart()}
${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
output[global_idx] = uniforms.start + ${p}(global_idx) * uniforms.delta;
}`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:o})}},Pl=e=>{let t=0,i=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],i=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],i=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),J.webgpu.validateInputContent&&Ml(t,i,r),e.compute(Ul(t,i,r,e.inputs[0].dataType),{inputs:[]})}}),ql,Sr,Ir,Nl,Vl,Ll,eh=T(()=>{N(),W(),re(),G(),ql=(e,t,i,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let a=`{
     var oldValue = 0;
     loop {
       let newValueF32 =`,n=`;
...
}`,Nl=(e,t)=>{let i=e[0].dims,r=e[1].dims,a=i,n=1,s=Math.ceil(k.size(r)/n),o=r[r.length-1],u=k.sizeFromDimension(i,o),l=k.sizeFromDimension(r,0)/o,d=[{type:12,data:s},{type:12,data:o},{type:12,data:u},...M(e[1].dims,e[2].dims,a)],p=h=>{let c=S("indices",e[1].dataType,e[1].dims.length),f=S("updates",e[2].dataType,e[2].dims.length,n),g=t.reduction!=="none"&&t.reduction!==""?Fa("output",e[0].dataType,a.length):B("output",e[0].dataType,a.length,n);return`
...
${Ir(t,g.type.value,!0)}
}`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d}),getShaderSource:p}},Vl=e=>Q({reduction:e.reduction}),Ll=(e,t)=>{e.compute(Nl(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Wl,Gl,Hl,Tr,Fl,Kl,jl,Zl,Ql,Xl,Yl,Jl,zr,ed,td,id,rd,ad,nd,sd,th=T(()=>{N(),W(),re(),G(),Wl=(e,t)=>{if(e.every(i=>i>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
}`},rd=(e,t,i,r,a,n)=>{let s=e.dims,o=jl(n,t.axes,s.length),u=Zl(s,r,a,t.axes),l=r.slice();r.length===0&&(l=s.map((m,w)=>m===0?1:u[w]/m),t.keepAspectRatioPolicy!=="stretch"&&(u=Ql(s,l,t)));let d=B("output",e.dataType,u.length),p=S("input",e.dataType,s.length),h=k.size(u),c=s.length===u.length&&s.every((m,w)=>m===u[w]),f=t.coordinateTransformMode==="tf_crop_and_resize",g=t.extrapolationValue,y=p.type.value,_=m=>`
${c?"":`
${Fl(t.coordinateTransformMode,y)};
${(()=>{switch(t.mode){case"nearest":return`
   ${Jl(p,s)};
   ${Kl(t.nearestMode,i,y)};
...
}`},$=[{dims:o,dataType:e[0].dataType}];return i>1&&$.push({dims:d,dataType:1}),i>2&&$.push({dims:d,dataType:1}),i>3&&$.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${_};${c};${f};${g}`,inputDependencies:e.map((b,x)=>"type")},getShaderSource:w,getRunData:()=>({outputs:$,dispatchGroup:{x:Math.ceil(u/l)},programUniforms:m})}},ld=(e,t)=>{od(e.inputs);let i=[0];e.outputCount>1&&i.push(-3),e.outputCount>2&&i.push(-3),e.outputCount>3&&i.push(3),e.compute(ud(e.inputs,t,e.outputCount,!1),{outputs:i})}}),dd,St,pd,Er,hd,cd,fd,md,rh=T(()=>{N(),W(),re(),G(),dd=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((i,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},St=(e,t)=>{let i=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>i.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>i.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return i},pd=(e,t)=>{if(e.length>1){let i=St(e,1),r=St(e,2),a=St(e,3);return a.length===0&&(a=[...Array(e[0].dims.length).keys()]),Q({starts:i,ends:r,axes:a})}else return t},Er=(e,t,i,r,a)=>{let n=e;return e<0&&(n+=i[r[t]]),a[t]<0?Math.max(0,Math.min(n,i[r[t]]-1)):Math.max(0,Math.min(n,i[r[t]]))},hd=(e,t,i)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
var input_indices: ${e.type.indices};
var carry = 0u;
...
}`;return{name:"Slice",shaderCache:{hint:`${u.length}_${s.length}_${n.length}`,inputDependencies:["rank"]},getShaderSource:y,getRunData:()=>({outputs:[d],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:g})}},fd=(e,t)=>{dd(e.inputs,t);let i=pd(e.inputs,t);e.compute(cd(e.inputs,i),{inputs:[0]})},md=e=>{let t=e.starts,i=e.ends,r=e.axes;return Q({starts:t,ends:i,axes:r})}}),gd,_d,yd,$d,ah=T(()=>{N(),W(),re(),We(),G(),gd=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},_d=(e,t)=>{let i=e.inputs[0],r=i.dims,a=k.size(r),n=r.length,s=k.normalizeAxis(t.axis,n),o=s<r.length-1,u,l=[];o?(l=Array.from({length:n},(v,I)=>I),l[s]=n-1,l[n-1]=s,u=e.compute($e(i,l),{inputs:[i],outputs:[-1]})[0]):u=i;let d=u.dims,p=d[n-1],h=a/p,c=ie(p),f=p/c,g=64;h===1&&(g=256);let y=(v,I)=>I===4?`max(max(${v}.x, ${v}.y), max(${v}.z, ${v}.w))`:I===2?`max(${v}.x, ${v}.y)`:I===3?`max(max(${v}.x, ${v}.y), ${v}.z)`:v,_=S("x",u.dataType,u.dims,c),m=B("result",u.dataType,u.dims,c),w=_.type.value,$=ne(u.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,b=v=>`
...
if (lindex == 0) {
rowSumShared = ${w}(${Le("threadShared[0]",c)});
}
workgroupBarrier();
 ...
 * limitations under the License.
 * =============================================================================
 */typeof ip=="object"&&typeof Gr=="object"&&(Gr.exports=ii);console.log("wow3");ii.env.wasm.numThreads=4;self.onmessage=async De=>{const{type:he,userImageBuffer:Ae,topoImageBuffer:lt}=De.data;if(he==="createSession"){console.log("createSession in worker 2");try{const ce=performance.now(),T=await ii.InferenceSession.create("../../superpoint_lightglue_pipeline.ort.onnx",{executionProviders:["wasm"],graphOptimizationLevel:"all",wasm:{numThreads:navigator.hardwareConcurrency?Math.max(1,Math.min(4,navigator.hardwareConcurrency)):2,simd:!0,threads:!0}}),de=performance.now();self.session=T,self.postMessage({type:"sessionCreated",data:{sessionTime:de-ce}})}catch(ce){self.postMessage({type:"error",data:{message:ce.message}})}}if(he==="runInference"){if(!self.session){self.postMessage({type:"error",data:{message:"Session is not initialized."}});return}let ce=null,T=null,de=null,Ve=null;try{if(!Ae||!lt){self.postMessage({type:"error",data:{message:"Both user and topo images must be provided."}});return}de=new Blob([Ae]),ce=await createImageBitmap(de),Ve=new Blob([lt]),T=await createImageBitmap(Ve);const le=[ce,T],Me={width:ce.width,height:ce.height},we={width:T.width,height:T.height},ge=256,at=256,dt=le.map((At,J)=>yh(At,ge,at,J)),Ct=new Float32Array([...dt[0],...dt[1]]),Ot={images:new ii.Tensor("float32",Ct,[2,1,at,ge])},ri=performance.now(),pt=await self.session.run(Ot),me=performance.now();self.postMessage({type:"inferenceComplete",data:{inferenceTime:me-ri,results:pt,images:le,imgWidth:ge,imgHeight:at,userImageDims:Me,topoImageDims:we}})}catch(le){self.postMessage({type:"error",data:{message:le.message}})}finally{ce&&typeof ce.close=="function"&&ce.close(),T&&typeof T.close=="function"&&T.close(),ce=null,T=null,de=null,Ve=null}}};function yh(De,he,Ae,lt){const T=new OffscreenCanvas(he,Ae).getContext("2d");T.drawImage(De,0,0,he,Ae);const de=T.getImageData(0,0,he,Ae).data,Ve=new Float32Array(he*Ae);for(let le=0;le<he*Ae;le++){const Me=de[le*4]/255,we=de[le*4+1]/255,ge=de[le*4+2]/255;Ve[le]=.299*Me+.587*we+.114*ge}return Ve}});export default $h();
