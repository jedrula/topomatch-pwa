...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Fa=(e,t)=>new Ha(e,t)}),ja,Mi,Ka,Za,Qa,Xa,$e,Ya,Ja,We=T(()=>{N(),W(),re(),G(),ja=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},Mi=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Ka=(e,t)=>k.sortBasedOnPerm(e,Mi(e.length,t)),Za=(e,t,i,r)=>{let a=`fn perm(i: ${r.type.indices}) -> ${i.type.indices} {
var a: ${i.type.indices};`;for(let n=0;n<t;++n)a+=`a[${e[n]}]=i[${n}];`;return a+="return a;}"},Qa=(e,t)=>{let i=[],r=[];for(let a=0;a<e.length;++a)e[a]!==1&&i.push(e[a]),e[t[a]]!==1&&r.push(t[a]);return{newShape:i,newPerm:r}},Xa=(e,t)=>{let i=0;for(let r=0;r<e.length;++r)if(t[e[r]]!==1){if(e[r]<i)return!1;i=e[r]}return!0},$e=(e,t)=>{let i=e.dataType,r=e.dims.length,a=Mi(r,t),n=Ka(e.dims,a),s=e.dims,o=n,u=r<2||Xa(a,e.dims),l;if(u)return l=f=>{let g=S("input",i,s,4),y=B("output",i,o,4);return`
${f.registerUniform("output_size","u32").declareVariables(g,y)}
${f.mainStart()}
${f.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
output[global_idx] = input[global_idx];
}`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let f=k.size(n);return{outputs:[{dims:n,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(f/64/4)},programUniforms:[{type:12,data:Math.ceil(f/4)}]}},getShaderSource:l};let{newShape:d,newPerm:p}=Qa(e.dims,a),c=k.areEqual(p,[2,3,1]),h=k.areEqual(p,[3,1,2]);if(d.length===2||c||h){s=c?[d[0],d[1]*d[2]]:h?[d[0]*d[1],d[2]]:d,o=[s[1],s[0]];let f=16;return l=g=>{let y=S("a",i,s.length),_=B("output",i,o.length);return`
...
}`;return{name:e,shaderCache:{hint:`${t};${c}`,inputDependencies:["type"]},getShaderSource:f,getRunData:()=>({outputs:[{dims:n,dataType:a}],dispatchGroup:{x:u},programUniforms:[{type:12,data:l}]})}},Ce=(e,t,i,r)=>{let a=e.inputs.length===1?i:Ui(e.inputs,i),n=a.axes;n.length===0&&!a.noopWithEmptyAxes&&(n=e.inputs[0].dims.map((h,f)=>f));let s=k.normalizeAxes(n,e.inputs[0].dims.length),o=s,u=e.inputs[0],l=ln(o,e.inputs[0].dims.length);l.length>0&&(u=e.compute($e(e.inputs[0],l),{inputs:[0],outputs:[-1]})[0],o=nn(o.length,u.dims.length));let[d,p]=sn(u.dims,o),c=d;a.keepDims&&(c=on(d,s)),e.compute(dn(t,a.cacheKey,[u],r,e.inputs[0].dataType,c,p),{inputs:[u]})},pn=(e,t)=>{Ce(e,"ReduceMeanShared",t,"mean")},cn=(e,t)=>{Ce(e,"ReduceL1Shared",t,"l1")},hn=(e,t)=>{Ce(e,"ReduceL2Shared",t,"l2")},fn=(e,t)=>{Ce(e,"ReduceLogSumExpShared",t,"logSumExp")},mn=(e,t)=>{Ce(e,"ReduceMaxShared",t,"max")},gn=(e,t)=>{Ce(e,"ReduceMinShared",t,"min")},_n=(e,t)=>{Ce(e,"ReduceProdShared",t,"prod")},yn=(e,t)=>{Ce(e,"ReduceSumShared",t,"sum")},$n=(e,t)=>{Ce(e,"ReduceSumSquareShared",t,"sumSquare")},wn=(e,t)=>{Ce(e,"ReduceLogSumShared",t,"logSum")}}),Oe,bn,Nt,Ui,Ae,vn,xn,kn,Sn,In,Tn,zn,En,Cn,On,Be,An,Bn,Rn,Dn,Mn,Un,Pn,qn,Nn,Vn,Pi=T(()=>{N(),W(),re(),G(),bp(),Oe=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},bn=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Nt=(e,t,i,r,a,n,s=!1,o=!1)=>{let u=[],l=i[0].dims,d=l.length,p=k.normalizeAxes(a,d),c=!o&&p.length===0;l.forEach((g,y)=>{c||p.indexOf(y)>=0?s&&u.push(1):u.push(g)});let h=u.length,f=k.size(u);return{name:e,shaderCache:t,getShaderSource:g=>{let y=[],_=S("_A",i[0].dataType,d),m=B("output",n,h),w=r(_,m,p),$=w[2];for(let b=0,x=0;b<d;b++)c||p.indexOf(b)>=0?(s&&x++,$=`for(var j${b}: u32 = 0; j${b} < ${l[b]}; j${b}++) {
...
`)}
}`},getRunData:()=>({outputs:[{dims:u,dataType:n}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:[{type:12,data:f},...M(l,u)]})}},Ui=(e,t)=>{let i=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(r=>i.push(Number(r))),Q({axes:i,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},Ae=(e,t,i,r)=>{let a=e.inputs,n=a.length===1?i:Ui(a,i);e.compute(Nt(t,{hint:n.cacheKey,inputDependencies:["rank"]},[a[0]],n.noopWithEmptyAxes&&n.axes.length===0?bn:r,n.axes,a[0].dataType,n.keepDims,n.noopWithEmptyAxes),{inputs:[0]})},vn=(e,t)=>{Oe(e.inputs),Ae(e,"ReduceLogSum",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${i.getByIndices("input_indices")};`,"value = log(value);"])},xn=(e,t)=>{Oe(e.inputs),Ae(e,"ReduceL1",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += abs(${i.getByIndices("input_indices")});`,""])},kn=(e,t)=>{Oe(e.inputs),Ae(e,"ReduceL2",t,(i,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${i.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])},Sn=(e,t)=>{Oe(e.inputs),Ae(e,"ReduceLogSumExp",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += exp(${i.getByIndices("input_indices")});`,"value = log(value);"])},In=(e,t)=>{Oe(e.inputs),Ae(e,"ReduceMax",t,(i,r,a)=>{let n=[];for(let s=0;s<i.rank;s++)(a.indexOf(s)>=0||a.length===0)&&n.push(i.indicesSet("input_indices",s,0));return[`${n.join(`
`)}`,`var value = ${i.getByIndices("input_indices")};`,`value = max(value, ${i.getByIndices("input_indices")});`,""]})},Tn=(e,t)=>{Oe(e.inputs),Ae(e,"ReduceMean",t,(i,r,a)=>{let n=1;for(let s=0;s<i.rank;s++)(a.indexOf(s)>=0||a.length===0)&&(n*=e.inputs[0].dims[s]);return["var sum = f32(0);","",`sum += f32(${i.getByIndices("input_indices")});`,`let value = ${r.type.value}(sum / ${n});`]})},zn=(e,t)=>{Oe(e.inputs),Ae(e,"ReduceMin",t,(i,r,a)=>{let n=[];for(let s=0;s<i.rank;s++)(a.indexOf(s)>=0||a.length===0)&&n.push(`input_indices[${s}] = 0;`);return[`${n.join(`
`)}`,`var value = ${i.getByIndices("input_indices")};`,`value = min(value, ${i.getByIndices("input_indices")});`,""]})},En=(e,t)=>{Oe(e.inputs),Ae(e,"ReduceProd",t,(i,r)=>[`var value = ${r.type.storage}(1);`,"",`value *= ${i.getByIndices("input_indices")};`,""])},Cn=(e,t)=>{Oe(e.inputs),Ae(e,"ReduceSum",t,(i,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${i.getByIndices("input_indices")};`,""])},On=(e,t)=>{Oe(e.inputs),Ae(e,"ReduceSumSquare",t,(i,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${i.getByIndices("input_indices")}; value += t * t;`,""])},Be=(e,t,i)=>{if(t.length===0)return i;let r=1,a=1;for(let n=0;n<t.length;n++)t.indexOf(n)===-1?r*=e[n]:a*=e[n];return a<32&&r>1024},An=(e,t)=>{Be(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Tn(e,t):pn(e,t)},Bn=(e,t)=>{Be(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?xn(e,t):cn(e,t)},Rn=(e,t)=>{Be(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?kn(e,t):hn(e,t)},Dn=(e,t)=>{Be(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Sn(e,t):fn(e,t)},Mn=(e,t)=>{Be(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?In(e,t):mn(e,t)},Un=(e,t)=>{Be(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?zn(e,t):gn(e,t)},Pn=(e,t)=>{Be(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?En(e,t):_n(e,t)},qn=(e,t)=>{Be(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Cn(e,t):yn(e,t)},Nn=(e,t)=>{Be(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?On(e,t):$n(e,t)},Vn=(e,t)=>{Be(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?vn(e,t):wn(e,t)}}),qi,Ln,Wn,Ni,vp=T(()=>{N(),re(),Pi(),qi=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},Ln=(e,t)=>{qi(e.inputs);let i=(r,a,n)=>{let s=[];for(let o=0;o<r.rank;o++)(n.indexOf(o)>=0||n.length===0)&&s.push(`input_indices[${o}] = 0;`);return[`${s.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?"<=":"<"} value) {
value = ${r.getByIndices("input_indices")};
best_index = i32(last_index);
}`,"",a.setByOffset("global_idx","best_index")]};e.compute(Nt("ArgMin",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],i,[t.axis],7,t.keepDims),{inputs:[0]})},Wn=(e,t)=>{qi(e.inputs);let i=(r,a,n)=>{let s=[];for(let o=0;o<r.rank;o++)(n.indexOf(o)>=0||n.length===0)&&s.push(`input_indices[${o}] = 0;`);return[`${s.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
value = ${r.getByIndices("input_indices")};
best_index = i32(last_index);
}`,"",a.setByOffset("global_idx","best_index")]};e.compute(Nt("argMax",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],i,[t.axis],7,t.keepDims),{inputs:[0]})},Ni=e=>Q(e)}),Gn,Vt,Hn,Fn,jn,gt,Kn,Zn,Vi=T(()=>{N(),W(),Ci(),G(),Gn=(e,t)=>{let i=e[0],r=e[1],a=e[2],n=e[3],s=e[4],o=e[5];if(s&&o)throw new Error("Attention cannot have both past and attention_bias");if(i.dims.length!==3)throw new Error('Input "input" must have 3 dimensions');let u=i.dims[0],l=i.dims[1],d=i.dims[2];if(a.dims.length!==1)throw new Error('Input "bias" is expected to have 1 dimensions');if(r.dims.length!==2)throw new Error('Input "weights" is expected to have 2 dimensions');if(r.dims[0]!==d)throw new Error("Input 1 dimension 0 should have same length as dimension 2 of input 0");if(a.dims[0]!==r.dims[1])throw new Error('Input "bias" dimension 0 should have same length as dimension 1 of input "weights"');let p=a.dims[0]/3,c=p,h=c;if(t.qkvHiddenSizes.length>0){if(t.qkvHiddenSizes.length!==3)throw new Error("qkv_hidden_sizes attribute should have 3 elements");for(let w of t.qkvHiddenSizes)if(w%t.numHeads!==0)throw new Error("qkv_hidden_sizes should be divisible by num_heads");p=t.qkvHiddenSizes[0],c=t.qkvHiddenSizes[1],h=t.qkvHiddenSizes[2]}let f=l;if(p!==c)throw new Error("qkv_hidden_sizes first element should be same as the second");if(a.dims[0]!==p+c+h)throw new Error('Input "bias" dimension 0 should have same length as sum of Q/K/V hidden sizes');let g=0;if(s){if(c!==h)throw new Error('Input "past" expect k_hidden_size == v_hidden_size');if(s.dims.length!==5)throw new Error('Input "past" must have 5 dimensions');if(s.dims[0]!==2)throw new Error('Input "past" first dimension must be 2');if(s.dims[1]!==u)throw new Error('Input "past" second dimension must be batch_size');if(s.dims[2]!==t.numHeads)throw new Error('Input "past" third dimension must be num_heads');if(s.dims[4]!==c/t.numHeads)throw new Error('Input "past" fifth dimension must be k_hidden_size / num_heads');t.pastPresentShareBuffer||(g=s.dims[3])}let y=f+g,_=-1,m=0;if(n)throw new Error("Mask not supported");if(s)throw new Error("past is not supported");if(o){if(o.dims.length!==4)throw new Error('Input "attention_bias" must have 4 dimensions');if(o.dims[0]!==u||o.dims[1]!==t.numHeads||o.dims[2]!==l||o.dims[3]!==y)throw new Error('Expect "attention_bias" shape (batch_size, num_heads, sequence_length, total_sequence_length)')}return{batchSize:u,sequenceLength:l,pastSequenceLength:g,kvSequenceLength:f,totalSequenceLength:y,maxSequenceLength:_,inputHiddenSize:d,hiddenSize:p,vHiddenSize:h,headSize:Math.floor(p/t.numHeads),vHeadSize:Math.floor(h/t.numHeads),numHeads:t.numHeads,isUnidirectional:!1,pastPresentShareBuffer:!1,maskFilterValue:t.maskFilterValue,maskType:m,scale:t.scale,broadcastResPosBias:!1,passPastInKv:!1,qkvFormat:1}},Vt=(e,t,i)=>t&&e?`
...
}`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${r}_${s}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:m,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l?[{type:12,data:u},...M(n)]:[{type:12,data:u}]})}},Yn=e=>Q(e),Jn=(e,t)=>{let{inputs:i,outputCount:r}=e,a=Yn({...t,outputCount:r});if(ee.webgpu.validateInputContent&&Qn(i,a),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Xn(i,a))}}),es,ts,is,kp=T(()=>{W(),G(),es=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},ts=e=>{let t=e[0].dims,i=e[0].dims[2],r=k.size(t)/4,a=e[0].dataType,n=S("input",a,t,4),s=S("bias",a,[i],4),o=S("residual",a,t,4),u=B("output",a,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:l=>`
...
}`}},is=e=>{es(e.inputs),e.compute(ts(e.inputs))}}),rs,K,as,ns,ss,os,us,ls,ds,ps,cs,hs,fs,ms,gs,_s,_t,ys,Lt,$s,ws,bs,vs,xs,ks,Ss,Is,Ts,zs,Es,Cs,Os,As,Bs,Rs,Li,Ds,Wi,Gi,Ms,Us,Ps,qs,Ns,Vs,Hi=T(()=>{N(),W(),re(),G(),rs=(e,t,i,r,a,n,s)=>{let o=Math.ceil(t/4),u="";typeof a=="string"?u=`${a}(a)`:u=a("a");let l=S("inputData",i,[o],4),d=B("outputData",r,[o],4),p=[{name:"vec_size",type:"u32"}];return s&&p.push(...s),`
...
}`},K=(e,t,i,r,a,n=e.dataType,s,o)=>{let u=[{type:12,data:Math.ceil(k.size(e.dims)/4)}];return s&&u.push(...s),{name:t,shaderCache:{hint:a,inputDependencies:["type"]},getShaderSource:l=>rs(l,k.size(e.dims),e.dataType,n,i,r,o),getRunData:l=>({outputs:[{dims:e.dims,dataType:n}],dispatchGroup:{x:Math.ceil(k.size(l[0].dims)/64/4)},programUniforms:u})}},as=e=>{e.compute(K(e.inputs[0],"Abs","abs"))},ns=e=>{e.compute(K(e.inputs[0],"Acos","acos"))},ss=e=>{e.compute(K(e.inputs[0],"Acosh","acosh"))},os=e=>{e.compute(K(e.inputs[0],"Asin","asin"))},us=e=>{e.compute(K(e.inputs[0],"Asinh","asinh"))},ls=e=>{e.compute(K(e.inputs[0],"Atan","atan"))},ds=e=>{e.compute(K(e.inputs[0],"Atanh","atanh"))},ps=e=>Q(e),cs=(e,t)=>{let i;switch(t.to){case 10:i="vec4<f16>";break;case 1:i="vec4<f32>";break;case 12:i="vec4<u32>";break;case 6:i="vec4<i32>";break;case 9:i="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(K(e.inputs[0],"Cast",i,void 0,t.cacheKey,t.to))},hs=e=>{let t,i,r=e.length>=2&&e[1].data!==0,a=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,i=a?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,i=a?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return Q({min:t,max:i})},fs=(e,t)=>{let i=t||hs(e.inputs),r=pe(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Clip",a=>`clamp(${a}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,i.cacheKey,void 0,[{type:e.inputs[0].dataType,data:i.min},{type:e.inputs[0].dataType,data:i.max}],[{name:"min",type:r},{name:"max",type:r}]),{inputs:[0]})},ms=e=>{e.compute(K(e.inputs[0],"Ceil","ceil"))},gs=e=>{e.compute(K(e.inputs[0],"Cos","cos"))},_s=e=>{e.compute(K(e.inputs[0],"Cosh","cosh"))},_t=e=>Q(e),ys=(e,t)=>{let i=pe(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
}`,$s=e=>{let t=pe(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Erf",i=>`erf_vf32(${i})`,Lt(t)))},ws=e=>{e.compute(K(e.inputs[0],"Exp","exp"))},bs=e=>{e.compute(K(e.inputs[0],"Floor","floor"))},vs=e=>{let t=pe(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Gelu",i=>`0.5 * ${i} * (1.0 + erf_vf32(${i} * 0.7071067811865475))`,Lt(t)))},xs=(e,t)=>{let i=pe(e.inputs[0].dataType);e.compute(K(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${t.alpha});`,t.cacheKey))},ks=e=>{e.compute(K(e.inputs[0],"Not",t=>`!${t}`))},Ss=e=>{e.compute(K(e.inputs[0],"Neg",t=>`-${t}`))},Is=e=>{e.compute(K(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Ts=e=>{let t=pe(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Relu",i=>`select(vec4<${t}>(0.0), ${i}, ${i} > vec4<${t}>(0.0))`))},zs=e=>{e.compute(K(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Es=e=>Q(e),Cs=(e,t)=>{let i=pe(e.inputs[0].dataType);e.compute(K(e.inputs[0],"HardSigmoid",r=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${t.alpha} * ${r} + vec4<${i}>(${t.beta})))`,void 0,t.cacheKey))},Os=e=>{e.compute(K(e.inputs[0],"Sin","sin"))},As=e=>{e.compute(K(e.inputs[0],"Sinh","sinh"))},Bs=e=>{e.compute(K(e.inputs[0],"Sqrt","sqrt"))},Rs=e=>{e.compute(K(e.inputs[0],"Tan","tan"))},Li=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Ds=e=>{e.compute(K(e.inputs[0],"Tanh",Li))},Wi=(e="f32")=>`
...
`,Gi=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Ms=e=>{let t=pe(e.inputs[0].dataType);e.compute(K(e.inputs[0],"FastGelu",Gi,Wi(t),void 0,e.inputs[0].dataType))},Us=(e,t)=>{let i=pe(e.inputs[0].dataType);return e.compute(K(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${i}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${i}>(${t.alpha});`,t.cacheKey)),0},Ps=e=>{e.compute(K(e.inputs[0],"Log","log"))},qs=(e,t)=>`
...
`,Ns=e=>`quick_gelu_impl(${e})`,Vs=(e,t)=>{let i=pe(e.inputs[0].dataType);e.compute(K(e.inputs[0],"QuickGelu",Ns,qs(i,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Ls,Ws,Gs,Sp=T(()=>{W(),G(),Hi(),Ls=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Ws=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let i=S("input",e[0].dataType,e[0].dims,4),r=S("bias",e[0].dataType,[e[0].dims[2]],4),a=B("output",e[0].dataType,t,4),n=k.size(t)/4,s=oe(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:o=>`
...
${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
${_}
}`},Fs=(e,t,i,r,a,n,s=i.dataType)=>{let o=i.dims.map(g=>Number(g)??1),u=r.dims.map(g=>Number(g)??1),l=!k.areEqual(o,u),d=o,p=k.size(o),c=!1,h=!1,f=[l];if(l){let g=st.calcShape(o,u,!1);if(!g)throw new Error("Can't perform binary op on the given tensors");d=g.slice(),p=k.size(d);let y=k.size(o)===1,_=k.size(u)===1,m=o.length>0&&o[o.length-1]%4===0,w=u.length>0&&u[u.length-1]%4===0;f.push(y),f.push(_),f.push(m),f.push(w);let $=1;for(let b=1;b<d.length;b++){let x=o[o.length-b],v=u[u.length-b];if(x===v)$*=x;else break}$%4===0?(h=!0,c=!0):(y||_||m||w)&&(c=!0)}else c=!0;return f.push(c),{name:e,shaderCache:{hint:t+f.map(g=>g.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:g=>Hs(g,o,u,d,c,l,h,a,i.dataType,r.dataType,s,n),getRunData:()=>({outputs:[{dims:d,dataType:s}],dispatchGroup:{x:Math.ceil(p/64/4)},programUniforms:[{type:12,data:Math.ceil(k.size(d)/4)},...M(o,u,d)]})}},Re=(e,t,i,r,a,n)=>{e.compute(Fs(t,a??"",e.inputs[0],e.inputs[1],i,r,n))},js=e=>{Re(e,"Add",(t,i)=>`${t}+${i}`)},Ks=e=>{Re(e,"Div",(t,i)=>`${t}/${i}`)},Zs=e=>{Re(e,"Equal",{scalar:(t,i)=>`u32(${t}==${i})`,vector:(t,i)=>`vec4<u32>(${t}==${i})`},void 0,void 0,9)},Qs=e=>{Re(e,"Mul",(t,i)=>`${t}*${i}`)},Xs=e=>{let t=S("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Re(e,"Pow",{scalar:(i,r)=>`pow_custom(${i},${r})`,vector:(i,r)=>`pow_vector_custom(${i},${r})`},`
...
`)},Ys=e=>{Re(e,"Sub",(t,i)=>`${t}-${i}`)},Js=e=>{Re(e,"Greater",{scalar:(t,i)=>`u32(${t}>${i})`,vector:(t,i)=>`vec4<u32>(${t}>${i})`},void 0,void 0,9)},eo=e=>{Re(e,"Less",{scalar:(t,i)=>`u32(${t}<${i})`,vector:(t,i)=>`vec4<u32>(${t}<${i})`},void 0,void 0,9)},to=e=>{Re(e,"GreaterOrEqual",{scalar:(t,i)=>`u32(${t}>=${i})`,vector:(t,i)=>`vec4<u32>(${t}>=${i})`},void 0,void 0,9)},io=e=>{Re(e,"LessOrEqual",{scalar:(t,i)=>`u32(${t}<=${i})`,vector:(t,i)=>`vec4<u32>(${t}<=${i})`},void 0,void 0,9)}}),ro,ao,no,so,oo,uo,Tp=T(()=>{N(),W(),re(),G(),ro=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let i=0,r=e[i],a=r.dataType,n=r.dims.length;e.forEach((s,o)=>{if(o!==i){if(s.dataType!==a)throw new Error("input tensors should be one type");if(s.dims.length!==n)throw new Error("input tensors should have the same shape");s.dims.forEach((u,l)=>{if(l!==t&&u!==r.dims[l])throw new Error("non concat dimensions must match")})}})},ao=(e,t)=>`
...
`)},so=(e,t,i,r)=>{let a=k.size(i),n=new Array(e.length),s=new Array(e.length),o=0,u=[],l=[],d=[{type:12,data:a}];for(let g=0;g<e.length;++g)o+=e[g].dims[t],n[g]=o,l.push(e[g].dims.length),s[g]=S(`input${g}`,r,l[g]),u.push("rank"),d.push({type:12,data:n[g]});for(let g=0;g<e.length;++g)d.push(...M(e[g].dims));d.push(...M(i));let p=B("output",r,i.length),c=p.indicesGet("indices",t),h=Array.from(Array(n.length).keys()).map(g=>`uniforms.sizeInConcatAxis${g}`).join(","),f=g=>`
...
${no(s,p)}
}`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:i,dataType:r}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:d}),getShaderSource:f}},oo=(e,t)=>{let i=e.inputs,r=i[0].dims,a=k.normalizeAxis(t.axis,r.length);ro(i,a);let n=r.slice();n[a]=i.reduce((o,u)=>o+(u.dims.length>a?u.dims[a]:0),0);let s=i.filter(o=>k.size(o.dims)>0);e.compute(so(s,a,n,i[0].dataType),{inputs:s})},uo=e=>Q({axis:e.axis})}),Qe,Xe,Ye,Fi,Je=T(()=>{N(),W(),Qe=(e,t,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${i}(uniforms.clip_min)), ${t}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
   value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
`;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Xe=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},Ye=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Fi=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[i,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:i,beta:r}}else if(t==="Clip"){let[i,r]=e?.activation_params||[Ca,Oa];return{activation:t,clipMax:r,clipMin:i}}else if(t==="LeakyRelu"){let[i]=e?.activation_params||[.01];return{activation:t,alpha:i}}return{activation:t}}}),ue,lo,ji=T(()=>{ue=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},lo=e=>`
...
`}),yt,Ki,Zi=T(()=>{N(),W(),G(),Je(),yt=(e,t,i,r,a)=>{let n=r-i;return`
...
`},Ki=(e,t,i,r,a=!1,n)=>{let s=e[0].dims,o=e[1].dims,u=s[s.length-2],l=o[o.length-1],d=s[s.length-1],p=ie(l),c=ie(d),h=ie(u),f=k.size(i)/p/h,g=e.length>2,y=r?r.slice(0,-2):i.slice(0,-2),_=[k.size(y),u,l],m=[{type:12,data:f},{type:12,data:u},{type:12,data:l},{type:12,data:d}];Xe(t,m),m.push(...M(y,s,o)),g&&m.push(...M(e[2].dims)),m.push(...M(_));let w=$=>{let b=Di("batch_dims",e[0].dataType,y.length),x=S("a",e[0].dataType,s.length,c),v=S("b",e[1].dataType,o.length,p),I=B("output",e[0].dataType,_.length,p),z=oe(I.type.tensor),O=Qe(t,I.type.value,z),V=[x,v],U="";if(g){let F=a?p:1;V.push(S("bias",e[2].dataType,e[2].dims.length,F)),U=`${a?`value += bias[col / ${F}];`:`value += ${I.type.value}(bias[row + i]);`}`}let L=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Ye(t,L);let A=()=>{let F=`var a_data: ${x.type.value};`;for(let q=0;q<c;q++)F+=`
...
`};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${p};${c};${h};${a}`,inputDependencies:g?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:m}),getShaderSource:w}}}),co,ho,Qi,Xi,fo,Yi,mo,Wt,Ji=T(()=>{N(),W(),G(),Je(),Zi(),ji(),co=(e,t)=>e?`
...
}`,Qi=(e,t,i="f32",r,a=!1,n=32,s=!1,o=32)=>{let u=t[1]*e[1],l=t[0]*e[0],d=a?u:n,p=a?n:u,c=d/t[0],h=n/t[1];if(!((a&&c===4&&e[1]===4||!a&&(c===3||c===4))&&d%t[0]===0&&n%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${a} is true, innerElementSize ${c} and workPerThread[1] ${e[1]} must be 4.
...
`},mo=(e,t,i,r,a=!1)=>{let[n,s,o,u]=r,l=oe(r[0].type.tensor);return`
...
`},Wt=(e,t,i,r,a=!1,n)=>{let s=e[0].dims,o=e[1].dims,u=s.slice(0,-2),l=o.slice(0,-2),d=r?r.slice(0,-2):i.slice(0,-2),p=k.size(d),c=s[s.length-2],h=s[s.length-1],f=o[o.length-1],g=h%4===0&&f%4===0,y=c<=8?[4,1,1]:[4,4,1],_=[8,8,1],m=[Math.ceil(f/_[0]/y[0]),Math.ceil(c/_[1]/y[1]),Math.ceil(p/_[2]/y[2])],w=g?4:1,$=[...u,c,h/w],b=$.length,x=[...l,h,f/w],v=x.length,I=[p,c,f/w],z=[{type:6,data:c},{type:6,data:f},{type:6,data:h}];Xe(t,z),z.push(...M(d,$,x));let O=["rank","rank"],V=e.length>2;V&&(z.push(...M(e[2].dims)),O.push("rank")),z.push(...M(I));let U=L=>{let A=d.length,F=Di("batchDims",e[0].dataType,A,1),q=oe(e[0].dataType),D=S("a",e[0].dataType,b,w),Z=S("b",e[1].dataType,v,w),P=B("result",e[0].dataType,I.length,w),te=[D,Z];if(V){let le=a?w:1;te.push(S("bias",e[2].dataType,e[2].dims.length,le))}let E=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];Ye(t,E);let C=oe(P.type.tensor),H=Qe(t,P.type.value,C),Y=mo(w,V,H,[F,D,Z,P],a);return`
${L.registerUniforms(E).registerInternalVariables(F).declareVariables(...te,P)}
${Y}
${g?Qi(y,_,q,F):Yi(y,_,q,F)}
        `};return{name:"MatMul",shaderCache:{hint:`${y};${t.activation};${g};${a}`,inputDependencies:O},getRunData:()=>({outputs:[{dims:n?n(i):i,dataType:e[0].dataType}],dispatchGroup:{x:m[0],y:m[1],z:m[2]},programUniforms:z}),getShaderSource:U}}}),go,_o,Ep=T(()=>{N(),qe(),G(),Je(),ji(),zp(),Ji(),go=(e,t,i,r,a=!1,n,s=4,o=4,u=4,l="f32")=>{let d=z=>{switch(z){case 1:return"resData = x[xIndex];";case 3:return`resData = vec3<${l}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return"resData = x[xIndex / 4];";default:throw new Error(`innerElementSize ${z} is not supported.`)}},p=z=>{switch(z){case 1:return"return w[row * i32(uniforms.w_shape[3]) + colIn];";case 4:return"return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];";default:throw new Error(`innerElementSize ${z} is not supported.`)}},c=e?`
...
return ${ue(o,l)}(0.0);`,b=ue(u,l),x=ue(e?s:o,l),v=ue(e?o:s,l),I=Qe(n,b,l);return`
...
}`,E=S("x",e[0].dataType,e[0].dims.length,b===3?1:b),C=S("w",e[1].dataType,e[1].dims.length,Z),H=[E,C],Y=B("result",e[0].dataType,i.length,Z);if(s){let le=S("bias",e[2].dataType,e[2].dims.length,Z);H.push(le),te+=`
...
${te}
${go(l,z,O,V,s,t,U[0],U[1],U[2],P)}
${g?Qi(w,m,P,void 0,!l,I):Yi(w,m,P,void 0,!l,I,!1,void 0,o)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${b};${g};${z};${O};${V};${x};${v};${I}`,inputDependencies:A},getRunData:()=>({outputs:[{dims:u?u(i):i,dataType:e[0].dataType}],dispatchGroup:{x:$[0],y:$[1],z:$[2]},programUniforms:L}),getShaderSource:F}}}),yo,er,$t,$o,tr,wo,bo,vo,Cp=T(()=>{N(),qe(),W(),G(),Je(),ji(),yo=e=>{let t=1;for(let i=0;i<e.length;i++)t*=e[i];return t},er=e=>typeof e=="number"?[e,e,e]:e,$t=(e,t)=>t<=1?e:e+(e-1)*(t-1),$o=(e,t,i,r=1)=>{let a=$t(t,r);return Math.floor((e[0]*(i-1)-i+a)/2)},tr=(e,t,i,r,a)=>{a==null&&(a=$o(e,t[0],r[0]));let n=[0,0,0,i];for(let s=0;s<3;s++)e[s]+2*a>=t[s]&&(n[s]=Math.trunc((e[s]-t[s]+2*a)/r[s]+1));return n},wo=(e,t,i,r,a,n,s,o,u,l)=>{let d,p,c,h;if(e==="VALID"&&(e=0),typeof e=="number"){d={top:e,bottom:e,left:e,right:e,front:e,back:e};let f=tr([t,i,r,1],[o,u,l],1,[a,n,s],e);p=f[0],c=f[1],h=f[2]}else if(Array.isArray(e)){if(!e.every((g,y,_)=>g===_[0]))throw Error(`Unsupported padding parameter: ${e}`);d={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let f=tr([t,i,r,1],[o,u,l],1,[a,n,s],e[0]);p=f[0],c=f[1],h=f[2]}else if(e==="SAME_UPPER"){p=Math.ceil(t/a),c=Math.ceil(i/n),h=Math.ceil(r/s);let f=(p-1)*a+o-t,g=(c-1)*n+u-i,y=(h-1)*s+l-r,_=Math.floor(f/2),m=f-_,w=Math.floor(g/2),$=g-w,b=Math.floor(y/2),x=y-b;d={top:w,bottom:$,left:b,right:x,front:_,back:m}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:d,outDepth:p,outHeight:c,outWidth:h}},bo=(e,t,i,r,a,n=!1,s="channelsLast")=>{let o,u,l,d,p;if(s==="channelsLast")[o,u,l,d,p]=e;else if(s==="channelsFirst")[o,p,u,l,d]=e;else throw new Error(`Unknown dataFormat ${s}`);let[c,,h,f,g]=t,[y,_,m]=er(i),[w,$,b]=er(r),x=$t(h,w),v=$t(f,$),I=$t(g,b),{padInfo:z,outDepth:O,outHeight:V,outWidth:U}=wo(a,u,l,d,y,_,m,x,v,I),L=n?c*p:c,A=[0,0,0,0,0];return s==="channelsFirst"?A=[o,L,O,V,U]:s==="channelsLast"&&(A=[o,O,V,U,L]),{batchSize:o,dataFormat:s,inDepth:u,inHeight:l,inWidth:d,inChannels:p,outDepth:O,outHeight:V,outWidth:U,outChannels:L,padInfo:z,strideDepth:y,strideHeight:_,strideWidth:m,filterDepth:h,filterHeight:f,filterWidth:g,effectiveFilterDepth:x,effectiveFilterHeight:v,effectiveFilterWidth:I,dilationDepth:w,dilationHeight:$,dilationWidth:b,inShape:e,outShape:A,filterShape:t}},vo=(e,t,i,r,a,n)=>{let s=n==="channelsLast";s?e[0].dims[3]:e[0].dims[1];let o=[64,1,1],u={x:i.map((y,_)=>_)},l=[Math.ceil(yo(u.x.map(y=>i[y]))/o[0]),1,1];j("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${l}`);let d=1,p=k.size(i),c=[{type:12,data:p},{type:12,data:r},{type:12,data:a},{type:12,data:t.strides},{type:12,data:t.dilations}];Xe(t,c),c.push(...M(e[0].dims,e[1].dims));let h=["rank","rank"],f=e.length===3;f&&(c.push(...M(e[2].dims)),h.push("rank")),c.push(...M(i));let g=y=>{let _=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:r.length},{name:"pads",type:"u32",length:a.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];Ye(t,_);let m=1,w=oe(e[0].dataType),$=S("x",e[0].dataType,e[0].dims.length,d),b=S("W",e[1].dataType,e[1].dims.length,m),x=[$,b],v=B("result",e[0].dataType,i.length,m),I="";if(f){let V=S("bias",e[2].dataType,e[2].dims.length,m);x.push(V),I+=`
fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${w} {
return bias[${s?R("coords",4,5):R("coords",1,5)}];
}`}let z=ue(d,w),O=Qe(t,z,w);return`
 ${I}
...
}`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${s};${d};${f}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:l[0],y:l[1],z:l[2]},programUniforms:c}),getShaderSource:g}}}),xo,ko,Op=T(()=>{N(),W(),G(),Je(),xo=(e,t,i,r)=>{let a=e.length>2,n=a?"value += b[output_channel];":"",s=e[0].dims,o=e[1].dims,u=t.format==="NHWC",l=u?i[3]:i[1],d=l/t.group,p=u&&d>=4?ie(l):1,c=k.size(i)/p,h=[{type:12,data:c},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:d}];Xe(t,h),h.push(...M(s,[o[0],o[1],o[2],o[3]/p]));let f=a?["rank","rank","rank"]:["rank","rank"];h.push(...M([i[0],i[1],i[2],i[3]/p]));let g=y=>{let _=B("output",e[0].dataType,i.length,p),m=oe(_.type.tensor),w=Qe(t,_.type.value,m),$=S("x",e[0].dataType,s.length),b=S("w",e[1].dataType,o.length,p),x=[$,b];a&&x.push(S("b",e[2].dataType,e[2].dims,p));let v=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];Ye(t,v);let I=u?`
...
}`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${p}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:h}),getShaderSource:g}},ko=(e,t,i,r)=>{let a=e.length>2,n=ie(i[3]),s=ie(i[2]),o=k.size(i)/n/s,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/n],l=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/n],d=[i[0],i[1],i[2],i[3]/n],p=[{type:12,data:o},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Xe(t,p),p.push(...M(u,l,d));let c=(s-1)*t.strides[1]+l[1],h=f=>{let g=B("output",e[0].dataType,d.length,n),y=oe(g.type.tensor),_=Qe(t,g.type.value,y),m=S("x",e[0].dataType,u.length,n),w=S("w",e[1].dataType,l.length,n),$=[m,w];a&&$.push(S("b",e[2].dataType,e[2].dims,n));let b=a?"value += b[output_channel];":"",x=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Ye(t,x),`
...
}`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${n};${s};${c};${l[0]};${l[1]}`,inputDependencies:a?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:p}),getShaderSource:h}}}),So,Gt,Io,Ht,ir,rr,To,zo,ar,Ap=T(()=>{W(),Ep(),Cp(),Ji(),Op(),Je(),Zi(),We(),So=(e,t,i,r,a,n)=>{let s=e[0],o=e.slice(n?1:2,n?3:4),u=o.length,l=t[0],d=t.slice(2).map((c,h)=>c+(c-1)*(i[h]-1)),p=o.map((c,h)=>c+r[h]+r[h+u]).map((c,h)=>Math.floor((c-d[h]+a[h])/a[h]));return p.splice(0,0,s),p.splice(n?3:1,0,l),p},Gt=[2,3,1,0],Io=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let i=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[1]*t.group;if(i!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let a=e[0].dims.length-2;if(t.dilations.length!==a)throw new Error(`dilations should be ${a}D`);if(t.strides.length!==a)throw new Error(`strides should be ${a}D`);if(t.pads.length!==a*2)throw new Error(`pads should be ${a*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Ht=(e,t)=>{let i=e.kernelShape.slice();i.length<t[1].dims.length-2&&i.push(...Array(t[1].dims.length-2-i.length).fill(0));for(let n=2;n<t[1].dims.length;++n)i[n-2]===0&&(i[n-2]=t[1].dims[n]);let r=e.pads.slice();Mt.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,i,r,e.format==="NHWC",e.autoPad);let a=Object.assign({},e);return Object.assign(a,{kernelShape:i,pads:r}),a},ir=e=>{let t=Fi(e),i=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],a=e.dilations,n=e.group,s=e.kernel_shape,o=e.pads,u=e.strides,l=e.w_is_const();return{autoPad:r,format:i,dilations:a,group:n,kernelShape:s,pads:o,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},rr=(e,t,i,r)=>{let a=i.format==="NHWC",n=So(t[0].dims,t[1].dims,i.dilations,i.pads,i.strides,a);if(i.group!==1){let x=[t[0]];if(a){let v=e.kernelCustomData.wT??e.compute($e(t[1],Gt),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=v),x.push(v)}else x.push(t[1]);t.length===3&&x.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&a&&t[1].dims[0]===i.group&&t[1].dims[1]===1&&i.dilations[0]===1&&i.dilations[1]===1?e.compute(ko(x,i,n,r),{inputs:x}):e.compute(xo(x,i,n,r),{inputs:x});return}let s=t.length===3,o=t[0].dims[a?1:2],u=t[0].dims[a?2:3],l=t[0].dims[a?3:1],d=t[1].dims[2],p=t[1].dims[3],c=n[a?1:2],h=n[a?2:3],f=n[a?3:1],g=a&&d===o&&p===u&&i.pads[0]===0&&i.pads[1]===0;if(g||d===1&&p===1&&i.dilations[0]===1&&i.dilations[1]===1&&i.strides[0]===1&&i.strides[1]===1&&i.pads[0]===0&&i.pads[1]===0){let x=n[0],v,I,z,O=[];if(a){let L=e.kernelCustomData.wT??e.compute($e(t[1],Gt),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];if(i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=L),g){let A=o*u*l;v=t[0].reshape([1,x,A]),I=L.reshape([1,A,f]),z=[1,x,f]}else v=t[0].reshape([x,o*u,l]),I=L.reshape([1,l,f]),z=[x,c*h,f];O.push(v),O.push(I)}else v=t[0].reshape([x,l,o*u]),I=t[1].reshape([1,f,l]),z=[x,f,c*h],O.push(I),O.push(v);s&&O.push(t[2]);let V=z[2],U=O[0].dims[O[0].dims.length-1];V<8&&U<8?e.compute(Ki(O,i,n,z,a,r),{inputs:O}):e.compute(Wt(O,i,n,z,a,r),{inputs:O});return}let y=!0,_=e.kernelCustomData.wT??e.compute($e(t[1],Gt),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=_);let m=[t[0],_];s&&m.push(t[2]);let w=a?c*h:f,$=a?f:c*h,b=d*p*l;e.compute(_o(m,i,n,w,$,b,s,y,r),{inputs:m})},To=(e,t)=>{let i=t.format==="NHWC",r=[e.inputs[0].reshape(i?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let a=[0,t.pads[0],0,t.pads[1]],n=[1].concat(t.strides),s=[1].concat(t.dilations),o=[1].concat(t.kernelShape),u=Ht({...t,pads:a,strides:n,dilations:s,kernelShape:o},r);rr(e,r,u,l=>i?[l[0],l[2],l[3]]:[l[0],l[1],l[3]])},zo=(e,t,i)=>{let r=i.format==="NHWC"?"channelsLast":"channelsFirst",a=Ht(i,t),n=i.autoPad==="NOTSET"?i.pads:i.autoPad,s=bo(t[0].dims,t[1].dims,i.strides,i.dilations,n,!1,r);e.compute(vo(t,a,s.outShape,[s.filterDepth,s.filterHeight,s.filterWidth],[s.padInfo.front,s.padInfo.top,s.padInfo.left],r))},ar=(e,t)=>{if(Io(e.inputs,t),e.inputs[0].dims.length===3)To(e,t);else if(e.inputs[0].dims.length===5)zo(e,e.inputs,t);else{let i=Ht(t,e.inputs);rr(e,e.inputs,i)}}}),Eo,Bp=T(()=>{N(),qe(),W(),G(),Eo=(e,t,i)=>{let r=e.length>2,a=t.outputShape,n=t.format==="NHWC",s=t.group,o=e[1].dims,u=o[2]/s,l=o[3],d=n?ie(u):1,p=n&&l===1&&u>=4,c=p?Math.floor(u/4)*4:Math.floor(u/d)*d,h=u-c,f=n?ie(l):1,g=n?l===1?d:f:1,y=k.size(a)/f,_=[Math.ceil(y/64),1,1];j("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${_}`);let m=["rank","rank"],w=[t.strides[0],t.strides[1]],$=[t.kernelShape[n?1:2],t.kernelShape[n?2:3]],b=[t.dilations[0],t.dilations[1]],x=[$[0]+(t.dilations[0]<=1?0:(t.kernelShape[n?1:2]-1)*(t.dilations[0]-1)),$[1]+(t.dilations[1]<=1?0:(t.kernelShape[n?2:3]-1)*(t.dilations[1]-1))],v=[x[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),x[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],I=[{type:12,data:y},{type:12,data:w},{type:12,data:$},{type:12,data:b},{type:12,data:x},{type:6,data:v},{type:12,data:c},{type:12,data:u},{type:12,data:l},...M(e[0].dims,e[1].dims)];r&&(I.push(...M(e[2].dims)),m.push("rank")),I.push(...M(a));let z=O=>{let V=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:w.length},{name:"filter_dims",type:"u32",length:$.length},{name:"dilations",type:"u32",length:$.length},{name:"effective_filter_dims",type:"u32",length:x.length},{name:"pads",type:"i32",length:v.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],U=oe(e[0].dataType),L=n?1:2,A=n?2:3,F=n?3:1,q=S("W",e[1].dataType,e[1].dims.length,g),D=S("Dy",e[0].dataType,e[0].dims.length,d),Z=[D,q];r&&Z.push(S("bias",e[2].dataType,[a[F]].length,f));let P=B("result",e[0].dataType,a.length,f),te=()=>{let H="";if(p)d===4?H+=`
...
${C}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${d}${g}${f}${p}${h}`,inputDependencies:m},getRunData:()=>({dispatchGroup:{x:_[0],y:_[1],z:_[2]},outputs:[{dims:i?i(a):a,dataType:e[0].dataType}],programUniforms:I}),getShaderSource:z}}}),Co,Oo,Ao,nr,Bo,Ro,sr,Do,Mo,Rp=T(()=>{Bp(),Je(),We(),Co=(e,t,i,r,a,n)=>(e-1)*t+i+(r-1)*a+1-n,Oo=(e,t,i,r,a)=>{let n=Math.floor(e/2);t==="SAME_UPPER"?(i[r]=n,i[a]=e-n):t==="SAME_LOWER"&&(i[r]=e-n,i[a]=n)},Ao=(e,t,i,r,a,n,s,o,u,l)=>{let d=e.length-2,p=l.length===0;u.length<d&&u.push(...Array(d-u.length).fill(0));let c=e[0],h=t[o?3:1]*a;for(let f=0,g=e.length-d-(o?1:0);f<d;++f,++g){let y=e[g],_=p?y*s[f]:l[f],m=Co(y,s[f],n[f],t[g],i[f],_);Oo(m,r,n,f,f+d),p&&l.push(s[f]*(y-1)+u[f]+(t[g]-1)*i[f]+1-n[f]-n[f+d])}l.splice(0,0,c),l.splice(o?3:1,0,h)},nr=(e,t)=>{let i=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((p,c)=>p*c,1)===0){i.length=0;for(let p=2;p<t[1].dims.length;++p)i.push(t[1].dims[p])}let r=e.format==="NHWC";i.splice(0,0,t[1].dims[0]),i.splice(r?3:1,0,t[1].dims[1]);let a=e.pads.slice(),n=e.outputShape.slice(),s=e.outputPadding.slice(),o=t[0].dims,u=e.dilations.slice();if(u.reduce((p,c)=>p+c,0)===0){let p=t[0].dims.length-2;u=new Array(p).fill(1)}let l=e.strides.slice();if(l.reduce((p,c)=>p+c,0)===0){let p=t[0].dims.length-2;l=new Array(p).fill(1)}Ao(o,i,u,e.autoPad,e.group,a,l,r,s,n);let d=Object.assign({},e);return Object.assign(d,{kernelShape:i,pads:a,outputPadding:s,outputShape:n,dilations:u,strides:l}),d},Bo=e=>{let t=Fi(e),i=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],a=e.dilations,n=e.group,s=e.kernelShape,o=e.pads,u=e.strides,l=e.wIsConst(),d=e.outputPadding,p=e.outputShape;return{autoPad:r,format:i,dilations:a,group:n,kernelShape:s,outputPadding:d,outputShape:p,pads:o,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},Ro=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let i=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[0];if(i!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let a=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==a))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.reduce((s,o)=>s+o,0)>0&&t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.reduce((s,o)=>s+o,0)>0&&t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.reduce((s,o)=>s+o,0)>0&&t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.outputPadding.length!==n&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${n}D`);if(t.kernelShape.reduce((s,o)=>s+o,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},sr=(e,t,i,r)=>{let a=e.kernelCustomData.wT??e.compute($e(t[1],[2,3,0,1]),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=a);let n=[t[0],a];t.length===3&&n.push(t[2]),e.compute(Eo(n,i,r),{inputs:n})},Do=(e,t)=>{let i=t.format==="NHWC",r=[e.inputs[0].reshape(i?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let a=t.kernelShape;(a.length===0||a[0]===0)&&(a=[e.inputs[1].dims[2]]);let n=t.dilations;(n.length===0||n[0]===0)&&(n=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let o=t.pads;o.length===0&&(o=[0,0]),o=[0,o[0],0,o[1]],s=[1].concat(s),n=[1].concat(n),a=[1].concat(a);let u=t.outputPadding;u=[0].concat(u);let l=nr({...t,pads:o,strides:s,dilations:n,kernelShape:a,outputPadding:u},r);sr(e,r,l,d=>i?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},Mo=(e,t)=>{if(Ro(e.inputs,t),e.inputs[0].dims.length===3)Do(e,t);else{let i=nr(t,e.inputs);sr(e,e.inputs,i)}}}),Uo,Po,qo,Dp=T(()=>{N(),W(),re(),G(),Uo=(e,t,i,r)=>{let a=k.size(t),n=t.length,s=S("input",e,n),o=B("output",e,n),u=i.dataType===6?i.getInt32Array()[0]:Number(i.getBigInt64Array()[0]),l=k.normalizeAxis(u,n),d=p=>{let c=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,h=R("uniforms.input_shape","uniforms.axis",n),f=r.reverse?c+(r.exclusive?" + 1":""):"0",g=r.reverse?h:c+(r.exclusive?"":" + 1");return`
     ...
     }`};return{name:"CumSum",shaderCache:{hint:r.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:[{type:12,data:a},{type:12,data:l},...M(t,t)]}),getShaderSource:d}},Po=(e,t)=>{let i=e.inputs[0].dims,r=e.inputs[0].dataType,a=e.inputs[1];e.compute(Uo(r,i,a,t),{inputs:[0]})},qo=e=>{let t=e.exclusive===1,i=e.reverse===1;return Q({exclusive:t,reverse:i})}}),No,Vo,Lo,Wo,Go,Mp=T(()=>{N(),W(),re(),G(),No=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},Vo=(e,t,i,r)=>{let a=[];a.push(`fn perm(i: ${r.type.indices}) -> ${i.type.indices} {
...
}`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:_=>{let m=u?[i,r*l,a*l,n/l**2]:[i,n/l**2,r*l,a*l],w=k.size(m),$=p.dims,b=k.sortBasedOnPerm($,o);return{outputs:[{dims:m,dataType:_[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:[{type:12,data:w},...M($,b)]}},getShaderSource:y}},Wo=(e,t)=>{No(e.inputs),e.compute(Lo(e.inputs[0],t))},Go=e=>Q({blocksize:e.blocksize,mode:e.mode,format:e.format})}),Ft,wt,or,Ho,Fo,jo,Ko,ur,Zo,Qo,Xo,Up=T(()=>{N(),W(),re(),G(),Ft="[a-zA-Z]|\\.\\.\\.",wt="("+Ft+")+",or="^"+wt+"$",Ho="("+wt+",)*"+wt,Fo="^"+Ho+"$",jo=class{constructor(e=-1){this.symbolToIndices=new Map,this.inputIndex=e}addSymbol(e,t){let i=this.symbolToIndices.get(e);i===void 0?i=[t]:i.push(t),this.symbolToIndices.set(e,i)}},Ko=class{constructor(e,t){this.equation=t,this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[i,r]=t.includes("->")?t.split("->",2):[t,""];if(!i.match(RegExp(Fo)))throw new Error("Invalid LHS term");if(i.split(",").forEach((a,n)=>{let s=e[n].dims.slice();if(!a.match(RegExp(or)))throw new Error("Invalid LHS term");let o=this.processTerm(a,!0,s,n);this.lhs.push(o)}),r==="")r+=[...this.symbolToInfo.entries()].filter(([a,n])=>n.count===1||a==="...").map(([a])=>a).join("");else if(!r.match(RegExp(wt)))throw new Error("Invalid RHS");r.match(RegExp(Ft,"g"))?.forEach(a=>{if(a==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let n=this.symbolToInfo.get(a);if(n===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(n.dimValue)}}),this.rhs=this.processTerm(r,!1,this.outputDims)}addSymbol(e,t,i){let r=this.symbolToInfo.get(e);if(r!==void 0){if(r.dimValue!==t&&r.count!==1)throw new Error("Dimension mismatch");r.count++,r.inputIndices.push(i)}else r={count:1,dimValue:t,inputIndices:[i]};this.symbolToInfo.set(e,r)}processTerm(e,t,i,r=-1){let a=i.length,n=!1,s=[],o=0;if(!e.match(RegExp(or))&&!t&&e!=="")throw new Error("Invalid LHS term");let u=e.match(RegExp(Ft,"g")),l=new jo(r);return u?.forEach((d,p)=>{if(d==="..."){if(n)throw new Error("Only one ellipsis is allowed per input term");n=!0;let c=a-u.length+1;if(c<0)throw new Error("Ellipsis out of bounds");if(s=i.slice(o,o+c),this.hasEllipsis){if(this.ellipsisDims.length!==s.length||this.ellipsisDims.toString()!==s.toString())throw new Error("Ellipsis dimensions mismatch")}else if(t)this.hasEllipsis=!0,this.ellipsisDims=s;else throw new Error("Ellipsis must be specified in the LHS");for(let h=0;h<s.length;h++){let f=String.fromCharCode(48+h);l.addSymbol(f,p+h),this.addSymbol(f,i[o++],r)}}else l.addSymbol(d,p+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(d,i[o++],r)}),l}},ur=e=>e+"_max",Zo=(e,t,i,r)=>{let a=e.map(l=>l.length).map((l,d)=>S(`input${d}`,t,l)),n=k.size(r),s=B("output",t,r.length),o=[...i.symbolToInfo.keys()].filter(l=>!i.rhs.symbolToIndices.has(l)),u=l=>{let d=[],p="var prod = 1.0;",c="var sum = 0.0;",h="sum += prod;",f=[],g=[],y=[],_=[],m=i.symbolToInfo.size===i.rhs.symbolToIndices.size;i.symbolToInfo.forEach(($,b)=>{if(i.rhs.symbolToIndices.has(b)){let x=i.rhs.symbolToIndices.get(b)?.[0];x!==void 0&&i.lhs.forEach((v,I)=>{if($.inputIndices.includes(I)){let z=v.symbolToIndices.get(b);if(z===void 0)throw new Error("Invalid symbol error");z.forEach(O=>{d.push(`${a[I].indicesSet(`input${I}Indices`,O,s.indicesGet("outputIndices",x))}`)})}})}else i.lhs.forEach((x,v)=>{if($.inputIndices.includes(v)){let I=x.symbolToIndices.get(b);if(I===void 0)throw new Error("Invalid symbol error");I.forEach(z=>{f.push(`${a[v].indicesSet(`input${v}Indices`,z,`${b}`)}`)}),_.push(`prod *= ${a[v].getByIndices(`input${v}Indices`)};`)}}),g.push(`for(var ${b}: u32 = 0; ${b} < uniforms.${ur(b)}; ${b}++) {`),y.push("}")});let w=m?[...d,`let sum = ${a.map(($,b)=>$.getByIndices(`input${b}Indices`)).join(" * ")};`]:[...d,c,...g,...f,p,..._,h,...y];return`
 ${l.registerUniforms(o.map($=>({name:`${ur($)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...a,s)}
...
${f}`},d=[{type:12,data:u},...M(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${s}${o}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d})}},tu=e=>{Yo(e.inputs),e.compute(eu(e.inputs),{inputs:[0]})}}),iu,ru,qp=T(()=>{N(),W(),G(),Hi(),iu=e=>{let t=e[0].dataType,i=k.size(e[0].dims),r=k.size(e[1].dims),a=r%4===0,n=s=>{let o=S("x",t,[1],4),u=S("bias",t,[1],4),l=B("y",t,[1],4),d=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],p=h=>`
...
${c}
let x_in = x + bias;
${l.setByOffset("global_idx",Gi("x_in"))}
}`};return{name:"FastGeluWithBias",shaderCache:{hint:`${a}`,inputDependencies:["type","type"]},getShaderSource:n,getRunData:s=>({outputs:[{dims:s[0].dims,dataType:s[0].dataType}],programUniforms:[{type:12,data:Math.ceil(i/4)},{type:12,data:r}],dispatchGroup:{x:Math.ceil(i/ot/4)}})}},ru=e=>{e.inputs.length<2||k.size(e.inputs[1].dims)===0?Ms(e):e.compute(iu(e.inputs))}}),au,nu,su,ou,Np=T(()=>{N(),W(),re(),G(),au=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},nu=(e,t)=>{let i=e[0].dims,r=e[1].dims,a=i.length,n=k.normalizeAxis(t.axis,a),s=i.slice(0);s.splice(n,1,...r);let o=i[n],u=e[0].dataType===9?4:1,l=Math.ceil(k.size(s)/u),d=[{type:12,data:l},{type:6,data:o},{type:12,data:n},...M(e[0].dims,e[1].dims,s)],p=c=>{let h=S("data",e[0].dataType,e[0].dims.length,u),f=S("inputIndices",e[1].dataType,e[1].dims.length),g=B("output",e[0].dataType,s.length,u),y=m=>{let w=r.length,$=`var indicesIndices${m}  = ${f.type.indices}(0);`;for(let b=0;b<w;b++)$+=`${w>1?`indicesIndices${m}[${b}]`:`indicesIndices${m}`} = ${s.length>1?`outputIndices${m}[uniforms.axis + ${b}]`:`outputIndices${m}`};`;$+=`
...
}`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((h,f)=>f!==1).map(h=>h.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(h,f)=>"rank")},getRunData:()=>({outputs:[{dims:o,dataType:l}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:c}},hu=(e,t)=>{let i=e.inputs;pu(i,t),e.compute(cu(e.inputs,t))},fu=e=>Q({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),mu,gu,_u,yu,Wp=T(()=>{N(),W(),re(),G(),mu=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
          indices input tensors be of same rank.`)},gu=(e,t)=>{let i=e[0].dims,r=e[0].dataType,a=i.length,n=e[1].dims,s=e[1].dataType,o=k.normalizeAxis(t.axis,a),u=i[o],l=n.slice(0),d=k.size(l),p=S("input",r,a),c=S("indicesInput",s,n.length),h=B("output",r,l.length),f=[{type:12,data:d},{type:6,data:u},{type:12,data:o}];return f.push(...M(i,n,l)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:f}),getShaderSource:g=>`
...
}`};return p?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:l*d},programUniforms:h}),getShaderSource:y}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:h}),getShaderSource:g}},bu=e=>{let t=e.transA,i=e.transB,r=e.alpha,a=e.beta;return{transA:t,transB:i,alpha:r,beta:a,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},vu=(e,t)=>{$u(e.inputs),e.compute(wu(e.inputs,t))}}),De,Ne,et,tt,xu,ku,Su,Iu,Tu,zu,Eu,Cu,Ou,Au,Hp=T(()=>{N(),W(),re(),G(),[De,Ne,et,tt]=[0,1,2,3],xu=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},ku=`
...
}`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:o,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:d},{inputs:[t,i],outputs:[-1]})[0]},bt=(e,t,i,r,a,n,s,o)=>{let u=n;if(s&&k.size(s.dims)>0){if(r===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=Du(e,n,s,t,r,i*a,o),u=u.reshape([t,r,i,a]),i===1||r===1?u:e.compute($e(u,dr.perm),{inputs:[u],outputs:[-1]})[0]}else return n.dims.length===3&&(u=n.reshape([t,r,i,a])),i===1||r===1?u:e.compute($e(u,dr.perm),{inputs:[u],outputs:[-1]})[0]},Mu=(e,t)=>{let i=Bu(e.inputs,t),r=e.inputs[0],a=ce(e.inputs,1),n=ce(e.inputs,2),s=ce(e.inputs,3),o=ce(e.inputs,4),u=ce(e.inputs,5),l=ce(e.inputs,6),d=ce(e.inputs,7);if(r.dims.length===5)throw new Error("Packed QKV is not implemented");if(a?.dims.length===5)throw new Error("Packed KV is not implemented");let p=a&&n&&a.dims.length===4&&n.dims.length===4,c=bt(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,r,s,0);if(p)return gt(e,c,a,n,o,void 0,l,d,u,i);if(!a||!n)throw new Error("key and value must be provided");let h=bt(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.headSize,a,s,i.hiddenSize),f=bt(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.vHeadSize,n,s,2*i.hiddenSize);gt(e,c,h,f,o,void 0,l,d,u,i)}}),Pu,qu,Nu,Vu,pr,Lu,Wu,Gu=T(()=>{N(),W(),re(),G(),Pu=e=>{if(!e||e.length<1)throw new Error("too few inputs")},qu=(e,t)=>{let i=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(a=>i.push(Number(a))),r=i.length),Q({numOutputs:r,axis:t.axis,splitSizes:i})},Nu=e=>`
...
}`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:h,getRunData:()=>({outputs:l,dispatchGroup:{x:Math.ceil(r/64)},programUniforms:c})}},Lu=(e,t)=>{Pu(e.inputs);let i=e.inputs.length===1?t:qu(e.inputs,t);e.compute(pr(e.inputs,i),{inputs:[0]})},Wu=e=>{let t=e.axis,i=e.splitSizes,r=e.numOutputs<0?i.length:e.numOutputs;if(r!==i.length)throw new Error("numOutputs and splitSizes lengh must be equal");return Q({axis:t,numOutputs:r,splitSizes:i})}}),Hu,jt,Fu,ju=T(()=>{N(),W(),re(),G(),Hu=(e,t)=>{let[i,r,a,n]=e,{numHeads:s,rotaryEmbeddingDim:o}=t;if(i.dims.length!==3&&i.dims.length!==4)throw new Error(`Input 'x' is expected to have 3 or 4 dimensions, got ${i.dims.length}`);if(!k.areEqual(r.dims,[])&&!k.areEqual(r.dims,[1])&&r.dims.length!==2)throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${r.dims.length}`);if(a.dims.length!==2)throw new Error(`Input 'cos_cache' is expected to have 2 dimensions, got ${a.dims.length}`);if(n.dims.length!==2)throw new Error(`Input 'sin_cache' is expected to have 2 dimensions, got ${n.dims.length}`);if(!k.areEqual(a.dims,n.dims))throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");if(o>0&&s===0)throw new Error("num_heads must be provided if rotary_embedding_dim is specified");let u=i.dims[0],l=i.dims[i.dims.length-2],d=a.dims[0],p=k.sizeFromDimension(i.dims,1)/l,c=o===0?a.dims[1]*2:p/s;if(o>c)throw new Error("rotary_embedding_dim must be less than or equal to head_size");if(r.dims.length===2){if(u!==r.dims[0])throw new Error(`Input 'position_ids' dimension 0 should be of size batch_size, got ${r.dims[0]}`);if(l!==r.dims[1])throw new Error(`Input 'position_ids' dimension 1 should be of size sequence_length, got ${r.dims[1]}`)}if(c/2!==a.dims[1]&&o/2!==a.dims[1])throw new Error(`Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${a.dims[1]}`);if(l>d)throw new Error("Updating cos_cache and sin_cache in RotaryEmbedding is not currently supported")},jt=(e,t)=>{let{interleaved:i,numHeads:r,rotaryEmbeddingDim:a,scale:n}=t,s=e[0].dims[0],o=k.sizeFromDimension(e[0].dims,1),u=e[0].dims[e[0].dims.length-2],l=o/u,d=e[2].dims[1],p=a===0?d*2:l/r,c=new Array(s,u,l/p,p-d),h=k.computeStrides(c),f=[{type:1,data:n},{type:12,data:c},{type:12,data:h},...e[0].dims.length===3?new Array({type:12,data:[o,l,p,1]}):[],...e[0].dims.length===4?new Array({type:12,data:[o,p,u*p,1]}):[],...M(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)],g=y=>{let _=S("input",e[0].dataType,e[0].dims.length),m=S("position_ids",e[1].dataType,e[1].dims.length),w=S("cos_cache",e[2].dataType,e[2].dims.length),$=S("sin_cache",e[3].dataType,e[3].dims.length),b=B("output",e[0].dataType,e[0].dims.length);return y.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:c.length},{name:"global_strides",type:"u32",length:h.length},{name:"input_output_strides",type:"u32",length:h.length}]),`
...
`};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:n},getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:u}),getShaderSource:l}},Xu=(e,t)=>{let i=Ku(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let r=e.inputs[0],a=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,n=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,s=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,o=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,u=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,d=i.kvNumHeads?i.kvNumHeads:i.numHeads,p=Q({axis:2,numOutputs:3,splitSizes:[i.numHeads*i.headSize,d*i.headSize,d*i.headSize]}),[c,h,f]=!a&&!n?e.compute(pr([r],p),{inputs:[r],outputs:[-1,-1,-1]}):[r,a,n],g,y;if(t.doRotary){let $=e.compute(Qu(i.batchSize,i.sequenceLength,u,l),{inputs:[u,l],outputs:[-1]})[0],b=e.inputs[7],x=e.inputs[8],v=Q({interleaved:t.rotaryInterleaved!==0,numHeads:i.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),I=[c,$,b,x],z=[-1];g=e.compute(jt(I,v),{inputs:I,outputs:z})[0],I.splice(0,1,h);let O=Q({interleaved:t.rotaryInterleaved!==0,numHeads:i.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});y=e.compute(jt(I,O),{inputs:I,outputs:z})[0]}let _=bt(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,t.doRotary?g:c,void 0,0),m=cr(e,t.doRotary?y:h,i),w=cr(e,f,i);gt(e,_,m,w,void 0,void 0,s,o,void 0,i,u,l)}}),hr,Yu,Ju,el,jp=T(()=>{N(),W(),We(),G(),hr=(e,t,i,r,a,n,s,o)=>{let u=ie(n),l=u===1?"f32":`vec${u}f`,d=u===1?"vec2f":`mat2x${u}f`,p=a*s,c=64;p===1&&(c=256);let h=[a,s,n/u],f=[a,s,2],g=["rank","type","type"],y=[];y.push(...M(h,f));let _=m=>{let w=S("x",t.dataType,3,u),$=S("scale",i.dataType,i.dims),b=S("bias",r.dataType,r.dims),x=B("output",1,3,2),v=[w,$,b,x];return`
...
}`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${o};${c}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:f,dataType:1}],dispatchGroup:{x:p},programUniforms:y}),getShaderSource:_},{inputs:[t,i,r],outputs:[-1]})[0]},Yu=(e,t,i)=>{let r=t[0].dims,a=r,n=2,s=r[0],o=r[1],u=k.sizeFromDimension(r,n),l=ie(u),d=k.size(a)/l,p=hr(e,t[0],t[1],t[2],s,u,o,i.epsilon),c=[s,o,u/l],h=[s,o],f=["type","none"],g=y=>{let _=S("x",t[0].dataType,c.length,l),m=S("scale_shift",1,h.length,2),w=B("output",t[0].dataType,c.length,l),$=[_,m,w];return`
...
}`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:y},{inputs:[t[0],g]})},el=(e,t)=>{t.format==="NHWC"?Ju(e,e.inputs,t):Yu(e,e.inputs,t)}}),tl,il,rl,Kp=T(()=>{N(),W(),G(),tl=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},il=(e,t,i)=>{let r=t.simplified,a=e[0].dims,n=e[1],s=!r&&e[2],o=a,u=k.normalizeAxis(t.axis,a.length),l=k.sizeToDimension(a,u),d=k.sizeFromDimension(a,u),p=k.size(n.dims),c=s?k.size(s.dims):0;if(p!==d||s&&c!==d)throw new Error(`Size of X.shape()[axis:] == ${d}.
Size of scale and bias (if provided) must match this.
Got scale size of ${p} and bias size of ${c}`);let h=[];for(let b=0;b<a.length;++b)b<u?h.push(a[b]):h.push(1);let f=ie(d),g=["type","type"],y=[{type:12,data:l},{type:1,data:d},{type:12,data:Math.floor(d/f)},{type:1,data:t.epsilon}];s&&g.push("type");let _=i>1,m=i>2,w=b=>{let x=oe(e[0].dataType),v=[S("x",e[0].dataType,e[0].dims,f),S("scale",n.dataType,n.dims,f)];s&&v.push(S("bias",s.dataType,s.dims,f)),v.push(B("output",e[0].dataType,o,f)),_&&v.push(B("mean_data_output",1,h)),m&&v.push(B("inv_std_output",1,h));let I=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
${b.registerUniforms(I).declareVariables(...v)}
${b.mainStart()}
${b.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.norm_count")}
let offset = global_idx * uniforms.norm_size_vectorized;
var mean_vector = ${Ri("f32",f)};
var mean_square_vector = ${Ri("f32",f)};

for (var h: u32 = 0u; h < uniforms.norm_size_vectorized; h++) {
let value = ${ut(x,f,"x[h + offset]")};
mean_vector += value;
...
let f32input = ${ut(x,f,"x[j + offset]")};
let f32scale = ${ut(x,f,"scale[j]")};
...
}`},$=[{dims:o,dataType:e[0].dataType}];return _&&$.push({dims:h,dataType:1}),m&&$.push({dims:h,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${f};${i};${r}`,inputDependencies:g},getRunData:()=>({outputs:$,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:y}),getShaderSource:w}},rl=(e,t)=>{tl(e.inputs),e.compute(il(e.inputs,t,e.outputCount))}}),al,nl,Zp=T(()=>{W(),Zi(),Ji(),al=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},nl=e=>{al(e.inputs);let t=st.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let i=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(i<8&&r<8)e.compute(Ki(e.inputs,{activation:""},t));else{let a=t[t.length-2],n=k.size(e.inputs[0].dims.slice(0,-2)),s=k.size(e.inputs[1].dims.slice(0,-2));if(n!==1&&a===1&&s===1){let o=e.inputs[0].reshape([1,n,r]),u=e.inputs[1].reshape([1,r,i]),l=[1,n,i],d=[o,u];e.compute(Wt(d,{activation:""},t,l),{inputs:d})}else e.compute(Wt(e.inputs,{activation:""},t))}}}),sl,ol,ul,ll,dl,Qp=T(()=>{N(),W(),re(),G(),sl=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let i=e[0],r=i.dims.length;if(i.dims[r-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let a=Math.floor((t.k+t.blockSize-1)/t.blockSize),n=t.blockSize/8*t.bits,s=e[1];if(!k.areEqual(s.dims,[t.n,a,n]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let o=e[2].dims;if(k.size(o)!==t.n*a)throw new Error("scales input size error.");if(e.length===4){let u=e[3].dims,l=t.bits>4?t.n*a:t.n*Math.floor((a+1)/2);if(k.size(u)!==l)throw new Error("zeroPoints input size error.")}},ol=(e,t)=>{let i=e[0].dims,r=i.length,a=i[r-2],n=t.k,s=t.n,o=i.slice(0,r-2),u=k.size(o),l=e[1].dims[2]/4,d=e[0].dataType,p=ie(t.k),c=ie(l),h=ie(s),f=o.concat([a,s]),g=a>1&&s/h%2===0?2:1,y=k.size(f)/h/g,_=64,m=[],w=[u,a,n/p],$=k.convertShape(e[1].dims).slice();$.splice(-1,1,l/c),m.push(...M(w)),m.push(...M($)),m.push(...M(e[2].dims)),e.length===4&&m.push(...M(k.convertShape(e[3].dims)));let b=[u,a,s/h];m.push(...M(b));let x=v=>{let I=w.length,z=S("a",e[0].dataType,I,p),O=S("b",12,$.length,c),V=S("scales",e[2].dataType,e[2].dims.length),U=[z,O,V],L=e.length===4?S("zero_points",12,e[3].dims.length):void 0;L&&U.push(L);let A=b.length,F=B("output",e[0].dataType,A,h),q=oe(e[0].dataType),D=(()=>{switch(p){case 1:return`array<${q}, 8>`;case 2:return`mat4x2<${q}>`;case 4:return`mat2x4<${q}>`;default:throw new Error(`${p}-component is not supported.`)}})(),Z=()=>{let E=`
// reuse a data
...
}`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${p};${c};${h};${g};${_}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:f,dataType:d}],dispatchGroup:{x:y},programUniforms:m}),getShaderSource:x}},ul=(e,t)=>{let i=e[0].dims,r=i.length,a=i[r-2],n=t.k,s=t.n,o=i.slice(0,r-2),u=k.size(o),l=e[1].dims[2]/4,d=e[0].dataType,p=ie(t.k),c=ie(l),h=o.concat([a,s]),f=128,g=s%8===0?8:s%4===0?4:1,y=f/g,_=y*c*8,m=_/p,w=_/t.blockSize,$=k.size(h)/g,b=[],x=[u,a,n/p],v=k.convertShape(e[1].dims).slice();v.splice(-1,1,l/c),b.push(...M(x)),b.push(...M(v)),b.push(...M(e[2].dims)),e.length===4&&b.push(...M(k.convertShape(e[3].dims)));let I=[u,a,s];b.push(...M(I));let z=O=>{let V=x.length,U=S("a",e[0].dataType,V,p),L=S("b",12,v.length,c),A=S("scales",e[2].dataType,e[2].dims.length),F=[U,L,A],q=e.length===4?S("zero_points",12,e[3].dims.length):void 0;q&&F.push(q);let D=I.length,Z=B("output",e[0].dataType,D),P=oe(e[0].dataType),te=()=>{switch(p){case 1:return`
...
}`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${p};${c};${y};${g}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:h,dataType:d}],dispatchGroup:{x:$},programUniforms:b}),getShaderSource:z}},ll=(e,t)=>{sl(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(ul(e.inputs,t)):e.compute(ol(e.inputs,t))},dl=e=>Q(e)}),pl,cl,hl,fl,ml,gl,_l,yl,$l,Xp=T(()=>{N(),W(),G(),pl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},cl=(e,t,i)=>{let r="";for(let a=t-1;a>=0;--a)r+=`
...
`},ml=(e,t,i)=>{let r="";for(let a=t-1;a>=0;--a)r+=`
 ...
 `;return`
   ...
   ${r}
   value = x[offset];
`},gl=(e,t,i)=>{switch(i.mode){case 0:return cl(e,t,i.pads.length);case 1:return hl(e,t,i.pads.length);case 2:return fl(e,t,i.pads.length);case 3:return ml(e,t,i.pads.length);default:throw new Error("Invalid mode")}},_l=(e,t)=>{let i=k.padShape(e[0].dims.slice(),t.pads),r=e[0].dims,a=k.size(i),n=[{type:12,data:a},{type:6,data:t.pads}],s=e.length>=3&&e[2].data;t.mode===0&&n.push({type:s?e[2].dataType:1,data:t.value}),n.push(...M(e[0].dims,i));let o=["rank"],u=l=>{let d=B("output",e[0].dataType,i.length),p=S("x",e[0].dataType,r.length),c=p.type.value,h=gl(d,r.length,t),f=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&f.push({name:"constant_value",type:s?c:"f32"}),`
 ...
 ${e.mainStart()}
   ...
   output[global_idx] = value;
 }`}},_r=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,wl=e=>`${_r(e)};${e.countIncludePad}`,bl=e=>`${_r(e)};${e.storageOrder};${e.dilations}`,yr=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),$r=(e,t,i,r)=>{let[a,n]=fr(t,r,i),s=S("x",t.dataType,t.dims.length),o=s.type.value,u="value += x_val;",l="";a.countIncludePad?l+=`value /= ${o}(uniforms.kernelSize);`:l+=`value /= ${o}(i32(uniforms.kernelSize) - pad);`;let[d,p,c,h,f]=mr(n,a);d.push(...M(t.dims,n));let g=["rank"];return{name:e,shaderCache:{hint:`${r.cacheKey};${c};${h};${f}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:n,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(k.size(n)/64)},programUniforms:d}),getShaderSource:y=>gr(y,s,t.dims.length,n.length,a,u,l,0,p,c,h,f)}},vl=e=>{let t=e.count_include_pad!==0,i=yr(e);if(i.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let r={countIncludePad:t,...i,cacheKey:""};return{...r,cacheKey:wl(r)}},xl=(e,t)=>{vt(e.inputs),e.compute($r("AveragePool",e.inputs[0],!1,t))},wr={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},kl=e=>{let t=e.format;return{format:t,...wr,cacheKey:t}},Sl=(e,t)=>{vt(e.inputs),e.compute($r("GlobalAveragePool",e.inputs[0],!0,t))},br=(e,t,i,r)=>{let[a,n]=fr(t,r,i),s=`
value = max(x_val, value);
`,o="",u=S("x",t.dataType,t.dims.length),l=["rank"],[d,p,c,h,f]=mr(n,a);return d.push(...M(t.dims,n)),{name:e,shaderCache:{hint:`${r.cacheKey};${c};${h};${f}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:n,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(k.size(n)/64)},programUniforms:d}),getShaderSource:g=>gr(g,u,t.dims.length,n.length,a,s,o,t.dataType===10?-65504:-1e5,p,c,h,f)}},Il=(e,t)=>{vt(e.inputs),e.compute(br("MaxPool",e.inputs[0],!1,t))},Tl=e=>{let t=e.storage_order,i=e.dilations,r=yr(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let a={storageOrder:t,dilations:i,...r,cacheKey:""};return{...a,cacheKey:bl(a)}},zl=e=>{let t=e.format;return{format:t,...wr,cacheKey:t}},El=(e,t)=>{vt(e.inputs),e.compute(br("GlobalMaxPool",e.inputs[0],!0,t))}}),Cl,Ol,Al,Bl,Jp=T(()=>{N(),W(),re(),G(),Cl=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((i,r)=>i===e[2].dims[r]).reduce((i,r)=>i&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((a,n)=>n===t.axis||a===e[0].dims[n]).reduce((a,n)=>a&&n,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(i/r)||t.blockSize>Math.ceil(i/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Ol=(e,t)=>{let i=k.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,a=r===3,n=e[0].dims,s=e[1].dataType,o=k.size(n),u=r===3||r===2,l=u?[Math.ceil(k.size(e[0].dims)/4)]:e[0].dims,d=e[1].dims,p=e.length>2?e[2]:void 0,c=p?u?[Math.ceil(k.size(p.dims)/4)]:p.dims:void 0,h=d.length===0||d.length===1&&d[0]===1,f=h===!1&&d.length===1,g=ie(o),y=h&&(!u||g===4),_=y?g:1,m=y&&!u?g:1,w=S("input",u?12:r,l.length,m),$=S("scale",s,d.length),b=p?S("zero_point",u?12:r,c.length):void 0,x=B("output",s,n.length,_),v=[w,$];b&&v.push(b);let I=[l,d];p&&I.push(c);let z=[{type:12,data:o/_},{type:12,data:i},{type:12,data:t.blockSize},...M(...I,n)],O=V=>{let U=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
...
}`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getShaderSource:O,getRunData:()=>({outputs:[{dims:n,dataType:s}],dispatchGroup:{x:Math.ceil(o/_/64),y:1,z:1},programUniforms:z})}},Al=(e,t)=>{Cl(e.inputs,t),e.compute(Ol(e.inputs,t))},Bl=e=>Q({axis:e.axis,blockSize:e.blockSize})}),Rl,Dl,Ml,ec=T(()=>{ze(),N(),G(),Rl=(e,t,i)=>{let r=e===t,a=e<t&&i<0,n=e>t&&i>0;if(r||a||n)throw new Error("Range these inputs' contents are invalid.")},Dl=(e,t,i,r)=>{let a=Math.abs(Math.ceil((t-e)/i)),n=[a],s=a,o=[{type:12,data:s},{type:r,data:e},{type:r,data:i},...M(n)],u=l=>{let d=B("output",r,n.length),p=d.type.value,c=[{name:"outputSize",type:"u32"},{name:"start",type:p},{name:"delta",type:p}];return`
${l.registerUniforms(c).declareVariables(d)}
${l.mainStart()}
${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
output[global_idx] = uniforms.start + ${p}(global_idx) * uniforms.delta;
}`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:o})}},Ml=e=>{let t=0,i=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],i=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],i=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),ee.webgpu.validateInputContent&&Rl(t,i,r),e.compute(Dl(t,i,r,e.inputs[0].dataType),{inputs:[]})}}),Ul,vr,xr,Pl,ql,Nl,tc=T(()=>{N(),W(),re(),G(),Ul=(e,t,i,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let a=`{
     var oldValue = 0;
     loop {
       let newValueF32 =`,n=`;
   ...
   ${a}bitcast<${r}>(oldValue) + (${i})${n}`;case"max":return r==="i32"||r==="u32"?`atomicMax(&${t}, bitcast<${r}>(${i}));`:`
     ${a}max(bitcast<f32>(oldValue), (${i}))${n}`;case"min":return r==="i32"||r==="u32"?`atomicMin(&${t}, bitcast<${r}>(${i}));`:`${a}min(bitcast<${r}>(oldValue), (${i}))${n}`;case"mul":return`${a}(bitcast<${r}>(oldValue) * (${i}))${n}`;default:throw new Error(`Reduction ${e} is not supported.`)}},vr=(e,t)=>`${e===1?`
...
data_offset += u32((u32(index) * element_count_dim));`,xr=(e,t,i)=>`for (var i = 0u; i < uniforms.num_updates_elements; i++) {
let value = updates[uniforms.num_updates_elements * ${i?"global_idx":"idx"} + i];
${Ul(e.reduction,"output[data_offset + i]","value",t)}
}`,Pl=(e,t)=>{let i=e[0].dims,r=e[1].dims,a=i,n=1,s=Math.ceil(k.size(r)/n),o=r[r.length-1],u=k.sizeFromDimension(i,o),l=k.sizeFromDimension(r,0)/o,d=[{type:12,data:s},{type:12,data:o},{type:12,data:u},...M(e[1].dims,e[2].dims,a)],p=c=>{let h=S("indices",e[1].dataType,e[1].dims.length),f=S("updates",e[2].dataType,e[2].dims.length,n),g=t.reduction!=="none"&&t.reduction!==""?Ga("output",e[0].dataType,a.length):B("output",e[0].dataType,a.length,n);return`
...
${xr(t,g.type.value,!0)}
}`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d}),getShaderSource:p}},ql=e=>Q({reduction:e.reduction}),Nl=(e,t)=>{e.compute(Pl(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Vl,Ll,Wl,kr,Gl,Hl,Fl,jl,Kl,Zl,Ql,Xl,Sr,Yl,Jl,ed,td,id,rd,ad,ic=T(()=>{N(),W(),re(),G(),Vl=(e,t)=>{if(e.every(i=>i>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
}`},Jl=(e,t,i,r,a,n,s,o,u,l)=>{let d=i.length===2,[p,c]=d?[0,1]:[2,3],h=e.type.value,f=g=>{let y=g===p?"row":"col";return`
...
}`},td=(e,t,i,r,a,n)=>{let s=e.dims,o=Fl(n,t.axes,s.length),u=jl(s,r,a,t.axes),l=r.slice();r.length===0&&(l=s.map((m,w)=>m===0?1:u[w]/m),t.keepAspectRatioPolicy!=="stretch"&&(u=Kl(s,l,t)));let d=B("output",e.dataType,u.length),p=S("input",e.dataType,s.length),c=k.size(u),h=s.length===u.length&&s.every((m,w)=>m===u[w]),f=t.coordinateTransformMode==="tf_crop_and_resize",g=t.extrapolationValue,y=p.type.value,_=m=>`
${h?"":`
...
${(()=>{switch(t.mode){case"nearest":return`
   ...
   ${(()=>{if(s.length===2||s.length===4)return`${Yl(p,d,s,f,g)}`;if(s.length===3||s.length===5)return`${ed(p,d,s,f,g)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
 `;case"cubic":return`
...
}`},$=[{dims:o,dataType:e[0].dataType}];return i>1&&$.push({dims:d,dataType:1}),i>2&&$.push({dims:d,dataType:1}),i>3&&$.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${_};${h};${f};${g}`,inputDependencies:e.map((b,x)=>"type")},getShaderSource:w,getRunData:()=>({outputs:$,dispatchGroup:{x:Math.ceil(u/l)},programUniforms:m})}},od=(e,t)=>{nd(e.inputs);let i=[0];e.outputCount>1&&i.push(-3),e.outputCount>2&&i.push(-3),e.outputCount>3&&i.push(3),e.compute(sd(e.inputs,t,e.outputCount,!1),{outputs:i})}}),ud,xt,ld,Ir,dd,pd,cd,hd,ac=T(()=>{N(),W(),re(),G(),ud=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((i,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},xt=(e,t)=>{let i=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>i.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>i.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return i},ld=(e,t)=>{if(e.length>1){let i=xt(e,1),r=xt(e,2),a=xt(e,3);return a.length===0&&(a=[...Array(e[0].dims.length).keys()]),Q({starts:i,ends:r,axes:a})}else return t},Ir=(e,t,i,r,a)=>{let n=e;return e<0&&(n+=i[r[t]]),a[t]<0?Math.max(0,Math.min(n,i[r[t]]-1)):Math.max(0,Math.min(n,i[r[t]]))},dd=(e,t,i)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
var input_indices: ${e.type.indices};
var carry = 0u;
...
}`;return{name:"Slice",shaderCache:{hint:`${u.length}_${s.length}_${n.length}`,inputDependencies:["rank"]},getShaderSource:y,getRunData:()=>({outputs:[d],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:g})}},cd=(e,t)=>{ud(e.inputs,t);let i=ld(e.inputs,t);e.compute(pd(e.inputs,i),{inputs:[0]})},hd=e=>{let t=e.starts,i=e.ends,r=e.axes;return Q({starts:t,ends:i,axes:r})}}),fd,md,gd,_d,nc=T(()=>{N(),W(),re(),We(),G(),fd=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},md=(e,t)=>{let i=e.inputs[0],r=i.dims,a=k.size(r),n=r.length,s=k.normalizeAxis(t.axis,n),o=s<r.length-1,u,l=[];o?(l=Array.from({length:n},(v,I)=>I),l[s]=n-1,l[n-1]=s,u=e.compute($e(i,l),{inputs:[i],outputs:[-1]})[0]):u=i;let d=u.dims,p=d[n-1],c=a/p,h=ie(p),f=p/h,g=64;c===1&&(g=256);let y=(v,I)=>I===4?`max(max(${v}.x, ${v}.y), max(${v}.z, ${v}.w))`:I===2?`max(${v}.x, ${v}.y)`:I===3?`max(max(${v}.x, ${v}.y), ${v}.z)`:v,_=S("x",u.dataType,u.dims,h),m=B("result",u.dataType,u.dims,h),w=_.type.value,$=oe(u.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,b=v=>`
 ...
 * limitations under the License.
 * =============================================================================
 */typeof tp=="object"&&typeof Vr=="object"&&(Vr.exports=Jt);console.log("wow3");Jt.env.wasm.numThreads=4;self.onmessage=async he=>{const{type:se}=he.data;if(se==="createSession")try{const ae=performance.now(),fe=await Jt.InferenceSession.create("../../superpoint_lightglue_pipeline.ort.onnx"),we=performance.now();self.session=fe,self.postMessage({type:"sessionCreated",data:{sessionTime:we-ae}})}catch(ae){self.postMessage({type:"error",data:{message:ae.message}})}if(se==="runInference"){if(!self.session){self.postMessage({type:"error",data:{message:"Session is not initialized."}});return}try{const ae=["../../otwarcie_fabryczna_testowy.jpg","../../fabryczna_otwarcie_topo.jpg"],fe=await Promise.all(ae.map(nt=>bc(nt))),we=256,T=256,me=fe.map((nt,Et)=>wc(nt,we,T,Et)),at=new Float32Array([...me[0],...me[1]]),Ue={images:new Jt.Tensor("float32",at,[2,1,T,we])},be=performance.now(),Se=await self.session.run(Ue),zt=performance.now();self.postMessage({type:"inferenceComplete",data:{inferenceTime:zt-be,results:Se,images:fe,imgWidth:we,imgHeight:T}})}catch(ae){self.postMessage({type:"error",data:{message:ae.message}})}}};function wc(he,se,ae,fe){const T=new OffscreenCanvas(se,ae).getContext("2d");T.drawImage(he,0,0,se,ae);const me=T.getImageData(0,0,se,ae).data,at=new Float32Array(se*ae);for(let ge=0;ge<se*ae;ge++){const Ue=me[ge*4]/255,be=me[ge*4+1]/255,Se=me[ge*4+2]/255;at[ge]=.299*Ue+.587*be+.114*Se}return at}async function bc(he){const ae=await(await fetch(he)).blob();return await createImageBitmap(ae)}});export default vc();
