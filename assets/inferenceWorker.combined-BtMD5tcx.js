...
`,jn=(e,t,i,r,a,n,s,o)=>{let u=ie(s?1:n),l=64,d=n/u;d<l&&(l=32);let p=Math.ceil(n/u/l),c=[{type:12,data:t},{type:12,data:i},{type:12,data:r},{type:12,data:a},{type:12,data:d},{type:12,data:p}],h=se(e.dataType,u),f=he(1,u),g=["type"];s&&g.push("type"),o&&g.push("type");let y=_=>{let m=B("x",e.dataType,e.dims,u),w=[m],$=s?S("seq_lens",s.dataType,s.dims):void 0;$&&w.push($);let b=o?S("total_sequence_length_input",o.dataType,o.dims):void 0;b&&w.push(b);let x=he(e.dataType),v=[{name:"batch_size",type:"u32"},{name:"num_heads",type:"u32"},{name:"past_sequence_length",type:"u32"},{name:"sequence_length",type:"u32"},{name:"total_sequence_length",type:"u32"},{name:"elements_per_thread",type:"u32"}];return`
...
}`},K=(e,t,i,r,a,n=e.dataType,s,o)=>{let u=[{type:12,data:Math.ceil(k.size(e.dims)/4)}];return s&&u.push(...s),{name:t,shaderCache:{hint:a,inputDependencies:["type"]},getShaderSource:l=>ns(l,k.size(e.dims),e.dataType,n,i,r,o),getRunData:l=>({outputs:[{dims:e.dims,dataType:n}],dispatchGroup:{x:Math.ceil(k.size(l[0].dims)/64/4)},programUniforms:u})}},ss=e=>{e.compute(K(e.inputs[0],"Abs","abs"))},os=e=>{e.compute(K(e.inputs[0],"Acos","acos"))},us=e=>{e.compute(K(e.inputs[0],"Acosh","acosh"))},ls=e=>{e.compute(K(e.inputs[0],"Asin","asin"))},ds=e=>{e.compute(K(e.inputs[0],"Asinh","asinh"))},ps=e=>{e.compute(K(e.inputs[0],"Atan","atan"))},cs=e=>{e.compute(K(e.inputs[0],"Atanh","atanh"))},hs=e=>Q(e),fs=(e,t)=>{let i;switch(t.to){case 10:i="vec4<f16>";break;case 1:i="vec4<f32>";break;case 12:i="vec4<u32>";break;case 6:i="vec4<i32>";break;case 9:i="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(K(e.inputs[0],"Cast",i,void 0,t.cacheKey,t.to))},ms=e=>{let t,i,r=e.length>=2&&e[1].data!==0,a=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,i=a?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,i=a?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return Q({min:t,max:i})},gs=(e,t)=>{let i=t||ms(e.inputs),r=he(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Clip",a=>`clamp(${a}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,i.cacheKey,void 0,[{type:e.inputs[0].dataType,data:i.min},{type:e.inputs[0].dataType,data:i.max}],[{name:"min",type:r},{name:"max",type:r}]),{inputs:[0]})},_s=e=>{e.compute(K(e.inputs[0],"Ceil","ceil"))},ys=e=>{e.compute(K(e.inputs[0],"Cos","cos"))},$s=e=>{e.compute(K(e.inputs[0],"Cosh","cosh"))},_t=e=>Q(e),ws=(e,t)=>{let i=he(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
}`,bs=e=>{let t=he(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Erf",i=>`erf_vf32(${i})`,Wt(t)))},vs=e=>{e.compute(K(e.inputs[0],"Exp","exp"))},xs=e=>{e.compute(K(e.inputs[0],"Floor","floor"))},ks=e=>{let t=he(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Gelu",i=>`0.5 * ${i} * (1.0 + erf_vf32(${i} * 0.7071067811865475))`,Wt(t)))},Ss=(e,t)=>{let i=he(e.inputs[0].dataType);e.compute(K(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${t.alpha});`,t.cacheKey))},Is=e=>{e.compute(K(e.inputs[0],"Not",t=>`!${t}`))},Ts=e=>{e.compute(K(e.inputs[0],"Neg",t=>`-${t}`))},zs=e=>{e.compute(K(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Es=e=>{let t=he(e.inputs[0].dataType);e.compute(K(e.inputs[0],"Relu",i=>`select(vec4<${t}>(0.0), ${i}, ${i} > vec4<${t}>(0.0))`))},Cs=e=>{e.compute(K(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Os=e=>Q(e),As=(e,t)=>{let i=he(e.inputs[0].dataType);e.compute(K(e.inputs[0],"HardSigmoid",r=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${t.alpha} * ${r} + vec4<${i}>(${t.beta})))`,void 0,t.cacheKey))},Bs=e=>{e.compute(K(e.inputs[0],"Sin","sin"))},Rs=e=>{e.compute(K(e.inputs[0],"Sinh","sinh"))},Ds=e=>{e.compute(K(e.inputs[0],"Sqrt","sqrt"))},Ms=e=>{e.compute(K(e.inputs[0],"Tan","tan"))},Hi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Us=e=>{e.compute(K(e.inputs[0],"Tanh",Hi))},Fi=(e="f32")=>`
...
`,ji=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Ps=e=>{let t=he(e.inputs[0].dataType);e.compute(K(e.inputs[0],"FastGelu",ji,Fi(t),void 0,e.inputs[0].dataType))},qs=(e,t)=>{let i=he(e.inputs[0].dataType);return e.compute(K(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${i}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${i}>(${t.alpha});`,t.cacheKey)),0},Ns=e=>{e.compute(K(e.inputs[0],"Log","log"))},Vs=(e,t)=>`
...
`,Ls=e=>`quick_gelu_impl(${e})`,Ws=(e,t)=>{let i=he(e.inputs[0].dataType);e.compute(K(e.inputs[0],"QuickGelu",Ls,Vs(i,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Gs,Hs,Fs,Sp=T(()=>{W(),G(),Ki(),Gs=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Hs=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let i=S("input",e[0].dataType,e[0].dims,4),r=S("bias",e[0].dataType,[e[0].dims[2]],4),a=B("output",e[0].dataType,t,4),n=k.size(t)/4,s=se(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:o=>`
...
${oo(s,p)}
}`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:i,dataType:r}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:d}),getShaderSource:f}},lo=(e,t)=>{let i=e.inputs,r=i[0].dims,a=k.normalizeAxis(t.axis,r.length);no(i,a);let n=r.slice();n[a]=i.reduce((o,u)=>o+(u.dims.length>a?u.dims[a]:0),0);let s=i.filter(o=>k.size(o.dims)>0);e.compute(uo(s,a,n,i[0].dataType),{inputs:s})},po=e=>Q({axis:e.axis})}),Xe,Ye,Je,Zi,et=T(()=>{N(),W(),Xe=(e,t,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${i}(uniforms.clip_min)), ${t}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
   value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
`;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Ye=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},Je=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Zi=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[i,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:i,beta:r}}else if(t==="Clip"){let[i,r]=e?.activation_params||[Aa,Ba];return{activation:t,clipMax:r,clipMin:i}}else if(t==="LeakyRelu"){let[i]=e?.activation_params||[.01];return{activation:t,alpha:i}}return{activation:t}}}),oe,co,Qi=T(()=>{oe=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},co=e=>`
...
`}),yt,Xi,Yi=T(()=>{N(),W(),G(),et(),yt=(e,t,i,r,a)=>{let n=r-i;return`
...
`},Xi=(e,t,i,r,a=!1,n)=>{let s=e[0].dims,o=e[1].dims,u=s[s.length-2],l=o[o.length-1],d=s[s.length-1],p=ie(l),c=ie(d),h=ie(u),f=k.size(i)/p/h,g=e.length>2,y=r?r.slice(0,-2):i.slice(0,-2),_=[k.size(y),u,l],m=[{type:12,data:f},{type:12,data:u},{type:12,data:l},{type:12,data:d}];Ye(t,m),m.push(...M(y,s,o)),g&&m.push(...M(e[2].dims)),m.push(...M(_));let w=$=>{let b=Pi("batch_dims",e[0].dataType,y.length),x=S("a",e[0].dataType,s.length,c),v=S("b",e[1].dataType,o.length,p),I=B("output",e[0].dataType,_.length,p),z=se(I.type.tensor),O=Xe(t,I.type.value,z),V=[x,v],U="";if(g){let F=a?p:1;V.push(S("bias",e[2].dataType,e[2].dims.length,F)),U=`${a?`value += bias[col / ${F}];`:`value += ${I.type.value}(bias[row + i]);`}`}let L=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Je(t,L);let A=()=>{let F=`var a_data: ${x.type.value};`;for(let q=0;q<c;q++)F+=`
...
`};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${p};${c};${h};${a}`,inputDependencies:g?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:m}),getShaderSource:w}}}),fo,mo,Ji,er,go,tr,_o,Gt,ir=T(()=>{N(),W(),G(),et(),Yi(),Qi(),fo=(e,t)=>e?`
...
return ${oe(o,l)}(0.0);`,b=oe(u,l),x=oe(e?s:o,l),v=oe(e?o:s,l),I=Xe(n,b,l);return`
...
}`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${s};${d};${f}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:l[0],y:l[1],z:l[2]},programUniforms:c}),getShaderSource:g}}}),So,Io,Op=T(()=>{N(),W(),G(),et(),So=(e,t,i,r)=>{let a=e.length>2,n=a?"value += b[output_channel];":"",s=e[0].dims,o=e[1].dims,u=t.format==="NHWC",l=u?i[3]:i[1],d=l/t.group,p=u&&d>=4?ie(l):1,c=k.size(i)/p,h=[{type:12,data:c},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:d}];Ye(t,h),h.push(...M(s,[o[0],o[1],o[2],o[3]/p]));let f=a?["rank","rank","rank"]:["rank","rank"];h.push(...M([i[0],i[1],i[2],i[3]/p]));let g=y=>{let _=B("output",e[0].dataType,i.length,p),m=se(_.type.tensor),w=Xe(t,_.type.value,m),$=S("x",e[0].dataType,s.length),b=S("w",e[1].dataType,o.length,p),x=[$,b];a&&x.push(S("b",e[2].dataType,e[2].dims,p));let v=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];Je(t,v);let I=u?`
...
}`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${p}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:h}),getShaderSource:g}},Io=(e,t,i,r)=>{let a=e.length>2,n=ie(i[3]),s=ie(i[2]),o=k.size(i)/n/s,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/n],l=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/n],d=[i[0],i[1],i[2],i[3]/n],p=[{type:12,data:o},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Ye(t,p),p.push(...M(u,l,d));let c=(s-1)*t.strides[1]+l[1],h=f=>{let g=B("output",e[0].dataType,d.length,n),y=se(g.type.tensor),_=Xe(t,g.type.value,y),m=S("x",e[0].dataType,u.length,n),w=S("w",e[1].dataType,l.length,n),$=[m,w];a&&$.push(S("b",e[2].dataType,e[2].dims,n));let b=a?"value += b[output_channel];":"",x=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Je(t,x),`
...
let dequantized_data = ${he(l)}(quantized_data - zero_point) * scale;
 ...
 * limitations under the License.
 * =============================================================================
 */typeof rp=="object"&&typeof Gr=="object"&&(Gr.exports=ei);console.log("wow3");ei.env.wasm.numThreads=4;self.onmessage=async me=>{const{type:ne,userImageBuffer:de}=me.data;if(ne==="createSession")try{const pe=performance.now(),De=await ei.InferenceSession.create("../../superpoint_lightglue_pipeline.ort.onnx"),T=performance.now();self.session=De,self.postMessage({type:"sessionCreated",data:{sessionTime:T-pe}})}catch(pe){self.postMessage({type:"error",data:{message:pe.message}})}if(ne==="runInference"){if(!self.session){self.postMessage({type:"error",data:{message:"Session is not initialized."}});return}try{if(!de){self.postMessage({type:"error",data:{message:"No user image provided."}});return}const pe=new Blob([de]),De=await createImageBitmap(pe),we=await bc("../../fabryczna_otwarcie_topo.jpg"),Fe=[De,we],ce=256,ke=256,ge=Fe.map((ri,lt)=>wc(ri,ce,ke,lt)),Se=new Float32Array([...ge[0],...ge[1]]),zt={images:new ei.Tensor("float32",Se,[2,1,ke,ce])},Et=performance.now(),ii=await self.session.run(zt),Ct=performance.now();self.postMessage({type:"inferenceComplete",data:{inferenceTime:Ct-Et,results:ii,images:Fe,imgWidth:ce,imgHeight:ke}})}catch(pe){self.postMessage({type:"error",data:{message:pe.message}})}}};function wc(me,ne,de,pe){const T=new OffscreenCanvas(ne,de).getContext("2d");T.drawImage(me,0,0,ne,de);const we=T.getImageData(0,0,ne,de).data,Fe=new Float32Array(ne*de);for(let ce=0;ce<ne*de;ce++){const ke=we[ce*4]/255,ge=we[ce*4+1]/255,Se=we[ce*4+2]/255;Fe[ce]=.299*ke+.587*ge+.114*Se}return Fe}async function bc(me){const de=await(await fetch(me)).blob();return await createImageBitmap(de)}});export default vc();
